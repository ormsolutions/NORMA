...
// The 'dataTypeName' attribute is invalid - The value '' is invalid according to its datatype 'Union' - The value '' is not valid according to any of the memberTypes of the union.
