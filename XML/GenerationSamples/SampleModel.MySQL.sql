...
ALTER TABLE PersonPerson ADD CONSTRAINT Husband_FK FOREIGN KEY (Husband_Person_id)  REFERENCES Person (Person_id)  ON DELETE RESTRICT ON UPDATE RESTRICT;

ALTER TABLE PersonPerson ADD CONSTRAINT VlTyp1DsSmthngElsWth_FK FOREIGN KEY (VlTyp1DsSmthngElsWth_VlTyp1Vl)  REFERENCES ValueType1 (ValueType1Value)  ON DELETE RESTRICT ON UPDATE RESTRICT;

ALTER TABLE PersonPerson ADD CONSTRAINT Father_FK FOREIGN KEY (Father_Person_id)  REFERENCES Person (Person_id)  ON DELETE RESTRICT ON UPDATE RESTRICT;

ALTER TABLE PersonPerson ADD CONSTRAINT Mother_FK FOREIGN KEY (Mother_Person_id)  REFERENCES Person (Person_id)  ON DELETE RESTRICT ON UPDATE RESTRICT;

ALTER TABLE TaskTask ADD CONSTRAINT Person_FK FOREIGN KEY (Person_Person_id)  REFERENCES Person (Person_id)  ON DELETE RESTRICT ON UPDATE RESTRICT;

ALTER TABLE ValueType1ValueType1 ADD CONSTRAINT DoesSomethingWithPerson_FK FOREIGN KEY (DsSmthngWthPrsn_Prsn_d)  REFERENCES Person (Person_id)  ON DELETE RESTRICT ON UPDATE RESTRICT;

ALTER TABLE PrsnBghtCrFrmPrsnOnDtPrsnBghtCrFrmPrsnOnDt ADD CONSTRAINT Buyer_FK FOREIGN KEY (Buyer_Person_id)  REFERENCES Person (Person_id)  ON DELETE RESTRICT ON UPDATE RESTRICT;

ALTER TABLE PrsnBghtCrFrmPrsnOnDtPrsnBghtCrFrmPrsnOnDt ADD CONSTRAINT Seller_FK FOREIGN KEY (Seller_Person_id)  REFERENCES Person (Person_id)  ON DELETE RESTRICT ON UPDATE RESTRICT;
