						...
						<xsl:for-each select="oil:informationType">
							<xsl:element name="Field">
								...
								<xsl:for-each select="//oil:informationTypeFormats/odt:identity[@name = current()/@formatRef]">
									<!-- old ../../oil:informationTypeFormats/odt:identity[@name = current()/@formatRef] -->
		...
		<plx:root>
			...
			<plx:namespace name="{$ModelName}">
				<xsl:for-each select="$AllClasses[not(substring-before(@name, 'Core') = '')]">
							...
							<plx:try>
														...
														<plx:binaryOperator type="inequality">
															...
															<plx:right>
																<xsl:call-template name="PropertyAccessor">
																	...
																	<xsl:with-param name="Name" select="@name" />
																	<xsl:with-param name="InstanceCaller" select="'this.abstractTypeVar'" />
																	<xsl:with-param name="OilInfo" select="$OilInfo" />
																</xsl:call-template>
															</plx:right>
														</plx:binaryOperator>
								...
								<plx:catch localName="exception" dataTypeName="Exception">
									<plx:callStatic name="Show" dataTypeName="MessageBox" dataTypeQualifier="System.Windows.Forms" type="methodCall">
										...
										<plx:passParam>
											<plx:nameRef name='"Create {@displayName}"' />
										</plx:passParam>
									</plx:callStatic>
								</plx:catch>
							</plx:try>
						...
						<plx:function name="btnCollection_Click" visibility="private">
							...
							<plx:try>
								...
								<plx:autoDispose localName="iterator" dataTypeName="IEnumerator">
									<plx:passTypeParam dataTypeName="{@displayName}" dataTypeQualifier="{substring-before(../TestClass/@name, 'Context')}" />
									<plx:initialize>
											...
											<plx:assign>
												...
												<plx:right>
													<xsl:call-template name="PropertyAccessor">
														<xsl:with-param name="ID_Kind" select="@dataTypeName" />
														<xsl:with-param name="Name" select="@name" />
														<xsl:with-param name="InstanceCaller" select="'iterator.Current'" />
														<xsl:with-param name="OilInfo" select="$OilInfo" />
													</xsl:call-template>
												</plx:right>
											</plx:assign>
								...
								<plx:catch localName="exception" dataTypeName="Exception">
									<plx:callStatic name="Show" dataTypeName="MessageBox" dataTypeQualifier="System.Windows.Forms" type="methodCall">
										...
										<plx:passParam>
											<plx:nameRef name='"Get Collection of {@displayName}"' />
										</plx:passParam>
									</plx:callStatic>
								</plx:catch>
							</plx:try>
					...
					<plx:pragma type="closeRegion" data="Collection{@name}_{$ClassName}" />
							...
							<plx:try>
								...
								<plx:catch localName="exception" dataTypeName="Exception">
									<plx:callStatic name="Show" dataTypeName="MessageBox" dataTypeQualifier="System.Windows.Forms" type="methodCall">
										...
										<plx:passParam>
											<plx:nameRef name='"Select {@displayName}"' />
										</plx:passParam>
									</plx:callStatic>
								</plx:catch>
							</plx:try>
							...
							<plx:try>
								...
								<plx:fallbackBranch>
									...
									<plx:assign>
										...
										<plx:right>
											<plx:nameRef name='"The current selected {@displayName}:"' />
										</plx:right>
									</plx:assign>
								...
								<plx:catch localName="exception" dataTypeName="Exception">
									<plx:callStatic name="Show" dataTypeName="MessageBox" dataTypeQualifier="System.Windows.Forms" type="methodCall">
										...
										<plx:passParam>
											<plx:nameRef name='"Display {@displayName}"' />
										</plx:passParam>
									</plx:callStatic>
								</plx:catch>
							</plx:try>
							...
							<plx:try>
								...
								<plx:catch localName="exception" dataTypeName="Exception">
									<plx:callStatic name="Show" dataTypeName="MessageBox" dataTypeQualifier="System.Windows.Forms" type="methodCall">
										...
										<plx:passParam>
											<plx:nameRef name='"Change Selection Mode for {@displayName}"' />
										</plx:passParam>
									</plx:callStatic>
								</plx:catch>
							</plx:try>
							...
							<plx:try>
								...
								<plx:catch localName="exception" dataTypeName="Exception">
									<plx:callStatic name="Show" dataTypeName="MessageBox" dataTypeQualifier="System.Windows.Forms" type="methodCall">
										...
										<plx:passParam>
											<plx:nameRef name='"Save {@displayName}"' />
										</plx:passParam>
									</plx:callStatic>
								</plx:catch>
							</plx:try>
							...
							<plx:try>
								...
								<plx:catch localName="exception" dataTypeName="Exception">
									<plx:callStatic name="Show" dataTypeName="MessageBox" dataTypeQualifier="System.Windows.Forms" type="methodCall">
										...
										<plx:passParam>
											<plx:nameRef name='"Cancel Edit {@displayName}"' />
										</plx:passParam>
									</plx:callStatic>
								</plx:catch>
							</plx:try>
							...
							<plx:try>
								<plx:branch>
									...
									<plx:assign>
										...
										<plx:right>
											<plx:string>The changed data has not been saved.</plx:string>
										</plx:right>
									</plx:assign>
								...
								<plx:catch localName="exception" dataTypeName="Exception">
									<plx:callStatic name="Show" dataTypeName="MessageBox" dataTypeQualifier="System.Windows.Forms" type="methodCall">
										...
										<plx:passParam>
											<plx:nameRef name='"Begin Edit {@displayName}"' />
										</plx:passParam>
									</plx:callStatic>
								</plx:catch>
							</plx:try>
					...
					<plx:try>
								...
								<plx:callInstance name="ConnectionString" type="property">
									<plx:callObject>
										<plx:callStatic name="ConnectionStrings" dataTypeName="ConfigurationManager" dataTypeQualifier="System.Configuration" type="property">
											<plx:passParam>
												<plx:string>connString</plx:string>
											</plx:passParam>
										</plx:callStatic>
									</plx:callObject>
								</plx:callInstance>
						...
						<plx:catch localName="exception" dataTypeName="Exception">
							<plx:callStatic name="Show" dataTypeName="MessageBox" dataTypeQualifier="System.Windows.Forms" type="methodCall">
								...
								<plx:passParam>
									<plx:nameRef name='"Get Database Connection for {$ActionType} on {$AbstractTypeName}"' />
								</plx:passParam>
							</plx:callStatic>
											...
											<plx:callObject>
												<plx:callInstance name="Cells" type="property">
													...
													<xsl:choose>
														...
														<xsl:when test="@displayName">
															<plx:passParam>
																<plx:value data='"{$Parameter/@displayName}"'/>
															</plx:passParam>
														</xsl:when>
														<xsl:otherwise>
															<plx:passParam>
																<plx:value data='"{$Parameter/@name}"'/>
															</plx:passParam>
														</xsl:otherwise>
													</xsl:choose>
												</plx:callInstance>
		...
		<xsl:choose>
			<xsl:when test="not($ID_Kind) or $ID_Kind = 'value' or not(substring-after($ID_Kind, '.') = '')">
				<plx:callInstance name='{$Name}' type='property'>
					<plx:callObject>
						<plx:nameRef name='{$InstanceCaller}' />
					</plx:callObject>
				</plx:callInstance>
			</xsl:when>
			<xsl:otherwise>
				<xsl:call-template name="PropertyAccessor">
					<xsl:with-param name="ID_Kind" select="$OilInfo/Type[@name = $ID_Kind]/PreferredIdentifier/Field/@id_kind" />
					<xsl:with-param name="Name" select="$OilInfo/Type[@name = $ID_Kind]/PreferredIdentifier/Field/@name" />
					<xsl:with-param name="InstanceCaller" select="concat($InstanceCaller, '.', $Name)" />
					<xsl:with-param name="OilInfo" select="$OilInfo" />
				</xsl:call-template>
			</xsl:otherwise>
		</xsl:choose>
				...
				<plx:callInstance name="Cells" type="property">
					...
					<xsl:choose>
						...
						<xsl:when test="$Property/@displayName">
							<plx:passParam>
								<plx:value data='"{$Property/@displayName}"'/>
							</plx:passParam>
						</xsl:when>
						<xsl:otherwise>
							<plx:passParam>
								<plx:value data='"{$Property/@name}"'/>
							</plx:passParam>
						</xsl:otherwise>
					</xsl:choose>
				</plx:callInstance>
