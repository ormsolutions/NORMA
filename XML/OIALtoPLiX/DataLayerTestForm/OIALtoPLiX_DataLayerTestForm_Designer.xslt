...
<xsl:stylesheet version="1.0"
	...
	<!-- Output file:  [ORM Model Name]TestForm.Designer.PLiX.xml -->
		...
		<plx:root>
			<plx:namespace name="{$ModelName}">
				<plx:class visibility="public" partial="true" name="{$ModelName}Tester">
					...
					<plx:pragma type="region" data="Windows Form Designer generated code"/>
					...
					<plx:function visibility="private" name="InitializeComponent">
						...
						<plx:assign>
							...
							<plx:right>
								<plx:string>NORMA:  <xsl:value-of select="$ModelName"/> Data Test Form</plx:string>
							</plx:right>
						</plx:assign>
					...
					<plx:pragma type="closeRegion" data="Windows Form Designer generated code"/>
