			...
			<plx:namespace name="{$ModelName}">
				...
				<xsl:for-each select="$AllClasses/../Class">
					...
					<plx:class name="{@name}_{$ClassName}" partial="true" visibility="public">
						<plx:field name="components" visibility="private" dataTypeName ="System.ComponentModel.IContainer">
							<plx:leadingInfo>
								<plx:docComment>
						...
						<plx:field name="actionTabs" visibility="private" dataTypeName="System.Windows.Forms.TabControl"/>
						...
						<plx:pragma type="region" data="Component Designer generated code" />
						...
						<plx:pragma type="closeRegion" data="Component Designer generated code" />
					</plx:class>
					...
					<plx:class name="Select_{@name}_{$ClassName}" partial="true" visibility="public">
						...
						<plx:field name="lblSelectionMode" visibility="private" dataTypeName="System.Windows.Forms.Label"/>
						<plx:field name="cbxSelectionMode" visibility="private" dataTypeName="System.Windows.Forms.ComboBox"/>
						<plx:field name="lblCurrentObject" visibility="private" dataTypeName="System.Windows.Forms.Label"/>
						<plx:field name="dgvCurrentObject" visibility="private" dataTypeName="System.Windows.Forms.DataGridView"/>
						<plx:field name="btnSave" visibility="private" dataTypeName="System.Windows.Forms.Button"/>
						<plx:field name="btnCancel" visibility="private" dataTypeName="System.Windows.Forms.Button"/>
						<plx:field name="pnlSave" visibility="private" dataTypeName="System.Windows.Forms.Panel"/>
						<plx:field name="editMode" visibility="private" dataTypeName="bool"/>
						<plx:field name="lblNeedToSave" visibility="private" dataTypeName="System.Windows.Forms.Label"/>
						...
						<plx:function name="InitializeComponent" visibility="private">
							...
							<plx:assign>
								...
								<plx:right>
									<plx:string>lblSelectionMode</plx:string>
								</plx:right>
							</plx:assign>
							...
							<plx:assign>
								...
								<plx:right>
									<plx:string>cbxSelectionMode</plx:string>
								</plx:right>
							</plx:assign>
							...
							<xsl:for-each select="../TestClass/Actions/Select/Function[current()/@displayName = @objectToSelect]">
								...
								<plx:callInstance name="Add" type="methodCall">
									...
									<plx:passParam>
										<plx:nameRef name='"{@selectionMode}"'/>
									</plx:passParam>
								</plx:callInstance>
							</xsl:for-each>
							...
							<plx:assign>
								...
								<plx:right>
									<plx:string>lblCurrentObject</plx:string>
								</plx:right>
							</plx:assign>
							...
							<plx:assign>
								...
								<plx:right>
									<plx:nameRef name='"There is no selected {@displayName}."' />
								</plx:right>
							</plx:assign>
							...
							<plx:assign>
								...
								<plx:right>
									<plx:nameRef name="System.Windows.Forms.DataGridViewColumnHeadersHeightSizeMode.AutoSize" />
								</plx:right>
							</plx:assign>
	...
	<xsl:template name="DeclareCommonFields">
		...
		<xsl:choose>
			<xsl:when test="$ActionType">
				<plx:field name="lbl{$ActionType}" visibility="private" dataTypeName="System.Windows.Forms.Label"/>
				<plx:field name="btn{$ActionType}" visibility="private" dataTypeName="System.Windows.Forms.Button"/>
				<plx:field name="dgv{$ActionType}" visibility="private" dataTypeName="System.Windows.Forms.DataGridView"/>
				<plx:field name="pnlDisplay" visibility="private" dataTypeName="System.Windows.Forms.Panel"/>
				<plx:field name="{$ActionType}_{$AbstractTypeName}_connect" visibility="private" dataTypeName="ConnectionDelegate" dataTypeQualifier="{substring-before($TestClassName, 'Context')}.{$TestClassName}" />
				<plx:field name="testVar" visibility="private" dataTypeName="I{$TestClassName}" dataTypeQualifier="{substring-before($TestClassName, 'Context')}" />
				<plx:field name="abstractTypeVar" visibility="private" dataTypeName="{$AbstractTypeName}" dataTypeQualifier="{substring-before($TestClassName, 'Context')}" />
			</xsl:when>
		</xsl:choose>
	</xsl:template>
		...
		<xsl:choose>
			<xsl:when test="$ActionType">
				...
				<plx:assign>
					...
					<plx:right>
						<plx:callNew dataTypeName="ConnectionDelegate" dataTypeQualifier="{substring-before($TestClassName, 'Context')}.{$TestClassName}" >
							<plx:passParam>
				...
				<plx:assign>
					...
					<plx:right>
						<plx:callNew dataTypeName="{$TestClassName}" dataTypeQualifier="{substring-before($TestClassName, 'Context')}" >
							<plx:passParam>
				...
				<plx:assign>
					...
					<plx:right>
						<plx:nameRef name='"lbl{$ActionType}"' />
					</plx:right>
				</plx:assign>
					...
					<plx:right>
						<xsl:choose>
							<xsl:when test="$ActionType = 'Collection'">
								<plx:nameRef name='"Click the {$ActionType} button to refresh the list of {$AbstractTypeName} records."' />
							</xsl:when>
							<xsl:otherwise>
								<plx:nameRef name='"Enter data to {$ActionType} {$AbstractTypeName} by:"' />
							</xsl:otherwise>
						</xsl:choose>
					</plx:right>
				</plx:assign>
				...
				<plx:assign>
					...
					<plx:right>
						<plx:nameRef name='"btn{$ActionType}"' />
					</plx:right>
				</plx:assign>
				...
				<plx:assign>
					...
					<plx:right>
						<plx:nameRef name='"dgv{$ActionType}"'/>
					</plx:right>
				</plx:assign>
				...
				<plx:assign>
					...
					<plx:right>
						<plx:callStatic name='Both' dataTypeName='ScrollBars' dataTypeQualifier='System.Windows.Forms' type='property' />
					</plx:right>
				</plx:assign>
				...
				<plx:assign>
					...
					<plx:right>
						<plx:string>pnlDisplay</plx:string>
					</plx:right>
				</plx:assign>
				...
				<plx:assign>
					...
					<plx:right>
						<plx:nameRef name="System.Windows.Forms.AutoScaleMode.Font"/>
					</plx:right>
				</plx:assign>
				...
				<plx:assign>
					...
					<plx:right>
						<plx:nameRef name="System.Windows.Forms.BorderStyle.Fixed3D"/>
					</plx:right>
				</plx:assign>
				...
				<plx:assign>
					...
					<plx:right>
						<plx:nameRef name='"ic{$ActionType}{$AbstractTypeName}InputControl"' />
					</plx:right>
				</plx:assign>
