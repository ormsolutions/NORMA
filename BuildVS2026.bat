...
IF "%TargetVisualStudioVersion%"=="v8.0" (
	...
	SET TargetVisualStudioVersion=v18.0
...
) ELSE IF "%TargetVisualStudioVersion%"=="v18.0" (
	MSBuild.exe /nologo "%~dp0VSIXInstall\VSIXOnly\NORMAVSIX.VS2026.sln" /consoleloggerparameters:DisableMPLogging"  %DegradeToolsVersion% %*
)