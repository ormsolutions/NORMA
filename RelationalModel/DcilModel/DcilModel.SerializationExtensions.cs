...
{
	#region DcilDomainModel model serialization
	partial class DcilDomainModel : IORMCustomSerializedDomainModel
	{
		/// <summary>The default XmlNamespace associated with the 'DcilDomainModel' extension model</summary>
		...
		{
			Collection<string> validNamespaces = DcilDomainModel.myValidNamespaces;
			Dictionary<string, Guid> classNameMap = DcilDomainModel.myClassNameMap;
			if (validNamespaces == null)
			{
				validNamespaces = new Collection<string>();
				DcilDomainModel.myValidNamespaces = validNamespaces;
			}
			if (classNameMap == null)
			{
				classNameMap = new Dictionary<string, Guid>();
				DcilDomainModel.myClassNameMap = classNameMap;
			}
	...
	#endregion // DcilDomainModel model serialization
}
