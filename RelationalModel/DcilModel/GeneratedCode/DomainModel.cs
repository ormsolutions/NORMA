	...
	public partial class ConceptualDatabaseDomainModel : DslModeling::DomainModel
	{
		...
		protected sealed override DomainMemberInfo[] GetGeneratedDomainProperties()
		{
			return new DomainMemberInfo[]
			{
				...
				new DomainMemberInfo(typeof(Column), "Scale", Column.ScaleDomainPropertyId, typeof(Column.ScalePropertyHandler)),
				new DomainMemberInfo(typeof(Column), "Length", Column.LengthDomainPropertyId, typeof(Column.LengthPropertyHandler)),
