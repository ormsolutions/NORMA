	...
	<Classes>
		...
		<DomainClass Id="16628BD3-D761-4C6A-816E-C98AEFBADC41" Namespace="ORMSolutions.ORMArchitect.RelationalModels.ConceptualDatabase" Name="Column" Description="Equivalent to a 'COLUMN' in the SQL Standard.">
			...
			<Properties>
				...
				<DomainProperty Name="DataTypeAutoGenerated" DefaultValue="false" DisplayName="DataTypeAutoGenerated" Description="Whether or not the values for this data type are auto-generated." Id="7E1F2744-7CF5-4808-905D-B766264BCC1E" Kind="CustomStorage">
					<Type>
						<ExternalTypeMoniker Name="/System/Boolean"/>
					</Type>
				</DomainProperty>
	...
	<Types>
		...
		<DomainEnumeration Namespace="ORMSolutions.ORMArchitect.RelationalModels.DatabaseDefinition" Name="PredefinedType">
			<Literals>
				...
				<EnumerationLiteral Name="UUID" Value="268435470">
					<Notes>14 | ExactNumericMask</Notes>
					<Attributes>
						<ClrAttribute Name="global::System.Xml.Serialization.XmlEnum">
							<Parameters>
								<AttributeParameter Value="&quot;UUID&quot;"/>
							</Parameters>
						</ClrAttribute>
					</Attributes>
				</EnumerationLiteral>
