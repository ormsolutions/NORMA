...
<Dsl
	...
	<Attributes>
		...
		<ClrAttribute Name="DslModeling::ExtendsDomainModel">
			<Parameters>
				<AttributeParameter Value="&quot;B2CAED8E-4155-4317-9405-55006FDE280E&quot;/*Neumont.Tools.EntityRelationshipModels.Barker.BarkerDomainModel*/"/>
			</Parameters>
		</ClrAttribute>
		<ClrAttribute Name="DslModeling::ExtendsDomainModel">
			<Parameters>
	...
	<Classes>
		<DomainClass Name="MappingBarkerModel" Namespace="Neumont.Tools.ORMAbstractionToBarkerERBridge" Id="1EAA1877-F749-465C-AB97-9C64F9582BF8" DisplayName="MappingBarkerModel" Description=""/>

		<DomainClass Name="BarkerERModelGenerationSetting" Namespace="Neumont.Tools.ORMAbstractionToBarkerERBridge" Id="77B26A43-49CF-47CE-BDCC-44FD78F9096F" DisplayName="BarkerERModelGenerationSetting" Description="">
			<BaseClass>
	...
	<Relationships>
		<DomainRelationship Id="42C5224A-EA1F-4C06-9516-D44B4FDBC30D" Name="BarkerErModelIsForAbstractionModel" Namespace="Neumont.Tools.ORMAbstractionToBarkerERBridge">
			<Source>
		...
		<DomainRelationship Id="281345A7-81EA-4BF8-A3C6-77607C83EA9B" Name="EntityTypeIsPrimarilyForConceptType" Namespace="Neumont.Tools.ORMAbstractionToBarkerERBridge">
			<Source>
		...
		<DomainRelationship Name="GenerationSettingTargetsBarkerERModel" Namespace="Neumont.Tools.ORMAbstractionToBarkerERBridge" Id="E44E5810-1166-4BB9-A6AB-4D8176DD3D46">
			<Source>
		...
		<DomainRelationship Id="E068B80F-D598-4C4C-A6E9-729602A6C564" Name="AttributeHasConceptTypeChild" Namespace="Neumont.Tools.ORMAbstractionToBarkerERBridge" AllowsDuplicates="true">
			<Source>
				<DomainRole Id="C18D335D-5B83-4B06-BD07-FD04F941FA57" Description="" Name="Attribute" PropertyName="ConceptTypeChildPath" Multiplicity="OneMany">
					<RolePlayer>
						<DomainClassMoniker Name="/Neumont.Tools.EntityRelationshipModels.Barker/Attribute"/>
					</RolePlayer>
				</DomainRole>
			</Source>
			<Target>
		...
		<DomainRelationship Id="011E06F6-6B28-4212-B57D-9C97403BCE0B" Name="BinaryAssociationHasConceptTypeChild" Namespace="Neumont.Tools.ORMAbstractionToBarkerERBridge" AllowsDuplicates="true">
			<Source>
	...
	<XmlSerializationBehavior Name="ORMAbstractionToBarkerERBridgeSerializationBehavior" Namespace="Neumont.Tools.ORMAbstractionToBarkerERBridge"/>	
</Dsl>