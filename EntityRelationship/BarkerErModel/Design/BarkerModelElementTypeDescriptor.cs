...
namespace ORMSolutions.ORMArchitect.EntityRelationshipModels.Barker.Design
{
	/// <summary>
	...
	/// The type of the <see cref="ModelElement"/> that this <see cref="BarkerModelElementTypeDescriptor{TModelElement}"/> is for.
	/// </typeparam>
	[HostProtection(SecurityAction.LinkDemand, SharedState = true)]
	public class BarkerModelElementTypeDescriptor<TModelElement> : ElementTypeDescriptor<TModelElement>
		where TModelElement : ModelElement
	{
		/// <summary>
		/// Initializes a new instance of <see cref="BarkerModelElementTypeDescriptor{TModelElement}"/> for
		/// the instance of <typeparamref name="TModelElement"/> specified by <paramref name="selectedElement"/>.
		/// </summary>
		public BarkerModelElementTypeDescriptor(ICustomTypeDescriptor parent, TModelElement selectedElement)
