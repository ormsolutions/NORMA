...
REG ADD "HKLM\%VSRegistryRoot%\Neumont\ORM Architect\Extensions\http://schemas.neumont.edu/ORM/Preview/CustomProperties" /v "Assembly" /d "Neumont.Tools.ORM.CustomProperties, Version=1.0.0.0, Culture=neutral, PublicKeyToken=957d5b7d5e79e25f" /f 1>NUL
:: REG ADD "HKLM\%VSRegistryRoot%\Neumont\ORM Architect\Extensions" /v "AutoLoadNamespaces" /t REG_MULTI_SZ /d "http://schemas.neumont.edu/ORM/Preview/CustomProperties\0" /f 1>NUL