...
<Dsl
	...
	Description="ORM Intermediate Abstraction Language"
	...
	<Classes>
		<DomainClass Name="OialModel" InheritanceModifier="Sealed" Namespace="Neumont.Tools.Oial" Id="9EF66BE3-C128-4642-9767-063244DE2CEF" DisplayName="OialModel" Description="">
			<Properties>
			...
			<ElementMergeDirectives>
				...
				<ElementMergeDirective UsesCustomAccept="false" UsesCustomMerge="false">
					...
					<LinkCreationPaths>
						<DomainPath>OialModelHasInformationTypeFormat.InformationTypeFormatCollection</DomainPath>
					</LinkCreationPaths>
				</ElementMergeDirective>
			</ElementMergeDirectives>
		</DomainClass>

		<DomainClass Name="ConceptType" InheritanceModifier="Sealed" Namespace="Neumont.Tools.Oial" Id="A75DF497-8D38-4841-AAE3-341FD4ED234B" DisplayName="ConceptType" Description="">
			<Properties>
		...
		<DomainClass Name="InformationTypeFormat" Namespace="Neumont.Tools.Oial" Id="7EB62327-99A6-4543-BE0D-8D4CED8C4F0E" DisplayName="InformationTypeFormat" Description="">
			<Properties>
		...
		<DomainClass Name="Uniqueness" InheritanceModifier="Sealed" Namespace="Neumont.Tools.Oial" Id="0AF67F1F-66D6-4C2B-B85C-D556894AC300" DisplayName="Uniqueness" Description="">
			<Properties>
	...
	<Relationships>
		<DomainRelationship Name="OialModelHasConceptType" InheritanceModifier="Sealed" Namespace="Neumont.Tools.Oial" IsEmbedding="true" Id="35E02E9E-24DB-4DEf-B1CC-C8051F0E44A7">
			<Source>
		...
		<DomainRelationship Name="OialModelHasInformationTypeFormat" InheritanceModifier="Sealed" Namespace="Neumont.Tools.Oial" IsEmbedding="true" Id="2CDBA90A-2059-48A7-B272-21CEE9119C55">
			<Source>
		...
		<DomainRelationship Name="ConceptTypeHasUniqueness" InheritanceModifier="Sealed" Namespace="Neumont.Tools.Oial" IsEmbedding="true" Id="356BCEA9-13E0-406D-BC0C-404909856A8F">
			<Source>
		...
		<DomainRelationship Name="ConceptTypeChild" AllowsDuplicates="true" Namespace="Neumont.Tools.Oial" InheritanceModifier="Abstract" Id="96AFB439-E314-4D49-9011-18362F78D724">
			<Properties>
		...
		<DomainRelationship Name="ConceptTypeHasChildAsPartOfAssociation" InheritanceModifier="Sealed" Namespace="Neumont.Tools.Oial" Id="0B5B8D09-E72B-484C-9A57-D4068FED9D65">
			<Source>
		...
		<DomainRelationship Name="InformationType" InheritanceModifier="Sealed" AllowsDuplicates="true" Namespace="Neumont.Tools.Oial" Id="10DBC480-9DD5-47FB-8533-982C27985EE5">
			<BaseRelationship>
				<DomainRelationshipMoniker Name="ConceptTypeChild" />
			</BaseRelationship>
			<Source>
		...
		<DomainRelationship Name="ConceptTypeReferencesConceptType" AllowsDuplicates="true" InheritanceModifier="Abstract" Namespace="Neumont.Tools.Oial" Id="F003A8DA-4CD5-4208-B3D3-A51E98C5B962">
			<BaseRelationship>
				<DomainRelationshipMoniker Name="ConceptTypeChild" />
			</BaseRelationship>
			<Properties>
		...
		<DomainRelationship Name="ConceptTypeRelatesToConceptType" InheritanceModifier="Sealed" AllowsDuplicates="true" Namespace="Neumont.Tools.Oial" Id="D8F2CBCD-1EB4-420A-9D18-5759D46B8AF3">
			<BaseRelationship>
		...
		<DomainRelationship Name="ConceptTypeAssimilatesConceptType" InheritanceModifier="Sealed" AllowsDuplicates="false" Namespace="Neumont.Tools.Oial" Id="A342DF5A-7426-4A9C-8263-3E24CBA2CF60">
			<BaseRelationship>
				<DomainRelationshipMoniker Name="ConceptTypeReferencesConceptType" />
			</BaseRelationship>
			<Properties>
		...
		<DomainRelationship Name="UniquenessIncludesConceptTypeChild" InheritanceModifier="Sealed" Namespace="Neumont.Tools.Oial" Id="C06E9C7D-89D3-433F-8B8A-FC80E3878DD5">
			<Source>
	...
	<XmlSerializationBehavior Name="OialDomainModelSerializationBehavior" Namespace="Neumont.Tools.Oial"/>
