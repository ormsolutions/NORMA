	...
	public partial class ORMInferenceEngineDomainModel : DslModeling::DomainModel
	{
		...
		public sealed override DslModeling::ModelElement CreateElement(DslModeling::Partition partition, global::System.Type elementType, DslModeling::PropertyAssignment[] propertyAssignments)
		{
			...
			if (createElementMap == null)
			{
				...
				createElementMap.Add(typeof(InferredConstraints), 6);
				createElementMap.Add(typeof(InferredSubsetConstraint), 7);
				createElementMap.Add(typeof(InferredEqualityConstraint), 8);
				createElementMap.Add(typeof(InferredExclusionConstraint), 9);
				createElementMap.Add(typeof(InferredSubtypeFact), 10);
				createElementMap.Add(typeof(InferredMandatoryConstraint), 11);
				createElementMap.Add(typeof(InferredFrequencyConstraint), 12);
				createElementMap.Add(typeof(InferredUniquenessConstraint), 13);
			}
			int index;
			...
			switch (index)
			{
				...
				case 6: return new InferredConstraints(partition, propertyAssignments);
				case 7: return new InferredSubsetConstraint(partition, propertyAssignments);
				case 8: return new InferredEqualityConstraint(partition, propertyAssignments);
				case 9: return new InferredExclusionConstraint(partition, propertyAssignments);
				case 10: return new InferredSubtypeFact(partition, propertyAssignments);
				case 11: return new InferredMandatoryConstraint(partition, propertyAssignments);
				case 12: return new InferredFrequencyConstraint(partition, propertyAssignments);
				case 13: return new InferredUniquenessConstraint(partition, propertyAssignments);
				default: return null;
			}
		}
		...
		public sealed override DslModeling::ElementLink CreateElementLink(DslModeling::Partition partition, global::System.Type elementLinkType, DslModeling::RoleAssignment[] roleAssignments, DslModeling::PropertyAssignment[] propertyAssignments)
		{
			...
			if (createElementLinkMap == null)
			{
				...
				createElementLinkMap.Add(typeof(InferenceResultTargetsORMModel), 8);
				createElementLinkMap.Add(typeof(InferredConstraintsTargetORMModel), 9);
				createElementLinkMap.Add(typeof(SetConstraintIsInferred), 10);
				createElementLinkMap.Add(typeof(SetComparisonConstraintIsInferred), 11);
				createElementLinkMap.Add(typeof(SubtypeFactIsInferred), 12);
			}
			int index;
			...
			switch (index)
			{
				...
				case 8: return new InferenceResultTargetsORMModel(partition, roleAssignments, propertyAssignments);
				case 9: return new InferredConstraintsTargetORMModel(partition, roleAssignments, propertyAssignments);
				case 10: return new SetConstraintIsInferred(partition, roleAssignments, propertyAssignments);
				case 11: return new SetComparisonConstraintIsInferred(partition, roleAssignments, propertyAssignments);
				case 12: return new SubtypeFactIsInferred(partition, roleAssignments, propertyAssignments);
				default: return null;
			}
		}
		#endregion
