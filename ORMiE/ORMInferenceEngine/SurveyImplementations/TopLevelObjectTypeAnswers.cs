...
{
	partial class TopLevelObjectType : ISurveyNodeReference, IAnswerSurveyQuestion<SurveyRootElementType>, ISurveyNode
	{
		...
		{
			return (int)SurveyRootElementType.TopLevelObjectType;
		}
