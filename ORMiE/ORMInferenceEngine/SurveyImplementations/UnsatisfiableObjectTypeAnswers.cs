...
{
	partial class UnsatisfiableObjectType : ISurveyNodeReference, IAnswerSurveyQuestion<SurveyRootElementType>, ISurveyNode
	{
		...
		{
			return (int)SurveyRootElementType.UnsatisfiableElement;
		}
	...
	partial class UnsatisfiableFactType : ISurveyNodeReference, IAnswerSurveyQuestion<SurveyRootElementType>, ISurveyNode
	{
		#region IAnswerSurveyQuestion<SurveyRootElementType> Implementation
		int IAnswerSurveyQuestion<SurveyRootElementType>.AskQuestion(object contextElement)
		{
