...
namespace unibz.ORMInferenceEngine
{
	...
	{
		SetComparisonConstraint CreateInferredExclusiveTypes(InferredConstraints container, string first, string second)
		{
			...
			targetConstraint.Name = "ExclusiveTypes " + first + " - " + second ;
