...
{
	partial class DisjointTopLevelFactType : ISurveyNodeReference, IAnswerSurveyQuestion<SurveyRootElementType>, ISurveyNode
	{
		...
		{
			return (int)SurveyRootElementType.DisjointTopLevelFactType;
		}
