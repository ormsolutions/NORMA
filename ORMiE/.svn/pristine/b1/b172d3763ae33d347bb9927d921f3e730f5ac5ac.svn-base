...
{
	partial class DisjointTopLevelObjectType : ISurveyNodeReference, IAnswerSurveyQuestion<SurveyRootElementType>, ISurveyNode
	{
		...
		{
			return (int)SurveyRootElementType.DisjointTopLevelObjectType;
		}
