...
{
	partial class EquivalentTopLevelFactType : ISurveyNodeReference, IAnswerSurveyQuestion<SurveyRootElementType>, ISurveyNode
	{
		...
		{
			return (int)SurveyRootElementType.EquivalentTopLevelFactType;
		}
