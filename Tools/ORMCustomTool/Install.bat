...
XCOPY /Y /D /V /Q "%XMLDir%\DILtoSQL\DDILtoSQLServer_ANSITypes.xslt" "%DILTransformsDir%\"
...
CALL:_AddXslORMGenerator "DDILtoSQLServerANSI" "DDIL to SQL Server (ANSI Types)" "Transforms DDIL to SQL Server-dialect SQL with ANSI data types." ".SQLServer.sql" "DDIL" "SQL_SQLServer" "%DILTransformsDir%\DDILtoSQLServer_ANSITypes.xslt"
