...
CALL:_AddTextTemplateReg "8.0" "DisableRuleDirectiveProcessor"
IF NOT "%VSRegistryRootSuffix%"=="" (CALL:_AddTextTemplateReg "8.0%VSRegistryRootSuffix%" "DisableRuleDirectiveProcessor")
