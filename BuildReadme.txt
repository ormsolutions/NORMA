...
2) BuildDevTools.bat builds the (relatively static) NUBuild MSBuild extensions and DSLTools directive processors. CalFled by FirstTimeBuild.bat
...
5) BuildSetup.bat builds everything included in setup. Requires install of WIX 3.0 as discussed in the README.txt file.
