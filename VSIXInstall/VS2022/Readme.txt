...
"C:\Program Files\Microsoft Visual Studio\2022\Community\VSSDK\VisualStudioIntegration\tools\bin\regpkg" /pkgdeffile:temp.pkgdef ..\..\ORMModel\bin\Debug\ORMSolutions.ORMArchitect.Core.VS2022.dll
...
If menu or other packages changes are made and VS2022 does not recognize them, then the .vsixmanifest file can be modified in place as follows:
1) Shut down VS2022 Experimental Hive
...
5) Relaunch VS2022 Experimental Hive (devenv /RootSuffix Exp) and open the Tools/Extension Manager dialog.
