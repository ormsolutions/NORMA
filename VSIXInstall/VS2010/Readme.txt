...
"C:\Program Files\Microsoft Visual Studio 2010 SDK\VisualStudioIntegration\tools\bin\regpkg" /pkgdeffile:temp.pkgdef ..\..\ORMModel\bin\Debug\ORMSolutions.ORMArchitect.Core.VS2010.dll
...
If menu or other packages changes are made and VS2010 does not recognize them, then the .vsixmanifest file can be modified in place as follows:
1) Shut down VS2010 Experimental Hive
...
4) Relaunch VS2010 Experimental Hive (devenv /RootSuffix Exp) and open the Tools/Extension Manager dialog.
5) Disable the NORMA tool and restart VS from the dialog.
6) Reopen the Extension Manager dialog and reenable the NORMA extension
7) Any cached settings should be updated after a final relaunch of the environment.
