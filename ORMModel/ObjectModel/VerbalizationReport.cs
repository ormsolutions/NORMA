...
namespace Neumont.Tools.ORM.ObjectModel.Verbalization
{
    ...
    public class VerbalizationReportGenerator
    {
        ...
        public static void GenerateReport(ORMModel model, VerbalizationReportContent reportContent, string baseDir)
        {
            ...
            IDictionary<Type, IVerbalizationSets> snippetDictionary = (model.Store as IORMToolServices).VerbalizationSnippetsDictionary;
            IVerbalizationSets<ReportVerbalizationSnippetType> snippets = (IVerbalizationSets<ReportVerbalizationSnippetType>)(model.Store as IORMToolServices).VerbalizationSnippetsDictionary[typeof(ReportVerbalizationSnippetType)];
            ...
            if (0 != (reportContent & VerbalizationReportContent.ObjectTypes))
            {
                ...
                if (objectTypeCount != 0)
                {
                    ...
                    writer = new VerbalizationReportCallbackWriter(snippetDictionary, textWriter);
                    ...
                    VerbalizationHelper.VerbalizeElement(childVerbalize, snippetDictionary,
                        verbalized, isNegative, writer, ref firstCall);
                    textWriter.Flush();
                    textWriter.Close();
                    ...
                    for (int i = 0; i < objectTypeCount; ++i)
                    {
                        ...
                        VerbalizationHelper.VerbalizeElement(child, snippetDictionary,
                            verbalized, isNegative, writer, ref firstCallPending);
    ...
    public class VerbalizationCallbackWriter
    {
        ...
        /// </summary>
        protected string[] myDocumentHeaderReplacementFields;
        /// <summary>
        /// List of Core Verbalization Snippets
        /// </summary>
        protected IVerbalizationSets<CoreVerbalizationSnippetType> myCoreSnippets;

        /// <summary>
        /// Initializes a new instance of Neumont.Tools.ORM.ObjectModel.VerbalizationCallbackWriter
        /// </summary>
        ...
        public VerbalizationCallbackWriter(TextWriter writer, string[] documentHeaderReplacementFields)
        {
            myWriter = writer;
        ...
        /// Initializes a new instance of Neumont.Tools.ORM.ObjectModel.VerbalizationCallbackWriter
        /// </summary>
        /// <param name="snippets">The <see cref="Neumont.Tools.ORM.ObjectModel.IVerbalizationSets"/> containing the Verbalization snippet set to use</param>
        /// <param name="writer">The <see cref="System.IO.TextWriter"/> to write to</param>
        ...
        public VerbalizationCallbackWriter(IVerbalizationSets<CoreVerbalizationSnippetType> snippets, TextWriter writer, string[] documentHeaderReplacementFields) 
            : this(writer, documentHeaderReplacementFields)
        {
            myCoreSnippets = snippets;
        }
        /// <summary>
    ...
    public class VerbalizationReportCallbackWriter : VerbalizationCallbackWriter
    {
        ...
        {
            myWriter.Write(myReportSnippets.GetSnippet(ReportVerbalizationSnippetType.ReportDocumentHeader));
        }
        /// <summary>
        /// Writes the Document Footer defined in the current Verbalization Snippet Set
        /// </summary>
    ...
    public static class VerbalizationHelper
    {
        ...
        /// </summary>
        private delegate VerbalizationResult VerbalizationHandler(VerbalizationCallbackWriter writer, IDictionary<Type, IVerbalizationSets> snippetsDictionary, IDictionary<IVerbalize, IVerbalize> alreadyVerbalized, IVerbalize verbalizer, int indentationLevel, bool isNegative, ref bool firstCallPending, ref bool firstWrite, ref int lastLevel);
        /// <summary>
        ...
        /// <param name="firstCallPending"></param>
        public static void VerbalizeElement(ModelElement element, IDictionary<Type, IVerbalizationSets> snippetsDictionary, IDictionary<IVerbalize, IVerbalize> alreadyVerbalized, bool isNegative, VerbalizationCallbackWriter writer, ref bool firstCallPending)
        {
            int lastLevel = 0;
        ...
        /// <param name="writer">The VerbalizationCallbackWriter for verbalization output</param>
        /// <param name="firstCallPending"></param>
        public static void VerbalizeElement(IVerbalizeCustomChildren customChildren, IDictionary<Type, IVerbalizationSets> snippetsDictionary, IDictionary<IVerbalize, IVerbalize> alreadyVerbalized, bool isNegative, VerbalizationCallbackWriter writer, ref bool firstCallPending)
        {
            int lastLevel = 0;
            bool firstWrite = true;
            bool localFirstCallPending = firstCallPending;
        ...
        private static void VerbalizeElement(ModelElement element, IDictionary<Type, IVerbalizationSets> snippetsDictionary, IDictionary<IVerbalize, IVerbalize> alreadyVerbalized, IVerbalizeFilterChildren filter, VerbalizationCallbackWriter writer, VerbalizationHandler callback, bool isNegative, int indentLevel, ref bool firstCallPending, ref bool firstWrite, ref int lastLevel)
        {
            ...
            try
            {
                VerbalizationResult result = (parentVerbalize != null) ? callback(writer, snippetsDictionary, alreadyVerbalized, parentVerbalize, indentLevel, isNegative, ref firstCallPending, ref firstWrite, ref lastLevel) : VerbalizationResult.NotVerbalized;
                ...
                if (verbalizeChildren)
                {
                    ...
                    for (int i = 0; i < aggregatingCount; ++i)
                    {
                        ...
                        if (roleInfo.IsEmbedding)
                        {
                            ...
                            {
                                VerbalizeElement(children[j], snippetsDictionary, alreadyVerbalized, filter, writer, callback, isNegative, indentLevel, ref firstCallPending, ref firstWrite, ref lastLevel);
                            }
                        }
                    }
                    ...
                    VerbalizeCustomChildren(customChildren, writer, callback, snippetsDictionary, alreadyVerbalized, isNegative, indentLevel, ref firstCallPending, ref firstWrite, ref lastLevel);
                }
            }
            finally
            {
            ...
            if (customChildren != null)
            {
                foreach (CustomChildVerbalizer customChild in customChildren.GetCustomChildVerbalizations(isNegative))
                {
                    ...
                    if (childVerbalize != null)
                    {
                        try
                        {
                            callback(writer, snippetsDictionary, alreadyVerbalized, childVerbalize, indentationLevel, isNegative, ref firstCallPending, ref firstWrite, ref lastLevel);
                        }
                        finally
                        {
