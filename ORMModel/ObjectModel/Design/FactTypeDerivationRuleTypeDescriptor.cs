...
{
	/// <summary>
	/// <see cref="ElementTypeDescriptor"/> for <see cref="FactTypeDerivationRule"/>s.
	/// </summary>
	[HostProtection(SecurityAction.LinkDemand, SharedState = true)]
	public class FactTypeDerivationRuleTypeDescriptor<TModelElement> : ORMModelElementTypeDescriptor<TModelElement>
		where TModelElement : FactTypeDerivationRule
	{
		/// <summary>
