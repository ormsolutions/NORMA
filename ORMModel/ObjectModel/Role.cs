	...
	public partial class Role : IModelErrorOwner, IRedirectVerbalization, IVerbalizeChildren, INamedElementDictionaryParent, INamedElementDictionaryRemoteParent, IHasIndirectModelErrorOwner, IHierarchyContextEnabled
	{
		...
		private sealed partial class RolePlayerRequiredDeleteRule : DeleteRule
		{
			public sealed override void ElementDeleted(ElementDeletedEventArgs e)
			{
				...
				if (!role.IsDeleted)
				{
					ORMCoreDomainModel.DelayValidateElement(role, DelayValidateRolePlayerRequiredError);
				}
			}
		}
		...
		private sealed partial class RolePlayerRequiredForNewRoleAddRule : AddRule
		{
			...
			public sealed override void ElementAdded(ElementAddedEventArgs e)
			{
				...
				if (addedRole != null)
				{
					ORMCoreDomainModel.DelayValidateElement(addedRole, DelayValidateRolePlayerRequiredError);
					ORMCoreDomainModel.DelayValidateElement(addedRole, DelayRenumberErrorsWithRoleNumbersAfterRole);
				}
			}
		}
		...
		private sealed partial class UpdatedRolePlayerRequiredErrorsDeleteRule : DeleteRule
		{
			...
			public sealed override void ElementDeleted(ElementDeletedEventArgs e)
			{
				...
				{
					ORMCoreDomainModel.DelayValidateElement(factType, DelayRenumberErrorsWithRoleNumbers);
				}
			}
		}
