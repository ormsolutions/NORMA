	...
	public partial class ORMMetaModel
	{
		...
		protected override Type[] AllMetaModelTypes()
		{
			...
			Type[] retVal = new Type[]{
				...
				typeof(FactTypeNameChangedEvent),
				...
				typeof(MandatoryConstraint).GetNestedType("VerifyImpliedMandatoryRoleRemoved", BindingFlags.Public | BindingFlags.NonPublic),
				...
				typeof(Objectification).GetNestedType("ImpliedObjectificationConstraintRoleSequenceHasRoleRemovingRule", BindingFlags.Public | BindingFlags.NonPublic),
				...
				typeof(Objectification).GetNestedType("ImpliedObjectificationFactTypeHasRoleRemovingRule", BindingFlags.Public | BindingFlags.NonPublic),
				...
				typeof(SetComparisonConstraint).GetNestedType("EnforceRoleSequenceCardinalityForRemove", BindingFlags.Public | BindingFlags.NonPublic),
				...
				typeof(SetComparisonConstraint).GetNestedType("EnforceRoleSequenceValidityForFactTypeAdd", BindingFlags.Public | BindingFlags.NonPublic),
				typeof(SetComparisonConstraint).GetNestedType("EnforceRoleSequenceValidityForFactTypeRemove", BindingFlags.Public | BindingFlags.NonPublic),
				typeof(SetComparisonConstraint).GetNestedType("EnforceRoleSequenceValidityForRemove", BindingFlags.Public | BindingFlags.NonPublic),
				...
				typeof(SetComparisonConstraint).GetNestedType("ExternalRoleConstraintRemoved", BindingFlags.Public | BindingFlags.NonPublic),
				...
				typeof(SetConstraint).GetNestedType("EnforceRoleSequenceValidityForFactTypeAdd", BindingFlags.Public | BindingFlags.NonPublic),
				typeof(SetConstraint).GetNestedType("EnforceRoleSequenceValidityForFactTypeRemove", BindingFlags.Public | BindingFlags.NonPublic),
				...
				typeof(UniquenessConstraint).GetNestedType("NMinusOneRemoveRuleModelConstraintRemoveValidation", BindingFlags.Public | BindingFlags.NonPublic),
				typeof(UniquenessConstraint).GetNestedType("NMinusOneRemoveRuleModelFactRemoveValidation", BindingFlags.Public | BindingFlags.NonPublic),
