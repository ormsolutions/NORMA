			...
			get
			{
				...
				if (retVal == null)
				{
					...
					retVal = new Type[]{
						...
						typeof(Neumont.Tools.ORM.Framework.NamedElementDictionary).GetNestedType("ElementLinkDeleteRule", BindingFlags.Public | BindingFlags.NonPublic),
						...
						typeof(ObjectType).GetNestedType("UnspecifiedDataRoleRolePlayerChanged", BindingFlags.Public | BindingFlags.NonPublic),
						...
						typeof(SetComparisonConstraint).GetNestedType("EnforceRoleSequenceValidityForFactTypeDelete", BindingFlags.Public | BindingFlags.NonPublic),
						...
						typeof(SetConstraint).GetNestedType("EnforceRoleSequenceValidityForFactTypeDelete", BindingFlags.Public | BindingFlags.NonPublic),
