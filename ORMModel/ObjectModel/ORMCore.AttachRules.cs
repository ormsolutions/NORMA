	...
	public partial class ORMMetaModel
	{
		...
		protected override Type[] AllMetaModelTypes()
		{
			Type[] retVal = new Type[]{
				...
				typeof(FactType).GetNestedType("DuplicateInternalUniquenessConstraintAddRule", BindingFlags.Public | BindingFlags.NonPublic),
				typeof(FactType).GetNestedType("DuplicateInternalUniquenessConstraintRemoveRule", BindingFlags.Public | BindingFlags.NonPublic),
