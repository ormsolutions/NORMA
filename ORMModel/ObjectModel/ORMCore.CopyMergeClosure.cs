...
namespace ORMSolutions.ORMArchitect.Core.ObjectModel
{
	...
	partial class ORMCoreDomainModel : ICopyClosureProvider
	{
		private void AddCopyClosureDirectives(ICopyClosureManager closureManager)
		{
			...
			closureManager.AddCopyClosureDirective(new DomainRoleClosureRestriction(ConstraintRoleSequenceHasRole.RoleDomainRoleId), new DomainRoleClosureRestriction(ConstraintRoleSequenceHasRole.ConstraintRoleSequenceDomainRoleId), CopyClosureDirectiveOptions.None, delegate(ElementLink link, ICopyClosureTargetState targetState)
				{
			...
			closureManager.AddCopyClosureDirective(new DomainRoleClosureRestriction(LeadRolePathSatisfiesCalculatedCondition.LeadRolePathDomainRoleId), new DomainRoleClosureRestriction(LeadRolePathSatisfiesCalculatedCondition.CalculatedConditionDomainRoleId), CopyClosureDirectiveOptions.None, CopyClosureBehavior.InternalReferencedPart);
			closureManager.AddCopyClosureDirective(new DomainRoleClosureRestriction(MandatoryConstraintClosesUnaryFactType.UnaryFactTypeDomainRoleId), new DomainRoleClosureRestriction(MandatoryConstraintClosesUnaryFactType.MandatoryConstraintDomainRoleId), CopyClosureDirectiveOptions.None, CopyClosureBehavior.ExternalCompositePart);
			...
			closureManager.AddCopyClosureDirective(new DomainRoleClosureRestriction(NameAliasRefinesInstance.RefinedInstanceDomainRoleId), new DomainRoleClosureRestriction(NameAliasRefinesInstance.AliasDomainRoleId), CopyClosureDirectiveOptions.None, CopyClosureBehavior.ExternalReferencedPart);
			closureManager.AddCopyClosureDirective(new DomainRoleClosureRestriction(NameGeneratorRefinesInstance.InstanceDomainRoleId), new DomainRoleClosureRestriction(NameGeneratorRefinesInstance.NameGeneratorDomainRoleId), CopyClosureDirectiveOptions.None, CopyClosureBehavior.ExternalReferencedPart);
			...
			closureManager.AddCopyClosureDirective(new DomainRoleClosureRestriction(NameGeneratorRefinesNameGenerator.ParentDomainRoleId), new DomainRoleClosureRestriction(NameGeneratorRefinesNameGenerator.RefinementDomainRoleId), CopyClosureDirectiveOptions.None, delegate(ElementLink link, ICopyClosureTargetState targetState)
				{
					// Name generators are included with the parent generator if they are unrefined and the matching domain model is already loaded in the target store.
					NameGenerator refinement = ((NameGeneratorRefinesNameGenerator)link).Refinement;
					return (!refinement.AllowsRefinedInstances || refinement.RefinedInstance == null) && targetState != null && targetState.SupportsDomainModel(refinement.GetDomainClass().Id) ? CopyClosureBehavior.ContainedPart : CopyClosureBehavior.Ignored;
				});
			...
			closureManager.AddCopyClosureDirective(new DomainRoleClosureRestriction(ObjectTypeHasAbbreviation.ObjectTypeDomainRoleId), new DomainRoleClosureRestriction(ObjectTypeHasAbbreviation.AbbreviationDomainRoleId), CopyClosureDirectiveOptions.None, delegate(ElementLink link, ICopyClosureTargetState targetState)
				{
					// Refined aliases are only included if the refined instance is included. Unrefined aliases are contained as part of the owning element.
					NameAlias alias = ((ObjectTypeHasAbbreviation)link).Abbreviation;
					return alias.RefinedInstance == null ? CopyClosureBehavior.ContainedPart : CopyClosureBehavior.Ignored;
				});
			...
			closureManager.AddCopyClosureDirective(new DomainRoleClosureRestriction(QueryParameterBinding.RolePathDomainRoleId), new DomainRoleClosureRestriction(QueryParameterBinding.QueryParameterDomainRoleId), CopyClosureDirectiveOptions.None, CopyClosureBehavior.ExternalReferencedPart);
			closureManager.AddCopyClosureDirective(new DomainRoleClosureRestriction(QueryParameterBoundToPathedRole.ParameterBindingDomainRoleId), new DomainRoleClosureRestriction(QueryParameterBoundToPathedRole.SourceDomainRoleId), CopyClosureDirectiveOptions.None, CopyClosureBehavior.InternalReferencedPart);
			closureManager.AddCopyClosureDirective(new DomainRoleClosureRestriction(QueryParameterBoundToRolePathRoot.ParameterBindingDomainRoleId), new DomainRoleClosureRestriction(QueryParameterBoundToRolePathRoot.SourceDomainRoleId), CopyClosureDirectiveOptions.None, CopyClosureBehavior.InternalReferencedPart);
			closureManager.AddCopyClosureDirective(new DomainRoleClosureRestriction(QueryParameterHasParameterType.ParameterDomainRoleId), new DomainRoleClosureRestriction(QueryParameterHasParameterType.ParameterTypeDomainRoleId), CopyClosureDirectiveOptions.None, CopyClosureBehavior.ExternalReferencedPart);
			...
			closureManager.AddCopyClosureDirective(new DomainRoleClosureRestriction(RecognizedPhraseHasAbbreviation.RecognizedPhraseDomainRoleId), new DomainRoleClosureRestriction(RecognizedPhraseHasAbbreviation.AbbreviationDomainRoleId), CopyClosureDirectiveOptions.None, delegate(ElementLink link, ICopyClosureTargetState targetState)
				{
					// Refined aliases are only included if the refined instance is included. Unrefined aliases are contained automatically.
					NameAlias alias = ((RecognizedPhraseHasAbbreviation)link).Abbreviation;
					return alias.RefinedInstance == null ? CopyClosureBehavior.ContainedPart : CopyClosureBehavior.Ignored;
				});
			...
			closureManager.AddCopyClosureDirective(new DomainRoleClosureRestriction(RoleSetDerivationProjection.DerivationRuleDomainRoleId), new DomainRoleClosureRestriction(RoleSetDerivationProjection.RolePathDomainRoleId), CopyClosureDirectiveOptions.None, delegate(ElementLink link, ICopyClosureTargetState targetState)
				{
			...
			closureManager.AddCopyClosureDirective(new DomainRoleClosureRestriction(SubqueryParameterInput.InputsDomainRoleId), new DomainRoleClosureRestriction(SubqueryParameterInput.ParameterDomainRoleId), CopyClosureDirectiveOptions.None, CopyClosureBehavior.ExternalReferencedPart);
			closureManager.AddCopyClosureDirective(new DomainRoleClosureRestriction(SubqueryParameterInputFromCalculatedPathValue.ParameterInputDomainRoleId), new DomainRoleClosureRestriction(SubqueryParameterInputFromCalculatedPathValue.SourceDomainRoleId), CopyClosureDirectiveOptions.None, CopyClosureBehavior.InternalReferencedPart);
			...
			closureManager.AddCopyClosureDirective(new DomainRoleClosureRestriction(SubqueryParameterInputFromPathedRole.ParameterInputDomainRoleId), new DomainRoleClosureRestriction(SubqueryParameterInputFromPathedRole.SourceDomainRoleId), CopyClosureDirectiveOptions.None, CopyClosureBehavior.InternalReferencedPart);
			closureManager.AddCopyClosureDirective(new DomainRoleClosureRestriction(SubqueryParameterInputFromRolePathRoot.ParameterInputDomainRoleId), new DomainRoleClosureRestriction(SubqueryParameterInputFromRolePathRoot.SourceDomainRoleId), CopyClosureDirectiveOptions.None, CopyClosureBehavior.InternalReferencedPart);
			closureManager.AddCopyClosureDirective(new DomainRoleClosureRestriction(SubqueryParameterInputs.RolePathDomainRoleId), new DomainRoleClosureRestriction(SubqueryParameterInputs.PathedEntryRoleDomainRoleId), CopyClosureDirectiveOptions.None, CopyClosureBehavior.ContainedPart);
			closureManager.AddCopyClosureDirective(new DomainRoleClosureRestriction(UnaryFactTypeHasNegationFactType.PositiveFactTypeDomainRoleId), new DomainRoleClosureRestriction(UnaryFactTypeHasNegationFactType.NegativeFactTypeDomainRoleId), CopyClosureDirectiveOptions.None, CopyClosureBehavior.ExternalCompositePart);
			closureManager.AddCopyClosureDirective(new DomainRoleClosureRestriction(UnaryFactTypeHasNegationFactType.NegativeFactTypeDomainRoleId), new DomainRoleClosureRestriction(UnaryFactTypeHasNegationFactType.PositiveFactTypeDomainRoleId), CopyClosureDirectiveOptions.None, CopyClosureBehavior.ExternalCompositePart);
