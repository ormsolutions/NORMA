...
namespace ORMSolutions.ORMArchitect.Core.ObjectModel
{
	...
	public partial class ORMCoreDomainModel : DslModeling::DomainModel
	{
		...
		public sealed override DslModeling::ModelElement CreateElement(DslModeling::Partition partition, global::System.Type elementType, DslModeling::PropertyAssignment[] propertyAssignments)
		{
			...
			{
				createElementMap = new global::System.Collections.Generic.Dictionary<global::System.Type, int>(201);
				...
				createElementMap.Add(typeof(ModelErrorDisplayFilter), 5);
				createElementMap.Add(typeof(ElementGroupingSet), 6);
				createElementMap.Add(typeof(ElementGrouping), 7);
				createElementMap.Add(typeof(ElementGroupingDuplicateNameError), 8);
				createElementMap.Add(typeof(ElementGroupingMembershipContradictionError), 9);
				createElementMap.Add(typeof(ORMModel), 10);
				createElementMap.Add(typeof(ObjectType), 11);
				createElementMap.Add(typeof(FactType), 12);
				createElementMap.Add(typeof(SubtypeFact), 13);
				createElementMap.Add(typeof(RoleProxy), 14);
				createElementMap.Add(typeof(Role), 15);
				createElementMap.Add(typeof(ObjectifiedUnaryRole), 16);
				createElementMap.Add(typeof(NameAlias), 17);
				createElementMap.Add(typeof(EqualityConstraint), 18);
				createElementMap.Add(typeof(ExclusionConstraint), 19);
				createElementMap.Add(typeof(SubsetConstraint), 20);
				createElementMap.Add(typeof(SetComparisonConstraintRoleSequence), 21);
				createElementMap.Add(typeof(RingConstraint), 22);
				createElementMap.Add(typeof(FrequencyConstraint), 23);
				createElementMap.Add(typeof(UniquenessConstraint), 24);
				createElementMap.Add(typeof(MandatoryConstraint), 25);
				createElementMap.Add(typeof(ValueComparisonConstraint), 26);
				createElementMap.Add(typeof(LeadRolePath), 27);
				createElementMap.Add(typeof(RoleSubPath), 28);
				createElementMap.Add(typeof(PathObjectUnifier), 29);
				createElementMap.Add(typeof(CalculatedPathValue), 30);
				createElementMap.Add(typeof(PathConstant), 31);
				createElementMap.Add(typeof(Function), 32);
				createElementMap.Add(typeof(FunctionParameter), 33);
				createElementMap.Add(typeof(CalculatedPathValueInput), 34);
				createElementMap.Add(typeof(QueryParameter), 35);
				createElementMap.Add(typeof(Subquery), 36);
				createElementMap.Add(typeof(FactTypeDerivationRule), 37);
				createElementMap.Add(typeof(QueryDerivationRule), 38);
				createElementMap.Add(typeof(SubtypeDerivationRule), 39);
				createElementMap.Add(typeof(ConstraintRoleSequenceJoinPath), 40);
				createElementMap.Add(typeof(PathRequiresRootObjectTypeError), 41);
				createElementMap.Add(typeof(PathSameFactTypeRoleFollowsJoinError), 42);
				createElementMap.Add(typeof(JoinedPathRoleRequiresCompatibleRolePlayerError), 43);
				createElementMap.Add(typeof(PathObjectUnifierRequiresCompatibleObjectTypesError), 44);
				createElementMap.Add(typeof(PathOuterJoinRequiresOptionalRoleError), 45);
				createElementMap.Add(typeof(CalculatedPathValueRequiresFunctionError), 46);
				createElementMap.Add(typeof(CalculatedPathValueRequiresAggregationContextError), 47);
				createElementMap.Add(typeof(CalculatedPathValueParameterBindingError), 48);
				createElementMap.Add(typeof(CalculatedPathValueMustBeConsumedError), 49);
				createElementMap.Add(typeof(RoleProjectedDerivationRequiresProjectionError), 50);
				createElementMap.Add(typeof(PartialRoleSetDerivationProjectionError), 51);
				createElementMap.Add(typeof(DerivedRoleRequiresCompatibleProjectionError), 52);
				createElementMap.Add(typeof(ConstraintRoleSequenceJoinPathRequiresProjectionError), 53);
				createElementMap.Add(typeof(PartialConstraintRoleSequenceJoinPathProjectionError), 54);
				createElementMap.Add(typeof(ConstraintRoleRequiresCompatibleJoinPathProjectionError), 55);
				createElementMap.Add(typeof(TooFewRoleSequencesError), 56);
				createElementMap.Add(typeof(TooManyRoleSequencesError), 57);
				createElementMap.Add(typeof(ObjectTypeDuplicateNameError), 58);
				createElementMap.Add(typeof(RecognizedPhraseDuplicateNameError), 59);
				createElementMap.Add(typeof(FunctionDuplicateNameError), 60);
				createElementMap.Add(typeof(DuplicateReadingSignatureError), 61);
				createElementMap.Add(typeof(PopulationUniquenessError), 62);
				createElementMap.Add(typeof(ExclusionContradictsMandatoryError), 63);
				createElementMap.Add(typeof(ExclusionContradictsEqualityError), 64);
				createElementMap.Add(typeof(ExclusionContradictsSubsetError), 65);
				createElementMap.Add(typeof(NotWellModeledSubsetAndMandatoryError), 66);
				createElementMap.Add(typeof(PopulationMandatoryError), 67);
				createElementMap.Add(typeof(ObjectifiedInstanceRequiredError), 68);
				createElementMap.Add(typeof(ObjectifyingInstanceRequiredError), 69);
				createElementMap.Add(typeof(ConstraintDuplicateNameError), 70);
				createElementMap.Add(typeof(TooFewReadingRolesError), 71);
				createElementMap.Add(typeof(TooManyReadingRolesError), 72);
				createElementMap.Add(typeof(ExternalConstraintRoleSequenceArityMismatchError), 73);
				createElementMap.Add(typeof(FactTypeRequiresReadingError), 74);
				createElementMap.Add(typeof(FactTypeRequiresInternalUniquenessConstraintError), 75);
				createElementMap.Add(typeof(DataTypeNotSpecifiedError), 76);
				createElementMap.Add(typeof(NMinusOneError), 77);
				createElementMap.Add(typeof(CompatibleRolePlayerTypeError), 78);
				createElementMap.Add(typeof(SupersetRoleOfSubtypeSubsetConstraintNotSubtypeError), 79);
				createElementMap.Add(typeof(JoinPathRequiredError), 80);
				createElementMap.Add(typeof(RolePlayerRequiredError), 81);
				createElementMap.Add(typeof(EntityTypeRequiresReferenceSchemeError), 82);
				createElementMap.Add(typeof(FrequencyConstraintMinMaxError), 83);
				createElementMap.Add(typeof(FrequencyConstraintExactlyOneError), 84);
				createElementMap.Add(typeof(FrequencyConstraintNonRestrictiveRangeError), 85);
				createElementMap.Add(typeof(ReadingRequiresUserModificationError), 86);
				createElementMap.Add(typeof(ReferenceModeKind), 87);
				createElementMap.Add(typeof(IntrinsicReferenceMode), 88);
				createElementMap.Add(typeof(CustomReferenceMode), 89);
				createElementMap.Add(typeof(UnspecifiedDataType), 90);
				createElementMap.Add(typeof(FixedLengthTextDataType), 91);
				createElementMap.Add(typeof(VariableLengthTextDataType), 92);
				createElementMap.Add(typeof(LargeLengthTextDataType), 93);
				createElementMap.Add(typeof(SignedIntegerNumericDataType), 94);
				createElementMap.Add(typeof(SignedSmallIntegerNumericDataType), 95);
				createElementMap.Add(typeof(SignedLargeIntegerNumericDataType), 96);
				createElementMap.Add(typeof(UnsignedIntegerNumericDataType), 97);
				createElementMap.Add(typeof(UnsignedTinyIntegerNumericDataType), 98);
				createElementMap.Add(typeof(UnsignedSmallIntegerNumericDataType), 99);
				createElementMap.Add(typeof(UnsignedLargeIntegerNumericDataType), 100);
				createElementMap.Add(typeof(AutoCounterNumericDataType), 101);
				createElementMap.Add(typeof(FloatingPointNumericDataType), 102);
				createElementMap.Add(typeof(SinglePrecisionFloatingPointNumericDataType), 103);
				createElementMap.Add(typeof(DoublePrecisionFloatingPointNumericDataType), 104);
				createElementMap.Add(typeof(DecimalNumericDataType), 105);
				createElementMap.Add(typeof(MoneyNumericDataType), 106);
				createElementMap.Add(typeof(FixedLengthRawDataDataType), 107);
				createElementMap.Add(typeof(VariableLengthRawDataDataType), 108);
				createElementMap.Add(typeof(LargeLengthRawDataDataType), 109);
				createElementMap.Add(typeof(PictureRawDataDataType), 110);
				createElementMap.Add(typeof(OleObjectRawDataDataType), 111);
				createElementMap.Add(typeof(AutoTimestampTemporalDataType), 112);
				createElementMap.Add(typeof(TimeTemporalDataType), 113);
				createElementMap.Add(typeof(DateTemporalDataType), 114);
				createElementMap.Add(typeof(DateAndTimeTemporalDataType), 115);
			...
			switch (index)
			{
				...
				case 5: return new ModelErrorDisplayFilter(partition, propertyAssignments);
				case 6: return new ElementGroupingSet(partition, propertyAssignments);
				case 7: return new ElementGrouping(partition, propertyAssignments);
				case 8: return new ElementGroupingDuplicateNameError(partition, propertyAssignments);
				case 9: return new ElementGroupingMembershipContradictionError(partition, propertyAssignments);
				case 10: return new ORMModel(partition, propertyAssignments);
				case 11: return new ObjectType(partition, propertyAssignments);
				case 12: return new FactType(partition, propertyAssignments);
				case 13: return new SubtypeFact(partition, propertyAssignments);
				case 14: return new RoleProxy(partition, propertyAssignments);
				case 15: return new Role(partition, propertyAssignments);
				case 16: return new ObjectifiedUnaryRole(partition, propertyAssignments);
				case 17: return new NameAlias(partition, propertyAssignments);
				case 18: return new EqualityConstraint(partition, propertyAssignments);
				case 19: return new ExclusionConstraint(partition, propertyAssignments);
				case 20: return new SubsetConstraint(partition, propertyAssignments);
				case 21: return new SetComparisonConstraintRoleSequence(partition, propertyAssignments);
				case 22: return new RingConstraint(partition, propertyAssignments);
				case 23: return new FrequencyConstraint(partition, propertyAssignments);
				case 24: return new UniquenessConstraint(partition, propertyAssignments);
				case 25: return new MandatoryConstraint(partition, propertyAssignments);
				case 26: return new ValueComparisonConstraint(partition, propertyAssignments);
				...
				case 29: return new PathObjectUnifier(partition, propertyAssignments);
				case 30: return new CalculatedPathValue(partition, propertyAssignments);
				case 31: return new PathConstant(partition, propertyAssignments);
				case 32: return new Function(partition, propertyAssignments);
				case 33: return new FunctionParameter(partition, propertyAssignments);
				case 34: return new CalculatedPathValueInput(partition, propertyAssignments);
				case 35: return new QueryParameter(partition, propertyAssignments);
				case 36: return new Subquery(partition, propertyAssignments);
				case 37: return new FactTypeDerivationRule(partition, propertyAssignments);
				case 38: return new QueryDerivationRule(partition, propertyAssignments);
				case 39: return new SubtypeDerivationRule(partition, propertyAssignments);
				case 40: return new ConstraintRoleSequenceJoinPath(partition, propertyAssignments);
				case 41: return new PathRequiresRootObjectTypeError(partition, propertyAssignments);
				case 42: return new PathSameFactTypeRoleFollowsJoinError(partition, propertyAssignments);
				case 43: return new JoinedPathRoleRequiresCompatibleRolePlayerError(partition, propertyAssignments);
				case 44: return new PathObjectUnifierRequiresCompatibleObjectTypesError(partition, propertyAssignments);
				case 45: return new PathOuterJoinRequiresOptionalRoleError(partition, propertyAssignments);
				case 46: return new CalculatedPathValueRequiresFunctionError(partition, propertyAssignments);
				case 47: return new CalculatedPathValueRequiresAggregationContextError(partition, propertyAssignments);
				case 48: return new CalculatedPathValueParameterBindingError(partition, propertyAssignments);
				case 49: return new CalculatedPathValueMustBeConsumedError(partition, propertyAssignments);
				case 50: return new RoleProjectedDerivationRequiresProjectionError(partition, propertyAssignments);
				case 51: return new PartialRoleSetDerivationProjectionError(partition, propertyAssignments);
				case 52: return new DerivedRoleRequiresCompatibleProjectionError(partition, propertyAssignments);
				case 53: return new ConstraintRoleSequenceJoinPathRequiresProjectionError(partition, propertyAssignments);
				case 54: return new PartialConstraintRoleSequenceJoinPathProjectionError(partition, propertyAssignments);
				case 55: return new ConstraintRoleRequiresCompatibleJoinPathProjectionError(partition, propertyAssignments);
				case 56: return new TooFewRoleSequencesError(partition, propertyAssignments);
				case 57: return new TooManyRoleSequencesError(partition, propertyAssignments);
				case 58: return new ObjectTypeDuplicateNameError(partition, propertyAssignments);
				case 59: return new RecognizedPhraseDuplicateNameError(partition, propertyAssignments);
				case 60: return new FunctionDuplicateNameError(partition, propertyAssignments);
				case 61: return new DuplicateReadingSignatureError(partition, propertyAssignments);
				case 62: return new PopulationUniquenessError(partition, propertyAssignments);
				case 63: return new ExclusionContradictsMandatoryError(partition, propertyAssignments);
				case 64: return new ExclusionContradictsEqualityError(partition, propertyAssignments);
				case 65: return new ExclusionContradictsSubsetError(partition, propertyAssignments);
				case 66: return new NotWellModeledSubsetAndMandatoryError(partition, propertyAssignments);
				case 67: return new PopulationMandatoryError(partition, propertyAssignments);
				case 68: return new ObjectifiedInstanceRequiredError(partition, propertyAssignments);
				case 69: return new ObjectifyingInstanceRequiredError(partition, propertyAssignments);
				case 70: return new ConstraintDuplicateNameError(partition, propertyAssignments);
				case 71: return new TooFewReadingRolesError(partition, propertyAssignments);
				case 72: return new TooManyReadingRolesError(partition, propertyAssignments);
				case 73: return new ExternalConstraintRoleSequenceArityMismatchError(partition, propertyAssignments);
				case 74: return new FactTypeRequiresReadingError(partition, propertyAssignments);
				case 75: return new FactTypeRequiresInternalUniquenessConstraintError(partition, propertyAssignments);
				case 76: return new DataTypeNotSpecifiedError(partition, propertyAssignments);
				case 77: return new NMinusOneError(partition, propertyAssignments);
				case 78: return new CompatibleRolePlayerTypeError(partition, propertyAssignments);
				case 79: return new SupersetRoleOfSubtypeSubsetConstraintNotSubtypeError(partition, propertyAssignments);
				case 80: return new JoinPathRequiredError(partition, propertyAssignments);
				case 81: return new RolePlayerRequiredError(partition, propertyAssignments);
				case 82: return new EntityTypeRequiresReferenceSchemeError(partition, propertyAssignments);
				case 83: return new FrequencyConstraintMinMaxError(partition, propertyAssignments);
				case 84: return new FrequencyConstraintExactlyOneError(partition, propertyAssignments);
				case 85: return new FrequencyConstraintNonRestrictiveRangeError(partition, propertyAssignments);
				case 86: return new ReadingRequiresUserModificationError(partition, propertyAssignments);
				case 87: return new ReferenceModeKind(partition, propertyAssignments);
				case 88: return new IntrinsicReferenceMode(partition, propertyAssignments);
				case 89: return new CustomReferenceMode(partition, propertyAssignments);
				case 90: return new UnspecifiedDataType(partition, propertyAssignments);
				case 91: return new FixedLengthTextDataType(partition, propertyAssignments);
				case 92: return new VariableLengthTextDataType(partition, propertyAssignments);
				case 93: return new LargeLengthTextDataType(partition, propertyAssignments);
				case 94: return new SignedIntegerNumericDataType(partition, propertyAssignments);
				case 95: return new SignedSmallIntegerNumericDataType(partition, propertyAssignments);
				case 96: return new SignedLargeIntegerNumericDataType(partition, propertyAssignments);
				case 97: return new UnsignedIntegerNumericDataType(partition, propertyAssignments);
				case 98: return new UnsignedTinyIntegerNumericDataType(partition, propertyAssignments);
				case 99: return new UnsignedSmallIntegerNumericDataType(partition, propertyAssignments);
				case 100: return new UnsignedLargeIntegerNumericDataType(partition, propertyAssignments);
				case 101: return new AutoCounterNumericDataType(partition, propertyAssignments);
				case 102: return new FloatingPointNumericDataType(partition, propertyAssignments);
				case 103: return new SinglePrecisionFloatingPointNumericDataType(partition, propertyAssignments);
				case 104: return new DoublePrecisionFloatingPointNumericDataType(partition, propertyAssignments);
				case 105: return new DecimalNumericDataType(partition, propertyAssignments);
				case 106: return new MoneyNumericDataType(partition, propertyAssignments);
				case 107: return new FixedLengthRawDataDataType(partition, propertyAssignments);
				case 108: return new VariableLengthRawDataDataType(partition, propertyAssignments);
				case 109: return new LargeLengthRawDataDataType(partition, propertyAssignments);
				case 110: return new PictureRawDataDataType(partition, propertyAssignments);
				case 111: return new OleObjectRawDataDataType(partition, propertyAssignments);
				case 112: return new AutoTimestampTemporalDataType(partition, propertyAssignments);
				case 113: return new TimeTemporalDataType(partition, propertyAssignments);
				case 114: return new DateTemporalDataType(partition, propertyAssignments);
				case 115: return new DateAndTimeTemporalDataType(partition, propertyAssignments);
