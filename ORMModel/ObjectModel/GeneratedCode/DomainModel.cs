...
namespace ORMSolutions.ORMArchitect.Core.ObjectModel
{
	...
	public partial class ORMCoreDomainModel : DslModeling::DomainModel
	{
		...
		public sealed override DslModeling::ModelElement CreateElement(DslModeling::Partition partition, global::System.Type elementType, DslModeling::PropertyAssignment[] propertyAssignments)
		{
			...
			{
				createElementMap = new global::System.Collections.Generic.Dictionary<global::System.Type, int>(189);
				...
				createElementMap.Add(typeof(DuplicateReadingSignatureError), 59);
				createElementMap.Add(typeof(PopulationUniquenessError), 60);
				createElementMap.Add(typeof(ExclusionContradictsMandatoryError), 61);
				createElementMap.Add(typeof(ExclusionContradictsEqualityError), 62);
				createElementMap.Add(typeof(ExclusionContradictsSubsetError), 63);
				createElementMap.Add(typeof(NotWellModeledSubsetAndMandatoryError), 64);
				createElementMap.Add(typeof(PopulationMandatoryError), 65);
				createElementMap.Add(typeof(ObjectifiedInstanceRequiredError), 66);
				createElementMap.Add(typeof(ObjectifyingInstanceRequiredError), 67);
				createElementMap.Add(typeof(ConstraintDuplicateNameError), 68);
				createElementMap.Add(typeof(TooFewReadingRolesError), 69);
				createElementMap.Add(typeof(TooManyReadingRolesError), 70);
				createElementMap.Add(typeof(ExternalConstraintRoleSequenceArityMismatchError), 71);
				createElementMap.Add(typeof(FactTypeRequiresReadingError), 72);
				createElementMap.Add(typeof(FactTypeRequiresInternalUniquenessConstraintError), 73);
				createElementMap.Add(typeof(DataTypeNotSpecifiedError), 74);
				createElementMap.Add(typeof(NMinusOneError), 75);
				createElementMap.Add(typeof(CompatibleRolePlayerTypeError), 76);
				createElementMap.Add(typeof(SupersetRoleOfSubtypeSubsetConstraintNotSubtypeError), 77);
				createElementMap.Add(typeof(JoinPathRequiredError), 78);
				createElementMap.Add(typeof(RolePlayerRequiredError), 79);
				createElementMap.Add(typeof(EntityTypeRequiresReferenceSchemeError), 80);
				createElementMap.Add(typeof(FrequencyConstraintMinMaxError), 81);
				createElementMap.Add(typeof(FrequencyConstraintExactlyOneError), 82);
				createElementMap.Add(typeof(FrequencyConstraintNonRestrictiveRangeError), 83);
				createElementMap.Add(typeof(ReadingRequiresUserModificationError), 84);
				createElementMap.Add(typeof(ReferenceModeKind), 85);
				createElementMap.Add(typeof(IntrinsicReferenceMode), 86);
				createElementMap.Add(typeof(CustomReferenceMode), 87);
				createElementMap.Add(typeof(UnspecifiedDataType), 88);
				createElementMap.Add(typeof(FixedLengthTextDataType), 89);
				createElementMap.Add(typeof(VariableLengthTextDataType), 90);
				createElementMap.Add(typeof(LargeLengthTextDataType), 91);
				createElementMap.Add(typeof(SignedIntegerNumericDataType), 92);
				createElementMap.Add(typeof(SignedSmallIntegerNumericDataType), 93);
				createElementMap.Add(typeof(SignedLargeIntegerNumericDataType), 94);
				createElementMap.Add(typeof(UnsignedIntegerNumericDataType), 95);
				createElementMap.Add(typeof(UnsignedTinyIntegerNumericDataType), 96);
				createElementMap.Add(typeof(UnsignedSmallIntegerNumericDataType), 97);
				createElementMap.Add(typeof(UnsignedLargeIntegerNumericDataType), 98);
				createElementMap.Add(typeof(AutoCounterNumericDataType), 99);
				createElementMap.Add(typeof(FloatingPointNumericDataType), 100);
				createElementMap.Add(typeof(SinglePrecisionFloatingPointNumericDataType), 101);
				createElementMap.Add(typeof(DoublePrecisionFloatingPointNumericDataType), 102);
				createElementMap.Add(typeof(DecimalNumericDataType), 103);
				createElementMap.Add(typeof(MoneyNumericDataType), 104);
				createElementMap.Add(typeof(FixedLengthRawDataDataType), 105);
				createElementMap.Add(typeof(VariableLengthRawDataDataType), 106);
				createElementMap.Add(typeof(LargeLengthRawDataDataType), 107);
				createElementMap.Add(typeof(PictureRawDataDataType), 108);
				createElementMap.Add(typeof(OleObjectRawDataDataType), 109);
				createElementMap.Add(typeof(AutoTimestampTemporalDataType), 110);
				createElementMap.Add(typeof(TimeTemporalDataType), 111);
				createElementMap.Add(typeof(DateTemporalDataType), 112);
				createElementMap.Add(typeof(DateAndTimeTemporalDataType), 113);
				createElementMap.Add(typeof(TrueOrFalseLogicalDataType), 114);
				createElementMap.Add(typeof(YesOrNoLogicalDataType), 115);
				createElementMap.Add(typeof(RowIdOtherDataType), 116);
				createElementMap.Add(typeof(ObjectIdOtherDataType), 117);
				createElementMap.Add(typeof(Reading), 118);
				createElementMap.Add(typeof(ReadingOrder), 119);
				createElementMap.Add(typeof(ValueRange), 120);
				createElementMap.Add(typeof(ValueTypeValueConstraint), 121);
				createElementMap.Add(typeof(RoleValueConstraint), 122);
				createElementMap.Add(typeof(PathConditionRoleValueConstraint), 123);
				createElementMap.Add(typeof(PathConditionRootValueConstraint), 124);
				createElementMap.Add(typeof(MinValueMismatchError), 125);
				createElementMap.Add(typeof(MaxValueMismatchError), 126);
				createElementMap.Add(typeof(ImpliedInternalUniquenessConstraintError), 127);
				createElementMap.Add(typeof(FrequencyConstraintViolatedByUniquenessConstraintError), 128);
				createElementMap.Add(typeof(RingConstraintTypeNotSpecifiedError), 129);
				createElementMap.Add(typeof(SubtypeMetaRole), 130);
				createElementMap.Add(typeof(SupertypeMetaRole), 131);
				createElementMap.Add(typeof(Definition), 132);
				createElementMap.Add(typeof(Note), 133);
				createElementMap.Add(typeof(ModelNote), 134);
				createElementMap.Add(typeof(CompatibleSupertypesError), 135);
				createElementMap.Add(typeof(ImplicationError), 136);
				createElementMap.Add(typeof(EqualityOrSubsetImpliedByMandatoryError), 137);
				createElementMap.Add(typeof(PreferredIdentifierRequiresMandatoryError), 138);
				createElementMap.Add(typeof(ValueRangeOverlapError), 139);
				createElementMap.Add(typeof(ValueConstraintValueTypeDetachedError), 140);
				createElementMap.Add(typeof(DerivationNote), 141);
				createElementMap.Add(typeof(FactTypeDerivationExpression), 142);
				createElementMap.Add(typeof(SubtypeDerivationExpression), 143);
				createElementMap.Add(typeof(EntityTypeInstance), 144);
				createElementMap.Add(typeof(EntityTypeSubtypeInstance), 145);
				createElementMap.Add(typeof(ValueTypeInstance), 146);
				createElementMap.Add(typeof(FactTypeInstance), 147);
				createElementMap.Add(typeof(TooFewEntityTypeRoleInstancesError), 148);
				createElementMap.Add(typeof(TooFewFactTypeRoleInstancesError), 149);
				createElementMap.Add(typeof(CompatibleValueTypeInstanceValueError), 150);
			}
			int index;
			...
			switch (index)
			{
				...
				case 59: return new DuplicateReadingSignatureError(partition, propertyAssignments);
				case 60: return new PopulationUniquenessError(partition, propertyAssignments);
				case 61: return new ExclusionContradictsMandatoryError(partition, propertyAssignments);
				case 62: return new ExclusionContradictsEqualityError(partition, propertyAssignments);
				case 63: return new ExclusionContradictsSubsetError(partition, propertyAssignments);
				case 64: return new NotWellModeledSubsetAndMandatoryError(partition, propertyAssignments);
				case 65: return new PopulationMandatoryError(partition, propertyAssignments);
				case 66: return new ObjectifiedInstanceRequiredError(partition, propertyAssignments);
				case 67: return new ObjectifyingInstanceRequiredError(partition, propertyAssignments);
				case 68: return new ConstraintDuplicateNameError(partition, propertyAssignments);
				case 69: return new TooFewReadingRolesError(partition, propertyAssignments);
				case 70: return new TooManyReadingRolesError(partition, propertyAssignments);
				case 71: return new ExternalConstraintRoleSequenceArityMismatchError(partition, propertyAssignments);
				case 72: return new FactTypeRequiresReadingError(partition, propertyAssignments);
				case 73: return new FactTypeRequiresInternalUniquenessConstraintError(partition, propertyAssignments);
				case 74: return new DataTypeNotSpecifiedError(partition, propertyAssignments);
				case 75: return new NMinusOneError(partition, propertyAssignments);
				case 76: return new CompatibleRolePlayerTypeError(partition, propertyAssignments);
				case 77: return new SupersetRoleOfSubtypeSubsetConstraintNotSubtypeError(partition, propertyAssignments);
				case 78: return new JoinPathRequiredError(partition, propertyAssignments);
				case 79: return new RolePlayerRequiredError(partition, propertyAssignments);
				case 80: return new EntityTypeRequiresReferenceSchemeError(partition, propertyAssignments);
				case 81: return new FrequencyConstraintMinMaxError(partition, propertyAssignments);
				case 82: return new FrequencyConstraintExactlyOneError(partition, propertyAssignments);
				case 83: return new FrequencyConstraintNonRestrictiveRangeError(partition, propertyAssignments);
				case 84: return new ReadingRequiresUserModificationError(partition, propertyAssignments);
				case 85: return new ReferenceModeKind(partition, propertyAssignments);
				case 86: return new IntrinsicReferenceMode(partition, propertyAssignments);
				case 87: return new CustomReferenceMode(partition, propertyAssignments);
				case 88: return new UnspecifiedDataType(partition, propertyAssignments);
				case 89: return new FixedLengthTextDataType(partition, propertyAssignments);
				case 90: return new VariableLengthTextDataType(partition, propertyAssignments);
				case 91: return new LargeLengthTextDataType(partition, propertyAssignments);
				case 92: return new SignedIntegerNumericDataType(partition, propertyAssignments);
				case 93: return new SignedSmallIntegerNumericDataType(partition, propertyAssignments);
				case 94: return new SignedLargeIntegerNumericDataType(partition, propertyAssignments);
				case 95: return new UnsignedIntegerNumericDataType(partition, propertyAssignments);
				case 96: return new UnsignedTinyIntegerNumericDataType(partition, propertyAssignments);
				case 97: return new UnsignedSmallIntegerNumericDataType(partition, propertyAssignments);
				case 98: return new UnsignedLargeIntegerNumericDataType(partition, propertyAssignments);
				case 99: return new AutoCounterNumericDataType(partition, propertyAssignments);
				case 100: return new FloatingPointNumericDataType(partition, propertyAssignments);
				case 101: return new SinglePrecisionFloatingPointNumericDataType(partition, propertyAssignments);
				case 102: return new DoublePrecisionFloatingPointNumericDataType(partition, propertyAssignments);
				case 103: return new DecimalNumericDataType(partition, propertyAssignments);
				case 104: return new MoneyNumericDataType(partition, propertyAssignments);
				case 105: return new FixedLengthRawDataDataType(partition, propertyAssignments);
				case 106: return new VariableLengthRawDataDataType(partition, propertyAssignments);
				case 107: return new LargeLengthRawDataDataType(partition, propertyAssignments);
				case 108: return new PictureRawDataDataType(partition, propertyAssignments);
				case 109: return new OleObjectRawDataDataType(partition, propertyAssignments);
				case 110: return new AutoTimestampTemporalDataType(partition, propertyAssignments);
				case 111: return new TimeTemporalDataType(partition, propertyAssignments);
				case 112: return new DateTemporalDataType(partition, propertyAssignments);
				case 113: return new DateAndTimeTemporalDataType(partition, propertyAssignments);
				case 114: return new TrueOrFalseLogicalDataType(partition, propertyAssignments);
				case 115: return new YesOrNoLogicalDataType(partition, propertyAssignments);
				case 116: return new RowIdOtherDataType(partition, propertyAssignments);
				case 117: return new ObjectIdOtherDataType(partition, propertyAssignments);
				case 118: return new Reading(partition, propertyAssignments);
				case 119: return new ReadingOrder(partition, propertyAssignments);
				case 120: return new ValueRange(partition, propertyAssignments);
				case 121: return new ValueTypeValueConstraint(partition, propertyAssignments);
				case 122: return new RoleValueConstraint(partition, propertyAssignments);
				case 123: return new PathConditionRoleValueConstraint(partition, propertyAssignments);
				case 124: return new PathConditionRootValueConstraint(partition, propertyAssignments);
				case 125: return new MinValueMismatchError(partition, propertyAssignments);
				case 126: return new MaxValueMismatchError(partition, propertyAssignments);
				case 127: return new ImpliedInternalUniquenessConstraintError(partition, propertyAssignments);
				case 128: return new FrequencyConstraintViolatedByUniquenessConstraintError(partition, propertyAssignments);
				case 129: return new RingConstraintTypeNotSpecifiedError(partition, propertyAssignments);
				case 130: return new SubtypeMetaRole(partition, propertyAssignments);
				case 131: return new SupertypeMetaRole(partition, propertyAssignments);
				case 132: return new Definition(partition, propertyAssignments);
				case 133: return new Note(partition, propertyAssignments);
				case 134: return new ModelNote(partition, propertyAssignments);
				case 135: return new CompatibleSupertypesError(partition, propertyAssignments);
				case 136: return new ImplicationError(partition, propertyAssignments);
				case 137: return new EqualityOrSubsetImpliedByMandatoryError(partition, propertyAssignments);
				case 138: return new PreferredIdentifierRequiresMandatoryError(partition, propertyAssignments);
				case 139: return new ValueRangeOverlapError(partition, propertyAssignments);
				case 140: return new ValueConstraintValueTypeDetachedError(partition, propertyAssignments);
				case 141: return new DerivationNote(partition, propertyAssignments);
				case 142: return new FactTypeDerivationExpression(partition, propertyAssignments);
				case 143: return new SubtypeDerivationExpression(partition, propertyAssignments);
				case 144: return new EntityTypeInstance(partition, propertyAssignments);
				case 145: return new EntityTypeSubtypeInstance(partition, propertyAssignments);
				case 146: return new ValueTypeInstance(partition, propertyAssignments);
				case 147: return new FactTypeInstance(partition, propertyAssignments);
				case 148: return new TooFewEntityTypeRoleInstancesError(partition, propertyAssignments);
				case 149: return new TooFewFactTypeRoleInstancesError(partition, propertyAssignments);
				case 150: return new CompatibleValueTypeInstanceValueError(partition, propertyAssignments);
				default: return null;
			}
		}
		...
		public sealed override DslModeling::ElementLink CreateElementLink(DslModeling::Partition partition, global::System.Type elementLinkType, DslModeling::RoleAssignment[] roleAssignments, DslModeling::PropertyAssignment[] propertyAssignments)
		{
			...
			{
				createElementLinkMap = new global::System.Collections.Generic.Dictionary<global::System.Type, int>(228);
				...
				createElementLinkMap.Add(typeof(ValueConstraintHasDuplicateNameError), 78);
				createElementLinkMap.Add(typeof(ModelHasDefinition), 79);
				createElementLinkMap.Add(typeof(ObjectTypeHasDefinition), 80);
				createElementLinkMap.Add(typeof(FactTypeHasDefinition), 81);
				createElementLinkMap.Add(typeof(SetConstraintHasDefinition), 82);
				createElementLinkMap.Add(typeof(SetComparisonConstraintHasDefinition), 83);
				createElementLinkMap.Add(typeof(ValueConstraintHasDefinition), 84);
				createElementLinkMap.Add(typeof(ElementGroupingHasDefinition), 85);
				createElementLinkMap.Add(typeof(FactTypeHasNote), 86);
				createElementLinkMap.Add(typeof(ObjectTypeHasNote), 87);
				createElementLinkMap.Add(typeof(SetConstraintHasNote), 88);
				createElementLinkMap.Add(typeof(SetComparisonConstraintHasNote), 89);
				createElementLinkMap.Add(typeof(ValueConstraintHasNote), 90);
				createElementLinkMap.Add(typeof(ElementGroupingHasNote), 91);
				createElementLinkMap.Add(typeof(ModelHasPrimaryNote), 92);
				createElementLinkMap.Add(typeof(LeadRolePathHasNote), 93);
				createElementLinkMap.Add(typeof(ModelHasModelNote), 94);
				createElementLinkMap.Add(typeof(ModelNoteReferencesFactType), 95);
				createElementLinkMap.Add(typeof(ModelNoteReferencesObjectType), 96);
				createElementLinkMap.Add(typeof(ModelNoteReferencesSetConstraint), 97);
				createElementLinkMap.Add(typeof(ModelNoteReferencesSetComparisonConstraint), 98);
				createElementLinkMap.Add(typeof(ObjectTypeHasCompatibleSupertypesError), 99);
				createElementLinkMap.Add(typeof(SetConstraintHasImplicationError), 100);
				createElementLinkMap.Add(typeof(SetComparisonConstraintHasImplicationError), 101);
				createElementLinkMap.Add(typeof(SetComparisonConstraintHasEqualityOrSubsetImpliedByMandatoryError), 102);
				createElementLinkMap.Add(typeof(ObjectTypeHasPreferredIdentifierRequiresMandatoryError), 103);
				createElementLinkMap.Add(typeof(ValueConstraintHasValueRangeOverlapError), 104);
				createElementLinkMap.Add(typeof(ValueConstraintHasValueTypeDetachedError), 105);
				createElementLinkMap.Add(typeof(FactTypeHasRole), 106);
				createElementLinkMap.Add(typeof(ReadingOrderHasRole), 107);
				createElementLinkMap.Add(typeof(RoleProxyHasRole), 108);
				createElementLinkMap.Add(typeof(ObjectifiedUnaryRoleHasRole), 109);
				createElementLinkMap.Add(typeof(FactTypeHasDerivationExpression), 110);
				createElementLinkMap.Add(typeof(SubtypeHasDerivationExpression), 111);
				createElementLinkMap.Add(typeof(ObjectTypeHasObjectTypeInstance), 112);
				createElementLinkMap.Add(typeof(EntityTypeHasEntityTypeInstance), 113);
				createElementLinkMap.Add(typeof(EntityTypeSubtypeHasEntityTypeSubtypeInstance), 114);
				createElementLinkMap.Add(typeof(ValueTypeHasValueTypeInstance), 115);
				createElementLinkMap.Add(typeof(EntityTypeRoleInstance), 116);
				createElementLinkMap.Add(typeof(FactTypeRoleInstance), 117);
				createElementLinkMap.Add(typeof(EntityTypeInstanceHasRoleInstance), 118);
				createElementLinkMap.Add(typeof(EntityTypeSubtypeInstanceHasSupertypeInstance), 119);
				createElementLinkMap.Add(typeof(FactTypeHasFactTypeInstance), 120);
				createElementLinkMap.Add(typeof(FactTypeInstanceHasRoleInstance), 121);
				createElementLinkMap.Add(typeof(ObjectificationInstance), 122);
				createElementLinkMap.Add(typeof(ObjectifiedInstanceHasObjectifyingInstanceRequiredError), 123);
				createElementLinkMap.Add(typeof(ObjectifyingInstanceHasObjectifiedInstanceRequiredError), 124);
				createElementLinkMap.Add(typeof(EntityTypeInstanceHasTooFewEntityTypeRoleInstancesError), 125);
				createElementLinkMap.Add(typeof(FactTypeInstanceHasTooFewFactTypeRoleInstancesError), 126);
				createElementLinkMap.Add(typeof(ValueTypeInstanceHasCompatibleValueTypeInstanceValueError), 127);
				createElementLinkMap.Add(typeof(ConstraintRoleSequenceHasJoinPath), 128);
				createElementLinkMap.Add(typeof(ConstraintRoleSequenceJoinPathProjection), 129);
				createElementLinkMap.Add(typeof(ConstraintRoleProjection), 130);
				createElementLinkMap.Add(typeof(ConstraintRoleProjectedFromRolePathRoot), 131);
				createElementLinkMap.Add(typeof(ConstraintRoleProjectedFromPathedRole), 132);
				createElementLinkMap.Add(typeof(ConstraintRoleProjectedFromCalculatedPathValue), 133);
				createElementLinkMap.Add(typeof(ConstraintRoleProjectedFromPathConstant), 134);
				createElementLinkMap.Add(typeof(ConstraintRoleProjectedFromPathedRole_Deprecated), 135);
				createElementLinkMap.Add(typeof(ConstraintRoleProjectedFromCalculatedPathValue_Deprecated), 136);
				createElementLinkMap.Add(typeof(ConstraintRoleProjectedFromPathConstant_Deprecated), 137);
				createElementLinkMap.Add(typeof(ModelHasModelErrorDisplayFilter), 138);
				createElementLinkMap.Add(typeof(ElementGroupingSetRelatesToORMModel), 139);
				createElementLinkMap.Add(typeof(ElementGroupingSetContainsElementGrouping), 140);
				createElementLinkMap.Add(typeof(ElementGroupingIsOfElementGroupingType), 141);
				createElementLinkMap.Add(typeof(GroupingElementInclusion), 142);
				createElementLinkMap.Add(typeof(GroupingElementExclusion), 143);
				createElementLinkMap.Add(typeof(ElementGroupingIncludesElementGrouping), 144);
				createElementLinkMap.Add(typeof(ElementGroupingExcludesElementGrouping), 145);
				createElementLinkMap.Add(typeof(ElementGroupingHasDuplicateNameError), 146);
				createElementLinkMap.Add(typeof(ElementGroupingHasMembershipContradictionError), 147);
				createElementLinkMap.Add(typeof(GroupingMembershipContradictionErrorIsForElement), 148);
				createElementLinkMap.Add(typeof(RolePathOwnerHasPathComponent_Deprecated), 149);
				createElementLinkMap.Add(typeof(RolePathOwnerOwnsLeadRolePath), 150);
				createElementLinkMap.Add(typeof(RolePathOwnerUsesSharedLeadRolePath), 151);
				createElementLinkMap.Add(typeof(RolePathOwnerHasSingleLeadRolePath), 152);
				createElementLinkMap.Add(typeof(RolePathOwnerHasSingleOwnedLeadRolePath), 153);
				createElementLinkMap.Add(typeof(RolePathOwnerOwnsSubquery), 154);
				createElementLinkMap.Add(typeof(RolePathOwnerUsesSharedSubquery), 155);
				createElementLinkMap.Add(typeof(RolePathObjectTypeRoot), 156);
				createElementLinkMap.Add(typeof(PathedRole), 157);
				createElementLinkMap.Add(typeof(PathedRoleIsRemotelyCorrelatedWithPathedRole_Deprecated), 158);
				createElementLinkMap.Add(typeof(LeadRolePathHasObjectUnifier), 159);
				createElementLinkMap.Add(typeof(PathObjectUnifierUnifiesPathedRole), 160);
				createElementLinkMap.Add(typeof(PathObjectUnifierUnifiesRolePathRoot), 161);
				createElementLinkMap.Add(typeof(RoleSubPathIsContinuationOfRolePath), 162);
				createElementLinkMap.Add(typeof(ModelDefinesFunction), 163);
				createElementLinkMap.Add(typeof(FunctionOperatesOnParameter), 164);
				createElementLinkMap.Add(typeof(RolePathOwnerCalculatesCalculatedPathValue_Deprecated), 165);
				createElementLinkMap.Add(typeof(LeadRolePathCalculatesCalculatedPathValue), 166);
				createElementLinkMap.Add(typeof(LeadRolePathSatisfiesCalculatedCondition), 167);
				createElementLinkMap.Add(typeof(CalculatedPathValueHasInput), 168);
				createElementLinkMap.Add(typeof(CalculatedPathValueScopedWithPathedRole_Deprecated), 169);
				createElementLinkMap.Add(typeof(CalculatedPathValueAggregationContextIncludesPathedRole), 170);
				createElementLinkMap.Add(typeof(CalculatedPathValueAggregationContextIncludesRolePathRoot), 171);
				createElementLinkMap.Add(typeof(CalculatedPathValueIsCalculatedWithFunction), 172);
				createElementLinkMap.Add(typeof(CalculatedPathValueInputCorrespondsToFunctionParameter), 173);
				createElementLinkMap.Add(typeof(CalculatedPathValueInputBindsToRolePathRoot), 174);
				createElementLinkMap.Add(typeof(CalculatedPathValueInputBindsToPathedRole), 175);
				createElementLinkMap.Add(typeof(CalculatedPathValueInputBindsToCalculatedPathValue), 176);
				createElementLinkMap.Add(typeof(CalculatedPathValueInputBindsToPathConstant), 177);
				createElementLinkMap.Add(typeof(QueryDefinesParameter), 178);
				createElementLinkMap.Add(typeof(QueryParameterHasParameterType), 179);
				createElementLinkMap.Add(typeof(QueryParameterBinding), 180);
				createElementLinkMap.Add(typeof(QueryParameterBoundToRolePathRoot), 181);
				createElementLinkMap.Add(typeof(QueryParameterBoundToPathedRole), 182);
				createElementLinkMap.Add(typeof(SubqueryParameterInputs), 183);
				createElementLinkMap.Add(typeof(SubqueryParameterInput), 184);
				createElementLinkMap.Add(typeof(SubqueryParameterInputFromRolePathRoot), 185);
				createElementLinkMap.Add(typeof(SubqueryParameterInputFromPathedRole), 186);
				createElementLinkMap.Add(typeof(SubqueryParameterInputFromCalculatedPathValue), 187);
				createElementLinkMap.Add(typeof(SubqueryParameterInputFromPathConstant), 188);
				createElementLinkMap.Add(typeof(FactTypeHasDerivationRule), 189);
				createElementLinkMap.Add(typeof(FactTypeDerivationRuleHasDerivationNote), 190);
				createElementLinkMap.Add(typeof(RoleSetDerivationProjection), 191);
				createElementLinkMap.Add(typeof(DerivedRoleProjection), 192);
				createElementLinkMap.Add(typeof(DerivedRoleProjectedFromRolePathRoot), 193);
				createElementLinkMap.Add(typeof(DerivedRoleProjectedFromPathedRole), 194);
				createElementLinkMap.Add(typeof(DerivedRoleProjectedFromCalculatedPathValue), 195);
				createElementLinkMap.Add(typeof(DerivedRoleProjectedFromPathConstant), 196);
				createElementLinkMap.Add(typeof(RoleDerivesFromPathedRole_Deprecated), 197);
				createElementLinkMap.Add(typeof(RoleDerivesFromCalculatedPathValue_Deprecated), 198);
				createElementLinkMap.Add(typeof(RoleDerivesFromPathConstant_Deprecated), 199);
				createElementLinkMap.Add(typeof(SubtypeHasDerivationRule), 200);
				createElementLinkMap.Add(typeof(SubtypeDerivationRuleHasDerivationNote), 201);
				createElementLinkMap.Add(typeof(RolePathHasRootObjectTypeError), 202);
				createElementLinkMap.Add(typeof(PathedRoleHasCompatibleJoinRolePlayerError), 203);
				createElementLinkMap.Add(typeof(PathObjectUnifierHasCompatibleObjectTypesError), 204);
				createElementLinkMap.Add(typeof(PathedRoleHasSameFactTypeFollowsJoinError), 205);
				createElementLinkMap.Add(typeof(PathedRoleHasMandatoryOuterJoinError), 206);
				createElementLinkMap.Add(typeof(CalculatedPathValueHasFunctionRequiredError), 207);
				createElementLinkMap.Add(typeof(CalculatedPathValueHasUnboundParameterError), 208);
				createElementLinkMap.Add(typeof(CalculatedPathValueParameterBindingErrorTargetsFunctionParameter), 209);
				createElementLinkMap.Add(typeof(CalculatedPathValueHasConsumptionRequiredError), 210);
				createElementLinkMap.Add(typeof(CalculatedPathValueHasAggregationContextRequiredError), 211);
				createElementLinkMap.Add(typeof(RoleProjectedDerivationRuleHasProjectionRequiredError), 212);
				createElementLinkMap.Add(typeof(RoleSetDerivationProjectionHasPartialProjectionError), 213);
				createElementLinkMap.Add(typeof(DerivedRoleProjectionHasDerivedRoleRequiresCompatibleProjectionError), 214);
				createElementLinkMap.Add(typeof(ConstraintRoleSequenceJoinPathHasProjectionRequiredError), 215);
				createElementLinkMap.Add(typeof(ConstraintRoleSequenceProjectionHasPartialProjectionError), 216);
				createElementLinkMap.Add(typeof(ConstraintRoleProjectionHasConstraintRoleRequiresCompatibleJoinPathProjectionError), 217);
			}
			int index;
			...
			switch (index)
			{
				...
				case 78: return new ValueConstraintHasDuplicateNameError(partition, roleAssignments, propertyAssignments);
				case 79: return new ModelHasDefinition(partition, roleAssignments, propertyAssignments);
				case 80: return new ObjectTypeHasDefinition(partition, roleAssignments, propertyAssignments);
				case 81: return new FactTypeHasDefinition(partition, roleAssignments, propertyAssignments);
				case 82: return new SetConstraintHasDefinition(partition, roleAssignments, propertyAssignments);
				case 83: return new SetComparisonConstraintHasDefinition(partition, roleAssignments, propertyAssignments);
				case 84: return new ValueConstraintHasDefinition(partition, roleAssignments, propertyAssignments);
				case 85: return new ElementGroupingHasDefinition(partition, roleAssignments, propertyAssignments);
				case 86: return new FactTypeHasNote(partition, roleAssignments, propertyAssignments);
				case 87: return new ObjectTypeHasNote(partition, roleAssignments, propertyAssignments);
				case 88: return new SetConstraintHasNote(partition, roleAssignments, propertyAssignments);
				case 89: return new SetComparisonConstraintHasNote(partition, roleAssignments, propertyAssignments);
				case 90: return new ValueConstraintHasNote(partition, roleAssignments, propertyAssignments);
				case 91: return new ElementGroupingHasNote(partition, roleAssignments, propertyAssignments);
				case 92: return new ModelHasPrimaryNote(partition, roleAssignments, propertyAssignments);
				case 93: return new LeadRolePathHasNote(partition, roleAssignments, propertyAssignments);
				case 94: return new ModelHasModelNote(partition, roleAssignments, propertyAssignments);
				case 95: return new ModelNoteReferencesFactType(partition, roleAssignments, propertyAssignments);
				case 96: return new ModelNoteReferencesObjectType(partition, roleAssignments, propertyAssignments);
				case 97: return new ModelNoteReferencesSetConstraint(partition, roleAssignments, propertyAssignments);
				case 98: return new ModelNoteReferencesSetComparisonConstraint(partition, roleAssignments, propertyAssignments);
				case 99: return new ObjectTypeHasCompatibleSupertypesError(partition, roleAssignments, propertyAssignments);
				case 100: return new SetConstraintHasImplicationError(partition, roleAssignments, propertyAssignments);
				case 101: return new SetComparisonConstraintHasImplicationError(partition, roleAssignments, propertyAssignments);
				case 102: return new SetComparisonConstraintHasEqualityOrSubsetImpliedByMandatoryError(partition, roleAssignments, propertyAssignments);
				case 103: return new ObjectTypeHasPreferredIdentifierRequiresMandatoryError(partition, roleAssignments, propertyAssignments);
				case 104: return new ValueConstraintHasValueRangeOverlapError(partition, roleAssignments, propertyAssignments);
				case 105: return new ValueConstraintHasValueTypeDetachedError(partition, roleAssignments, propertyAssignments);
				case 106: return new FactTypeHasRole(partition, roleAssignments, propertyAssignments);
				case 107: return new ReadingOrderHasRole(partition, roleAssignments, propertyAssignments);
				case 108: return new RoleProxyHasRole(partition, roleAssignments, propertyAssignments);
				case 109: return new ObjectifiedUnaryRoleHasRole(partition, roleAssignments, propertyAssignments);
				case 110: return new FactTypeHasDerivationExpression(partition, roleAssignments, propertyAssignments);
				case 111: return new SubtypeHasDerivationExpression(partition, roleAssignments, propertyAssignments);
				case 112: return new ObjectTypeHasObjectTypeInstance(partition, roleAssignments, propertyAssignments);
				case 113: return new EntityTypeHasEntityTypeInstance(partition, roleAssignments, propertyAssignments);
				case 114: return new EntityTypeSubtypeHasEntityTypeSubtypeInstance(partition, roleAssignments, propertyAssignments);
				case 115: return new ValueTypeHasValueTypeInstance(partition, roleAssignments, propertyAssignments);
				case 116: return new EntityTypeRoleInstance(partition, roleAssignments, propertyAssignments);
				case 117: return new FactTypeRoleInstance(partition, roleAssignments, propertyAssignments);
				case 118: return new EntityTypeInstanceHasRoleInstance(partition, roleAssignments, propertyAssignments);
				case 119: return new EntityTypeSubtypeInstanceHasSupertypeInstance(partition, roleAssignments, propertyAssignments);
				case 120: return new FactTypeHasFactTypeInstance(partition, roleAssignments, propertyAssignments);
				case 121: return new FactTypeInstanceHasRoleInstance(partition, roleAssignments, propertyAssignments);
				case 122: return new ObjectificationInstance(partition, roleAssignments, propertyAssignments);
				case 123: return new ObjectifiedInstanceHasObjectifyingInstanceRequiredError(partition, roleAssignments, propertyAssignments);
				case 124: return new ObjectifyingInstanceHasObjectifiedInstanceRequiredError(partition, roleAssignments, propertyAssignments);
				case 125: return new EntityTypeInstanceHasTooFewEntityTypeRoleInstancesError(partition, roleAssignments, propertyAssignments);
				case 126: return new FactTypeInstanceHasTooFewFactTypeRoleInstancesError(partition, roleAssignments, propertyAssignments);
				case 127: return new ValueTypeInstanceHasCompatibleValueTypeInstanceValueError(partition, roleAssignments, propertyAssignments);
				case 128: return new ConstraintRoleSequenceHasJoinPath(partition, roleAssignments, propertyAssignments);
				case 129: return new ConstraintRoleSequenceJoinPathProjection(partition, roleAssignments, propertyAssignments);
				case 130: return new ConstraintRoleProjection(partition, roleAssignments, propertyAssignments);
				case 131: return new ConstraintRoleProjectedFromRolePathRoot(partition, roleAssignments, propertyAssignments);
				case 132: return new ConstraintRoleProjectedFromPathedRole(partition, roleAssignments, propertyAssignments);
				case 133: return new ConstraintRoleProjectedFromCalculatedPathValue(partition, roleAssignments, propertyAssignments);
				case 134: return new ConstraintRoleProjectedFromPathConstant(partition, roleAssignments, propertyAssignments);
				case 135: return new ConstraintRoleProjectedFromPathedRole_Deprecated(partition, roleAssignments, propertyAssignments);
				case 136: return new ConstraintRoleProjectedFromCalculatedPathValue_Deprecated(partition, roleAssignments, propertyAssignments);
				case 137: return new ConstraintRoleProjectedFromPathConstant_Deprecated(partition, roleAssignments, propertyAssignments);
				case 138: return new ModelHasModelErrorDisplayFilter(partition, roleAssignments, propertyAssignments);
				case 139: return new ElementGroupingSetRelatesToORMModel(partition, roleAssignments, propertyAssignments);
				case 140: return new ElementGroupingSetContainsElementGrouping(partition, roleAssignments, propertyAssignments);
				case 141: return new ElementGroupingIsOfElementGroupingType(partition, roleAssignments, propertyAssignments);
				case 142: return new GroupingElementInclusion(partition, roleAssignments, propertyAssignments);
				case 143: return new GroupingElementExclusion(partition, roleAssignments, propertyAssignments);
				case 144: return new ElementGroupingIncludesElementGrouping(partition, roleAssignments, propertyAssignments);
				case 145: return new ElementGroupingExcludesElementGrouping(partition, roleAssignments, propertyAssignments);
				case 146: return new ElementGroupingHasDuplicateNameError(partition, roleAssignments, propertyAssignments);
				case 147: return new ElementGroupingHasMembershipContradictionError(partition, roleAssignments, propertyAssignments);
				case 148: return new GroupingMembershipContradictionErrorIsForElement(partition, roleAssignments, propertyAssignments);
				case 149: return new RolePathOwnerHasPathComponent_Deprecated(partition, roleAssignments, propertyAssignments);
				case 150: return new RolePathOwnerOwnsLeadRolePath(partition, roleAssignments, propertyAssignments);
				case 151: return new RolePathOwnerUsesSharedLeadRolePath(partition, roleAssignments, propertyAssignments);
				case 152: return new RolePathOwnerHasSingleLeadRolePath(partition, roleAssignments, propertyAssignments);
				case 153: return new RolePathOwnerHasSingleOwnedLeadRolePath(partition, roleAssignments, propertyAssignments);
				case 154: return new RolePathOwnerOwnsSubquery(partition, roleAssignments, propertyAssignments);
				case 155: return new RolePathOwnerUsesSharedSubquery(partition, roleAssignments, propertyAssignments);
				case 156: return new RolePathObjectTypeRoot(partition, roleAssignments, propertyAssignments);
				case 157: return new PathedRole(partition, roleAssignments, propertyAssignments);
				case 158: return new PathedRoleIsRemotelyCorrelatedWithPathedRole_Deprecated(partition, roleAssignments, propertyAssignments);
				case 159: return new LeadRolePathHasObjectUnifier(partition, roleAssignments, propertyAssignments);
				case 160: return new PathObjectUnifierUnifiesPathedRole(partition, roleAssignments, propertyAssignments);
				case 161: return new PathObjectUnifierUnifiesRolePathRoot(partition, roleAssignments, propertyAssignments);
				case 162: return new RoleSubPathIsContinuationOfRolePath(partition, roleAssignments, propertyAssignments);
				case 163: return new ModelDefinesFunction(partition, roleAssignments, propertyAssignments);
				case 164: return new FunctionOperatesOnParameter(partition, roleAssignments, propertyAssignments);
				case 165: return new RolePathOwnerCalculatesCalculatedPathValue_Deprecated(partition, roleAssignments, propertyAssignments);
				case 166: return new LeadRolePathCalculatesCalculatedPathValue(partition, roleAssignments, propertyAssignments);
				case 167: return new LeadRolePathSatisfiesCalculatedCondition(partition, roleAssignments, propertyAssignments);
				case 168: return new CalculatedPathValueHasInput(partition, roleAssignments, propertyAssignments);
				case 169: return new CalculatedPathValueScopedWithPathedRole_Deprecated(partition, roleAssignments, propertyAssignments);
				case 170: return new CalculatedPathValueAggregationContextIncludesPathedRole(partition, roleAssignments, propertyAssignments);
				case 171: return new CalculatedPathValueAggregationContextIncludesRolePathRoot(partition, roleAssignments, propertyAssignments);
				case 172: return new CalculatedPathValueIsCalculatedWithFunction(partition, roleAssignments, propertyAssignments);
				case 173: return new CalculatedPathValueInputCorrespondsToFunctionParameter(partition, roleAssignments, propertyAssignments);
				case 174: return new CalculatedPathValueInputBindsToRolePathRoot(partition, roleAssignments, propertyAssignments);
				case 175: return new CalculatedPathValueInputBindsToPathedRole(partition, roleAssignments, propertyAssignments);
				case 176: return new CalculatedPathValueInputBindsToCalculatedPathValue(partition, roleAssignments, propertyAssignments);
				case 177: return new CalculatedPathValueInputBindsToPathConstant(partition, roleAssignments, propertyAssignments);
				case 178: return new QueryDefinesParameter(partition, roleAssignments, propertyAssignments);
				case 179: return new QueryParameterHasParameterType(partition, roleAssignments, propertyAssignments);
				case 180: return new QueryParameterBinding(partition, roleAssignments, propertyAssignments);
				case 181: return new QueryParameterBoundToRolePathRoot(partition, roleAssignments, propertyAssignments);
				case 182: return new QueryParameterBoundToPathedRole(partition, roleAssignments, propertyAssignments);
				case 183: return new SubqueryParameterInputs(partition, roleAssignments, propertyAssignments);
				case 184: return new SubqueryParameterInput(partition, roleAssignments, propertyAssignments);
				case 185: return new SubqueryParameterInputFromRolePathRoot(partition, roleAssignments, propertyAssignments);
				case 186: return new SubqueryParameterInputFromPathedRole(partition, roleAssignments, propertyAssignments);
				case 187: return new SubqueryParameterInputFromCalculatedPathValue(partition, roleAssignments, propertyAssignments);
				case 188: return new SubqueryParameterInputFromPathConstant(partition, roleAssignments, propertyAssignments);
				case 189: return new FactTypeHasDerivationRule(partition, roleAssignments, propertyAssignments);
				case 190: return new FactTypeDerivationRuleHasDerivationNote(partition, roleAssignments, propertyAssignments);
				case 191: return new RoleSetDerivationProjection(partition, roleAssignments, propertyAssignments);
				case 192: return new DerivedRoleProjection(partition, roleAssignments, propertyAssignments);
				case 193: return new DerivedRoleProjectedFromRolePathRoot(partition, roleAssignments, propertyAssignments);
				case 194: return new DerivedRoleProjectedFromPathedRole(partition, roleAssignments, propertyAssignments);
				case 195: return new DerivedRoleProjectedFromCalculatedPathValue(partition, roleAssignments, propertyAssignments);
				case 196: return new DerivedRoleProjectedFromPathConstant(partition, roleAssignments, propertyAssignments);
				case 197: return new RoleDerivesFromPathedRole_Deprecated(partition, roleAssignments, propertyAssignments);
				case 198: return new RoleDerivesFromCalculatedPathValue_Deprecated(partition, roleAssignments, propertyAssignments);
				case 199: return new RoleDerivesFromPathConstant_Deprecated(partition, roleAssignments, propertyAssignments);
				case 200: return new SubtypeHasDerivationRule(partition, roleAssignments, propertyAssignments);
				case 201: return new SubtypeDerivationRuleHasDerivationNote(partition, roleAssignments, propertyAssignments);
				case 202: return new RolePathHasRootObjectTypeError(partition, roleAssignments, propertyAssignments);
				case 203: return new PathedRoleHasCompatibleJoinRolePlayerError(partition, roleAssignments, propertyAssignments);
				case 204: return new PathObjectUnifierHasCompatibleObjectTypesError(partition, roleAssignments, propertyAssignments);
				case 205: return new PathedRoleHasSameFactTypeFollowsJoinError(partition, roleAssignments, propertyAssignments);
				case 206: return new PathedRoleHasMandatoryOuterJoinError(partition, roleAssignments, propertyAssignments);
				case 207: return new CalculatedPathValueHasFunctionRequiredError(partition, roleAssignments, propertyAssignments);
				case 208: return new CalculatedPathValueHasUnboundParameterError(partition, roleAssignments, propertyAssignments);
				case 209: return new CalculatedPathValueParameterBindingErrorTargetsFunctionParameter(partition, roleAssignments, propertyAssignments);
				case 210: return new CalculatedPathValueHasConsumptionRequiredError(partition, roleAssignments, propertyAssignments);
				case 211: return new CalculatedPathValueHasAggregationContextRequiredError(partition, roleAssignments, propertyAssignments);
				case 212: return new RoleProjectedDerivationRuleHasProjectionRequiredError(partition, roleAssignments, propertyAssignments);
				case 213: return new RoleSetDerivationProjectionHasPartialProjectionError(partition, roleAssignments, propertyAssignments);
				case 214: return new DerivedRoleProjectionHasDerivedRoleRequiresCompatibleProjectionError(partition, roleAssignments, propertyAssignments);
				case 215: return new ConstraintRoleSequenceJoinPathHasProjectionRequiredError(partition, roleAssignments, propertyAssignments);
				case 216: return new ConstraintRoleSequenceProjectionHasPartialProjectionError(partition, roleAssignments, propertyAssignments);
				case 217: return new ConstraintRoleProjectionHasConstraintRoleRequiresCompatibleJoinPathProjectionError(partition, roleAssignments, propertyAssignments);
				default: return null;
			}
		}
		#endregion
