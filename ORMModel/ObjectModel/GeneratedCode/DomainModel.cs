...
namespace ORMSolutions.ORMArchitect.Core.ObjectModel
{
	...
	public partial class ORMCoreDomainModel : DslModeling::DomainModel
	{
		...
		protected sealed override global::System.Type[] GetGeneratedDomainModelTypes()
		{
			return new global::System.Type[]
			{
				...
				typeof(PrimaryRolePathHasRootObjectType),
				typeof(PathedRole),
				typeof(PathedRoleIsRemotelyCorrelatedWithPathedRole),
				typeof(RoleSubPathPathIsContinuationOfRolePath),
				typeof(ModelDefinesFunction),
				typeof(FunctionOperatesOnParameter),
				typeof(PrimaryRolePathCalculatesCalculatedPathValue),
				typeof(PrimaryRolePathSatisfiesCalculatedCondition),
		...
		protected sealed override DomainRolePlayerInfo[] GetGeneratedDomainRoles()
		{
			return new DomainRolePlayerInfo[]
			{
				...
				new DomainRolePlayerInfo(typeof(PrimaryRolePathHasRootObjectType), "PrimaryRolePath", PrimaryRolePathHasRootObjectType.PrimaryRolePathDomainRoleId),
				new DomainRolePlayerInfo(typeof(PrimaryRolePathHasRootObjectType), "RootObjectType", PrimaryRolePathHasRootObjectType.RootObjectTypeDomainRoleId),
				...
				new DomainRolePlayerInfo(typeof(RoleSubPathPathIsContinuationOfRolePath), "ParentRolePath", RoleSubPathPathIsContinuationOfRolePath.ParentRolePathDomainRoleId),
				new DomainRolePlayerInfo(typeof(RoleSubPathPathIsContinuationOfRolePath), "SubPath", RoleSubPathPathIsContinuationOfRolePath.SubPathDomainRoleId),
				...
				new DomainRolePlayerInfo(typeof(PrimaryRolePathCalculatesCalculatedPathValue), "PrimaryRolePath", PrimaryRolePathCalculatesCalculatedPathValue.PrimaryRolePathDomainRoleId),
				new DomainRolePlayerInfo(typeof(PrimaryRolePathCalculatesCalculatedPathValue), "CalculatedValue", PrimaryRolePathCalculatesCalculatedPathValue.CalculatedValueDomainRoleId),
				new DomainRolePlayerInfo(typeof(PrimaryRolePathSatisfiesCalculatedCondition), "PrimaryRolePath", PrimaryRolePathSatisfiesCalculatedCondition.PrimaryRolePathDomainRoleId),
				new DomainRolePlayerInfo(typeof(PrimaryRolePathSatisfiesCalculatedCondition), "CalculatedCondition", PrimaryRolePathSatisfiesCalculatedCondition.CalculatedConditionDomainRoleId),
		...
		public sealed override DslModeling::ModelElement CreateElement(DslModeling::Partition partition, global::System.Type elementType, DslModeling::PropertyAssignment[] propertyAssignments)
		{
			...
			{
				createElementMap = new global::System.Collections.Generic.Dictionary<global::System.Type, int>(158);
				...
				createElementMap.Add(typeof(CalculatedPathValue), 27);
				createElementMap.Add(typeof(PathConstant), 28);
				createElementMap.Add(typeof(Function), 29);
				createElementMap.Add(typeof(FunctionParameter), 30);
				createElementMap.Add(typeof(CalculatedPathValueInput), 31);
				createElementMap.Add(typeof(FactTypeDerivationRule), 32);
				createElementMap.Add(typeof(SubtypeDerivationRule), 33);
				createElementMap.Add(typeof(TooFewRoleSequencesError), 34);
				createElementMap.Add(typeof(TooManyRoleSequencesError), 35);
				createElementMap.Add(typeof(ObjectTypeDuplicateNameError), 36);
				createElementMap.Add(typeof(RecognizedPhraseDuplicateNameError), 37);
				createElementMap.Add(typeof(PopulationUniquenessError), 38);
				createElementMap.Add(typeof(ExclusionContradictsMandatoryError), 39);
				createElementMap.Add(typeof(ExclusionContradictsEqualityError), 40);
				createElementMap.Add(typeof(ExclusionContradictsSubsetError), 41);
				createElementMap.Add(typeof(NotWellModeledSubsetAndMandatoryError), 42);
				createElementMap.Add(typeof(PopulationMandatoryError), 43);
				createElementMap.Add(typeof(ObjectifiedInstanceRequiredError), 44);
				createElementMap.Add(typeof(ObjectifyingInstanceRequiredError), 45);
				createElementMap.Add(typeof(ConstraintDuplicateNameError), 46);
				createElementMap.Add(typeof(TooFewReadingRolesError), 47);
				createElementMap.Add(typeof(TooManyReadingRolesError), 48);
				createElementMap.Add(typeof(ExternalConstraintRoleSequenceArityMismatchError), 49);
				createElementMap.Add(typeof(FactTypeRequiresReadingError), 50);
				createElementMap.Add(typeof(FactTypeRequiresInternalUniquenessConstraintError), 51);
				createElementMap.Add(typeof(DataTypeNotSpecifiedError), 52);
				createElementMap.Add(typeof(NMinusOneError), 53);
				createElementMap.Add(typeof(CompatibleRolePlayerTypeError), 54);
				createElementMap.Add(typeof(RolePlayerRequiredError), 55);
				createElementMap.Add(typeof(EntityTypeRequiresReferenceSchemeError), 56);
				createElementMap.Add(typeof(FrequencyConstraintMinMaxError), 57);
				createElementMap.Add(typeof(FrequencyConstraintExactlyOneError), 58);
				createElementMap.Add(typeof(ReadingRequiresUserModificationError), 59);
				createElementMap.Add(typeof(ReferenceModeKind), 60);
				createElementMap.Add(typeof(IntrinsicReferenceMode), 61);
				createElementMap.Add(typeof(CustomReferenceMode), 62);
				createElementMap.Add(typeof(UnspecifiedDataType), 63);
				createElementMap.Add(typeof(FixedLengthTextDataType), 64);
				createElementMap.Add(typeof(VariableLengthTextDataType), 65);
				createElementMap.Add(typeof(LargeLengthTextDataType), 66);
				createElementMap.Add(typeof(SignedIntegerNumericDataType), 67);
				createElementMap.Add(typeof(SignedSmallIntegerNumericDataType), 68);
				createElementMap.Add(typeof(SignedLargeIntegerNumericDataType), 69);
				createElementMap.Add(typeof(UnsignedIntegerNumericDataType), 70);
				createElementMap.Add(typeof(UnsignedTinyIntegerNumericDataType), 71);
				createElementMap.Add(typeof(UnsignedSmallIntegerNumericDataType), 72);
				createElementMap.Add(typeof(UnsignedLargeIntegerNumericDataType), 73);
				createElementMap.Add(typeof(AutoCounterNumericDataType), 74);
				createElementMap.Add(typeof(FloatingPointNumericDataType), 75);
				createElementMap.Add(typeof(SinglePrecisionFloatingPointNumericDataType), 76);
				createElementMap.Add(typeof(DoublePrecisionFloatingPointNumericDataType), 77);
				createElementMap.Add(typeof(DecimalNumericDataType), 78);
				createElementMap.Add(typeof(MoneyNumericDataType), 79);
				createElementMap.Add(typeof(FixedLengthRawDataDataType), 80);
				createElementMap.Add(typeof(VariableLengthRawDataDataType), 81);
				createElementMap.Add(typeof(LargeLengthRawDataDataType), 82);
				createElementMap.Add(typeof(PictureRawDataDataType), 83);
				createElementMap.Add(typeof(OleObjectRawDataDataType), 84);
				createElementMap.Add(typeof(AutoTimestampTemporalDataType), 85);
				createElementMap.Add(typeof(TimeTemporalDataType), 86);
				createElementMap.Add(typeof(DateTemporalDataType), 87);
				createElementMap.Add(typeof(DateAndTimeTemporalDataType), 88);
				createElementMap.Add(typeof(TrueOrFalseLogicalDataType), 89);
				createElementMap.Add(typeof(YesOrNoLogicalDataType), 90);
				createElementMap.Add(typeof(RowIdOtherDataType), 91);
				createElementMap.Add(typeof(ObjectIdOtherDataType), 92);
				createElementMap.Add(typeof(Reading), 93);
				createElementMap.Add(typeof(ReadingOrder), 94);
				createElementMap.Add(typeof(ValueRange), 95);
				createElementMap.Add(typeof(ValueTypeValueConstraint), 96);
				createElementMap.Add(typeof(RoleValueConstraint), 97);
				createElementMap.Add(typeof(MinValueMismatchError), 98);
				createElementMap.Add(typeof(MaxValueMismatchError), 99);
				createElementMap.Add(typeof(ImpliedInternalUniquenessConstraintError), 100);
				createElementMap.Add(typeof(FrequencyConstraintViolatedByUniquenessConstraintError), 101);
				createElementMap.Add(typeof(RingConstraintTypeNotSpecifiedError), 102);
				createElementMap.Add(typeof(SubtypeMetaRole), 103);
				createElementMap.Add(typeof(SupertypeMetaRole), 104);
				createElementMap.Add(typeof(Definition), 105);
				createElementMap.Add(typeof(Note), 106);
				createElementMap.Add(typeof(ModelNote), 107);
				createElementMap.Add(typeof(CompatibleSupertypesError), 108);
				createElementMap.Add(typeof(ImplicationError), 109);
				createElementMap.Add(typeof(EqualityOrSubsetImpliedByMandatoryError), 110);
				createElementMap.Add(typeof(PreferredIdentifierRequiresMandatoryError), 111);
				createElementMap.Add(typeof(ValueRangeOverlapError), 112);
				createElementMap.Add(typeof(ValueConstraintValueTypeDetachedError), 113);
				createElementMap.Add(typeof(FactTypeDerivationExpression), 114);
				createElementMap.Add(typeof(SubtypeDerivationExpression), 115);
				createElementMap.Add(typeof(EntityTypeInstance), 116);
				createElementMap.Add(typeof(EntityTypeSubtypeInstance), 117);
				createElementMap.Add(typeof(ValueTypeInstance), 118);
				createElementMap.Add(typeof(FactTypeInstance), 119);
				createElementMap.Add(typeof(TooFewEntityTypeRoleInstancesError), 120);
				createElementMap.Add(typeof(TooFewFactTypeRoleInstancesError), 121);
				createElementMap.Add(typeof(CompatibleValueTypeInstanceValueError), 122);
			}
			int index;
			...
			switch (index)
			{
				...
				case 27: return new CalculatedPathValue(partition, propertyAssignments);
				case 28: return new PathConstant(partition, propertyAssignments);
				case 29: return new Function(partition, propertyAssignments);
				case 30: return new FunctionParameter(partition, propertyAssignments);
				case 31: return new CalculatedPathValueInput(partition, propertyAssignments);
				case 32: return new FactTypeDerivationRule(partition, propertyAssignments);
				case 33: return new SubtypeDerivationRule(partition, propertyAssignments);
				case 34: return new TooFewRoleSequencesError(partition, propertyAssignments);
				case 35: return new TooManyRoleSequencesError(partition, propertyAssignments);
				case 36: return new ObjectTypeDuplicateNameError(partition, propertyAssignments);
				case 37: return new RecognizedPhraseDuplicateNameError(partition, propertyAssignments);
				case 38: return new PopulationUniquenessError(partition, propertyAssignments);
				case 39: return new ExclusionContradictsMandatoryError(partition, propertyAssignments);
				case 40: return new ExclusionContradictsEqualityError(partition, propertyAssignments);
				case 41: return new ExclusionContradictsSubsetError(partition, propertyAssignments);
				case 42: return new NotWellModeledSubsetAndMandatoryError(partition, propertyAssignments);
				case 43: return new PopulationMandatoryError(partition, propertyAssignments);
				case 44: return new ObjectifiedInstanceRequiredError(partition, propertyAssignments);
				case 45: return new ObjectifyingInstanceRequiredError(partition, propertyAssignments);
				case 46: return new ConstraintDuplicateNameError(partition, propertyAssignments);
				case 47: return new TooFewReadingRolesError(partition, propertyAssignments);
				case 48: return new TooManyReadingRolesError(partition, propertyAssignments);
				case 49: return new ExternalConstraintRoleSequenceArityMismatchError(partition, propertyAssignments);
				case 50: return new FactTypeRequiresReadingError(partition, propertyAssignments);
				case 51: return new FactTypeRequiresInternalUniquenessConstraintError(partition, propertyAssignments);
				case 52: return new DataTypeNotSpecifiedError(partition, propertyAssignments);
				case 53: return new NMinusOneError(partition, propertyAssignments);
				case 54: return new CompatibleRolePlayerTypeError(partition, propertyAssignments);
				case 55: return new RolePlayerRequiredError(partition, propertyAssignments);
				case 56: return new EntityTypeRequiresReferenceSchemeError(partition, propertyAssignments);
				case 57: return new FrequencyConstraintMinMaxError(partition, propertyAssignments);
				case 58: return new FrequencyConstraintExactlyOneError(partition, propertyAssignments);
				case 59: return new ReadingRequiresUserModificationError(partition, propertyAssignments);
				case 60: return new ReferenceModeKind(partition, propertyAssignments);
				case 61: return new IntrinsicReferenceMode(partition, propertyAssignments);
				case 62: return new CustomReferenceMode(partition, propertyAssignments);
				case 63: return new UnspecifiedDataType(partition, propertyAssignments);
				case 64: return new FixedLengthTextDataType(partition, propertyAssignments);
				case 65: return new VariableLengthTextDataType(partition, propertyAssignments);
				case 66: return new LargeLengthTextDataType(partition, propertyAssignments);
				case 67: return new SignedIntegerNumericDataType(partition, propertyAssignments);
				case 68: return new SignedSmallIntegerNumericDataType(partition, propertyAssignments);
				case 69: return new SignedLargeIntegerNumericDataType(partition, propertyAssignments);
				case 70: return new UnsignedIntegerNumericDataType(partition, propertyAssignments);
				case 71: return new UnsignedTinyIntegerNumericDataType(partition, propertyAssignments);
				case 72: return new UnsignedSmallIntegerNumericDataType(partition, propertyAssignments);
				case 73: return new UnsignedLargeIntegerNumericDataType(partition, propertyAssignments);
				case 74: return new AutoCounterNumericDataType(partition, propertyAssignments);
				case 75: return new FloatingPointNumericDataType(partition, propertyAssignments);
				case 76: return new SinglePrecisionFloatingPointNumericDataType(partition, propertyAssignments);
				case 77: return new DoublePrecisionFloatingPointNumericDataType(partition, propertyAssignments);
				case 78: return new DecimalNumericDataType(partition, propertyAssignments);
				case 79: return new MoneyNumericDataType(partition, propertyAssignments);
				case 80: return new FixedLengthRawDataDataType(partition, propertyAssignments);
				case 81: return new VariableLengthRawDataDataType(partition, propertyAssignments);
				case 82: return new LargeLengthRawDataDataType(partition, propertyAssignments);
				case 83: return new PictureRawDataDataType(partition, propertyAssignments);
				case 84: return new OleObjectRawDataDataType(partition, propertyAssignments);
				case 85: return new AutoTimestampTemporalDataType(partition, propertyAssignments);
				case 86: return new TimeTemporalDataType(partition, propertyAssignments);
				case 87: return new DateTemporalDataType(partition, propertyAssignments);
				case 88: return new DateAndTimeTemporalDataType(partition, propertyAssignments);
				case 89: return new TrueOrFalseLogicalDataType(partition, propertyAssignments);
				case 90: return new YesOrNoLogicalDataType(partition, propertyAssignments);
				case 91: return new RowIdOtherDataType(partition, propertyAssignments);
				case 92: return new ObjectIdOtherDataType(partition, propertyAssignments);
				case 93: return new Reading(partition, propertyAssignments);
				case 94: return new ReadingOrder(partition, propertyAssignments);
				case 95: return new ValueRange(partition, propertyAssignments);
				case 96: return new ValueTypeValueConstraint(partition, propertyAssignments);
				case 97: return new RoleValueConstraint(partition, propertyAssignments);
				case 98: return new MinValueMismatchError(partition, propertyAssignments);
				case 99: return new MaxValueMismatchError(partition, propertyAssignments);
				case 100: return new ImpliedInternalUniquenessConstraintError(partition, propertyAssignments);
				case 101: return new FrequencyConstraintViolatedByUniquenessConstraintError(partition, propertyAssignments);
				case 102: return new RingConstraintTypeNotSpecifiedError(partition, propertyAssignments);
				case 103: return new SubtypeMetaRole(partition, propertyAssignments);
				case 104: return new SupertypeMetaRole(partition, propertyAssignments);
				case 105: return new Definition(partition, propertyAssignments);
				case 106: return new Note(partition, propertyAssignments);
				case 107: return new ModelNote(partition, propertyAssignments);
				case 108: return new CompatibleSupertypesError(partition, propertyAssignments);
				case 109: return new ImplicationError(partition, propertyAssignments);
				case 110: return new EqualityOrSubsetImpliedByMandatoryError(partition, propertyAssignments);
				case 111: return new PreferredIdentifierRequiresMandatoryError(partition, propertyAssignments);
				case 112: return new ValueRangeOverlapError(partition, propertyAssignments);
				case 113: return new ValueConstraintValueTypeDetachedError(partition, propertyAssignments);
				case 114: return new FactTypeDerivationExpression(partition, propertyAssignments);
				case 115: return new SubtypeDerivationExpression(partition, propertyAssignments);
				case 116: return new EntityTypeInstance(partition, propertyAssignments);
				case 117: return new EntityTypeSubtypeInstance(partition, propertyAssignments);
				case 118: return new ValueTypeInstance(partition, propertyAssignments);
				case 119: return new FactTypeInstance(partition, propertyAssignments);
				case 120: return new TooFewEntityTypeRoleInstancesError(partition, propertyAssignments);
				case 121: return new TooFewFactTypeRoleInstancesError(partition, propertyAssignments);
				case 122: return new CompatibleValueTypeInstanceValueError(partition, propertyAssignments);
				default: return null;
			}
		}
		...
		public sealed override DslModeling::ElementLink CreateElementLink(DslModeling::Partition partition, global::System.Type elementLinkType, DslModeling::RoleAssignment[] roleAssignments, DslModeling::PropertyAssignment[] propertyAssignments)
		{
			...
			{
				createElementLinkMap = new global::System.Collections.Generic.Dictionary<global::System.Type, int>(165);
				...
				createElementLinkMap.Add(typeof(ExternalRoleConstraint), 22);
				createElementLinkMap.Add(typeof(ExclusiveOrConstraintCoupler), 23);
				createElementLinkMap.Add(typeof(SetComparisonConstraintHasRoleSequence), 24);
				createElementLinkMap.Add(typeof(ConstraintRoleSequenceHasRole), 25);
				createElementLinkMap.Add(typeof(SetComparisonConstraintHasTooFewRoleSequencesError), 26);
				createElementLinkMap.Add(typeof(SetComparisonConstraintHasTooManyRoleSequencesError), 27);
				createElementLinkMap.Add(typeof(ObjectTypeHasDuplicateNameError), 28);
				createElementLinkMap.Add(typeof(EntityTypeRoleInstanceHasPopulationUniquenessError), 29);
				createElementLinkMap.Add(typeof(FactTypeRoleInstanceHasPopulationUniquenessError), 30);
				createElementLinkMap.Add(typeof(SetComparisonConstraintHasExclusionContradictsEqualityError), 31);
				createElementLinkMap.Add(typeof(SetComparisonConstraintHasExclusionContradictsSubsetError), 32);
				createElementLinkMap.Add(typeof(ExclusionConstraintHasExclusionContradictsMandatoryError), 33);
				createElementLinkMap.Add(typeof(MandatoryConstraintHasExclusionContradictsMandatoryError), 34);
				createElementLinkMap.Add(typeof(SubsetConstraintHasNotWellModeledSubsetAndMandatoryError), 35);
				createElementLinkMap.Add(typeof(MandatoryConstraintHasNotWellModeledSubsetAndMandatoryError), 36);
				createElementLinkMap.Add(typeof(MandatoryConstraintHasPopulationMandatoryError), 37);
				createElementLinkMap.Add(typeof(ObjectTypeInstanceHasPopulationMandatoryError), 38);
				createElementLinkMap.Add(typeof(ReadingOrderHasReading), 39);
				createElementLinkMap.Add(typeof(FactTypeHasReadingOrder), 40);
				createElementLinkMap.Add(typeof(ReferenceModeHasReferenceModeKind), 41);
				createElementLinkMap.Add(typeof(SetConstraintHasDuplicateNameError), 42);
				createElementLinkMap.Add(typeof(SetComparisonConstraintHasDuplicateNameError), 43);
				createElementLinkMap.Add(typeof(EntityTypeHasPreferredIdentifier), 44);
				createElementLinkMap.Add(typeof(ReadingHasTooManyRolesError), 45);
				createElementLinkMap.Add(typeof(ReadingHasTooFewRolesError), 46);
				createElementLinkMap.Add(typeof(ReadingHasReadingRequiresUserModificationError), 47);
				createElementLinkMap.Add(typeof(SetComparisonConstraintHasExternalConstraintRoleSequenceArityMismatchError), 48);
				createElementLinkMap.Add(typeof(ElementAssociatedWithModelError), 49);
				createElementLinkMap.Add(typeof(FactTypeHasFactTypeRequiresReadingError), 50);
				createElementLinkMap.Add(typeof(FactTypeHasFactTypeRequiresInternalUniquenessConstraintError), 51);
				createElementLinkMap.Add(typeof(ValueTypeHasValueConstraint), 52);
				createElementLinkMap.Add(typeof(RoleHasValueConstraint), 53);
				createElementLinkMap.Add(typeof(ValueConstraintHasValueRange), 54);
				createElementLinkMap.Add(typeof(ValueTypeHasUnspecifiedDataTypeError), 55);
				createElementLinkMap.Add(typeof(SetComparisonConstraintHasCompatibleRolePlayerTypeError), 56);
				createElementLinkMap.Add(typeof(SetConstraintHasCompatibleRolePlayerTypeError), 57);
				createElementLinkMap.Add(typeof(UniquenessConstraintHasNMinusOneError), 58);
				createElementLinkMap.Add(typeof(RoleHasRolePlayerRequiredError), 59);
				createElementLinkMap.Add(typeof(ObjectTypeHasEntityTypeRequiresReferenceSchemeError), 60);
				createElementLinkMap.Add(typeof(FrequencyConstraintHasFrequencyConstraintMinMaxError), 61);
				createElementLinkMap.Add(typeof(FrequencyConstraintHasFrequencyConstraintExactlyOneError), 62);
				createElementLinkMap.Add(typeof(ObjectificationImpliesFactType), 63);
				createElementLinkMap.Add(typeof(ValueRangeHasMaxValueMismatchError), 64);
				createElementLinkMap.Add(typeof(ValueRangeHasMinValueMismatchError), 65);
				createElementLinkMap.Add(typeof(FactTypeHasImpliedInternalUniquenessConstraintError), 66);
				createElementLinkMap.Add(typeof(SetConstraintHasTooFewRoleSequencesError), 67);
				createElementLinkMap.Add(typeof(SetConstraintHasTooManyRoleSequencesError), 68);
				createElementLinkMap.Add(typeof(FrequencyConstraintHasFrequencyConstraintViolatedByUniquenessConstraintError), 69);
				createElementLinkMap.Add(typeof(RingConstraintHasRingConstraintTypeNotSpecifiedError), 70);
				createElementLinkMap.Add(typeof(ValueConstraintHasDuplicateNameError), 71);
				createElementLinkMap.Add(typeof(ModelHasDefinition), 72);
				createElementLinkMap.Add(typeof(ObjectTypeHasDefinition), 73);
				createElementLinkMap.Add(typeof(FactTypeHasDefinition), 74);
				createElementLinkMap.Add(typeof(SetConstraintHasDefinition), 75);
				createElementLinkMap.Add(typeof(SetComparisonConstraintHasDefinition), 76);
				createElementLinkMap.Add(typeof(ValueConstraintHasDefinition), 77);
				createElementLinkMap.Add(typeof(ElementGroupingHasDefinition), 78);
				createElementLinkMap.Add(typeof(FactTypeHasNote), 79);
				createElementLinkMap.Add(typeof(ObjectTypeHasNote), 80);
				createElementLinkMap.Add(typeof(SetConstraintHasNote), 81);
				createElementLinkMap.Add(typeof(SetComparisonConstraintHasNote), 82);
				createElementLinkMap.Add(typeof(ValueConstraintHasNote), 83);
				createElementLinkMap.Add(typeof(ElementGroupingHasNote), 84);
				createElementLinkMap.Add(typeof(ModelHasPrimaryNote), 85);
				createElementLinkMap.Add(typeof(ModelHasModelNote), 86);
				createElementLinkMap.Add(typeof(ModelNoteReferencesFactType), 87);
				createElementLinkMap.Add(typeof(ModelNoteReferencesObjectType), 88);
				createElementLinkMap.Add(typeof(ModelNoteReferencesSetConstraint), 89);
				createElementLinkMap.Add(typeof(ModelNoteReferencesSetComparisonConstraint), 90);
				createElementLinkMap.Add(typeof(ObjectTypeHasCompatibleSupertypesError), 91);
				createElementLinkMap.Add(typeof(SetConstraintHasImplicationError), 92);
				createElementLinkMap.Add(typeof(SetComparisonConstraintHasImplicationError), 93);
				createElementLinkMap.Add(typeof(SetComparisonConstraintHasEqualityOrSubsetImpliedByMandatoryError), 94);
				createElementLinkMap.Add(typeof(ObjectTypeHasPreferredIdentifierRequiresMandatoryError), 95);
				createElementLinkMap.Add(typeof(ValueConstraintHasValueRangeOverlapError), 96);
				createElementLinkMap.Add(typeof(ValueConstraintHasValueTypeDetachedError), 97);
				createElementLinkMap.Add(typeof(FactTypeHasRole), 98);
				createElementLinkMap.Add(typeof(ReadingOrderHasRole), 99);
				createElementLinkMap.Add(typeof(RoleProxyHasRole), 100);
				createElementLinkMap.Add(typeof(ObjectifiedUnaryRoleHasRole), 101);
				createElementLinkMap.Add(typeof(FactTypeHasDerivationExpression), 102);
				createElementLinkMap.Add(typeof(SubtypeHasDerivationExpression), 103);
				createElementLinkMap.Add(typeof(ObjectTypeHasObjectTypeInstance), 104);
				createElementLinkMap.Add(typeof(EntityTypeHasEntityTypeInstance), 105);
				createElementLinkMap.Add(typeof(EntityTypeSubtypeHasEntityTypeSubtypeInstance), 106);
				createElementLinkMap.Add(typeof(ValueTypeHasValueTypeInstance), 107);
				createElementLinkMap.Add(typeof(EntityTypeRoleInstance), 108);
				createElementLinkMap.Add(typeof(FactTypeRoleInstance), 109);
				createElementLinkMap.Add(typeof(EntityTypeInstanceHasRoleInstance), 110);
				createElementLinkMap.Add(typeof(EntityTypeSubtypeInstanceHasSupertypeInstance), 111);
				createElementLinkMap.Add(typeof(FactTypeHasFactTypeInstance), 112);
				createElementLinkMap.Add(typeof(FactTypeInstanceHasRoleInstance), 113);
				createElementLinkMap.Add(typeof(ObjectificationInstance), 114);
				createElementLinkMap.Add(typeof(ObjectifiedInstanceHasObjectifyingInstanceRequiredError), 115);
				createElementLinkMap.Add(typeof(ObjectifyingInstanceHasObjectifiedInstanceRequiredError), 116);
				createElementLinkMap.Add(typeof(EntityTypeInstanceHasTooFewEntityTypeRoleInstancesError), 117);
				createElementLinkMap.Add(typeof(FactTypeInstanceHasTooFewFactTypeRoleInstancesError), 118);
				createElementLinkMap.Add(typeof(ValueTypeInstanceHasCompatibleValueTypeInstanceValueError), 119);
				createElementLinkMap.Add(typeof(JoinHasInputRole), 120);
				createElementLinkMap.Add(typeof(JoinHasOutputRole), 121);
				createElementLinkMap.Add(typeof(ConstraintRoleSequenceHasJoinPath), 122);
				createElementLinkMap.Add(typeof(ConstraintRoleSequenceHasRoleHasProjectionJoin), 123);
				createElementLinkMap.Add(typeof(ModelHasModelErrorDisplayFilter), 124);
				createElementLinkMap.Add(typeof(ElementGroupingSetRelatesToORMModel), 125);
				createElementLinkMap.Add(typeof(ElementGroupingSetContainsElementGrouping), 126);
				createElementLinkMap.Add(typeof(ElementGroupingIsOfElementGroupingType), 127);
				createElementLinkMap.Add(typeof(GroupingElementInclusion), 128);
				createElementLinkMap.Add(typeof(GroupingElementExclusion), 129);
				createElementLinkMap.Add(typeof(ElementGroupingIncludesElementGrouping), 130);
				createElementLinkMap.Add(typeof(ElementGroupingExcludesElementGrouping), 131);
				createElementLinkMap.Add(typeof(ElementGroupingHasDuplicateNameError), 132);
				createElementLinkMap.Add(typeof(ElementGroupingHasMembershipContradictionError), 133);
				createElementLinkMap.Add(typeof(GroupingMembershipContradictionErrorIsForElement), 134);
				createElementLinkMap.Add(typeof(PrimaryRolePathHasRootObjectType), 135);
				createElementLinkMap.Add(typeof(PathedRole), 136);
				createElementLinkMap.Add(typeof(PathedRoleIsRemotelyCorrelatedWithPathedRole), 137);
				createElementLinkMap.Add(typeof(RoleSubPathPathIsContinuationOfRolePath), 138);
				createElementLinkMap.Add(typeof(ModelDefinesFunction), 139);
				createElementLinkMap.Add(typeof(FunctionOperatesOnParameter), 140);
				createElementLinkMap.Add(typeof(PrimaryRolePathCalculatesCalculatedPathValue), 141);
				createElementLinkMap.Add(typeof(PrimaryRolePathSatisfiesCalculatedCondition), 142);
				createElementLinkMap.Add(typeof(CalculatedPathValueHasInput), 143);
				createElementLinkMap.Add(typeof(CalculatedPathValueScopedWithPathedRole), 144);
				createElementLinkMap.Add(typeof(CalculatedPathValueIsCalculatedWithFunction), 145);
				createElementLinkMap.Add(typeof(CalculatedPathValueInputCorrespondsToFunctionParameter), 146);
				createElementLinkMap.Add(typeof(CalculatedPathValueInputBindsToPathedRole), 147);
				createElementLinkMap.Add(typeof(CalculatedPathValueInputBindsToCalculatedPathValue), 148);
				createElementLinkMap.Add(typeof(CalculatedPathValueInputBindsToPathConstant), 149);
				createElementLinkMap.Add(typeof(FactTypeHasDerivationRule), 150);
				createElementLinkMap.Add(typeof(RoleDerivesFromPathedRole), 151);
				createElementLinkMap.Add(typeof(RoleDerivesFromCalculatedPathValue), 152);
				createElementLinkMap.Add(typeof(RoleDerivesFromPathConstant), 153);
				createElementLinkMap.Add(typeof(SubtypeHasDerivationRule), 154);
			}
			int index;
			...
			switch (index)
			{
				...
				case 22: return new ExternalRoleConstraint(partition, roleAssignments, propertyAssignments);
				case 23: return new ExclusiveOrConstraintCoupler(partition, roleAssignments, propertyAssignments);
				case 24: return new SetComparisonConstraintHasRoleSequence(partition, roleAssignments, propertyAssignments);
				case 25: return new ConstraintRoleSequenceHasRole(partition, roleAssignments, propertyAssignments);
				case 26: return new SetComparisonConstraintHasTooFewRoleSequencesError(partition, roleAssignments, propertyAssignments);
				case 27: return new SetComparisonConstraintHasTooManyRoleSequencesError(partition, roleAssignments, propertyAssignments);
				case 28: return new ObjectTypeHasDuplicateNameError(partition, roleAssignments, propertyAssignments);
				case 29: return new EntityTypeRoleInstanceHasPopulationUniquenessError(partition, roleAssignments, propertyAssignments);
				case 30: return new FactTypeRoleInstanceHasPopulationUniquenessError(partition, roleAssignments, propertyAssignments);
				case 31: return new SetComparisonConstraintHasExclusionContradictsEqualityError(partition, roleAssignments, propertyAssignments);
				case 32: return new SetComparisonConstraintHasExclusionContradictsSubsetError(partition, roleAssignments, propertyAssignments);
				case 33: return new ExclusionConstraintHasExclusionContradictsMandatoryError(partition, roleAssignments, propertyAssignments);
				case 34: return new MandatoryConstraintHasExclusionContradictsMandatoryError(partition, roleAssignments, propertyAssignments);
				case 35: return new SubsetConstraintHasNotWellModeledSubsetAndMandatoryError(partition, roleAssignments, propertyAssignments);
				case 36: return new MandatoryConstraintHasNotWellModeledSubsetAndMandatoryError(partition, roleAssignments, propertyAssignments);
				case 37: return new MandatoryConstraintHasPopulationMandatoryError(partition, roleAssignments, propertyAssignments);
				case 38: return new ObjectTypeInstanceHasPopulationMandatoryError(partition, roleAssignments, propertyAssignments);
				case 39: return new ReadingOrderHasReading(partition, roleAssignments, propertyAssignments);
				case 40: return new FactTypeHasReadingOrder(partition, roleAssignments, propertyAssignments);
				case 41: return new ReferenceModeHasReferenceModeKind(partition, roleAssignments, propertyAssignments);
				case 42: return new SetConstraintHasDuplicateNameError(partition, roleAssignments, propertyAssignments);
				case 43: return new SetComparisonConstraintHasDuplicateNameError(partition, roleAssignments, propertyAssignments);
				case 44: return new EntityTypeHasPreferredIdentifier(partition, roleAssignments, propertyAssignments);
				case 45: return new ReadingHasTooManyRolesError(partition, roleAssignments, propertyAssignments);
				case 46: return new ReadingHasTooFewRolesError(partition, roleAssignments, propertyAssignments);
				case 47: return new ReadingHasReadingRequiresUserModificationError(partition, roleAssignments, propertyAssignments);
				case 48: return new SetComparisonConstraintHasExternalConstraintRoleSequenceArityMismatchError(partition, roleAssignments, propertyAssignments);
				case 49: return new ElementAssociatedWithModelError(partition, roleAssignments, propertyAssignments);
				case 50: return new FactTypeHasFactTypeRequiresReadingError(partition, roleAssignments, propertyAssignments);
				case 51: return new FactTypeHasFactTypeRequiresInternalUniquenessConstraintError(partition, roleAssignments, propertyAssignments);
				case 52: return new ValueTypeHasValueConstraint(partition, roleAssignments, propertyAssignments);
				case 53: return new RoleHasValueConstraint(partition, roleAssignments, propertyAssignments);
				case 54: return new ValueConstraintHasValueRange(partition, roleAssignments, propertyAssignments);
				case 55: return new ValueTypeHasUnspecifiedDataTypeError(partition, roleAssignments, propertyAssignments);
				case 56: return new SetComparisonConstraintHasCompatibleRolePlayerTypeError(partition, roleAssignments, propertyAssignments);
				case 57: return new SetConstraintHasCompatibleRolePlayerTypeError(partition, roleAssignments, propertyAssignments);
				case 58: return new UniquenessConstraintHasNMinusOneError(partition, roleAssignments, propertyAssignments);
				case 59: return new RoleHasRolePlayerRequiredError(partition, roleAssignments, propertyAssignments);
				case 60: return new ObjectTypeHasEntityTypeRequiresReferenceSchemeError(partition, roleAssignments, propertyAssignments);
				case 61: return new FrequencyConstraintHasFrequencyConstraintMinMaxError(partition, roleAssignments, propertyAssignments);
				case 62: return new FrequencyConstraintHasFrequencyConstraintExactlyOneError(partition, roleAssignments, propertyAssignments);
				case 63: return new ObjectificationImpliesFactType(partition, roleAssignments, propertyAssignments);
				case 64: return new ValueRangeHasMaxValueMismatchError(partition, roleAssignments, propertyAssignments);
				case 65: return new ValueRangeHasMinValueMismatchError(partition, roleAssignments, propertyAssignments);
				case 66: return new FactTypeHasImpliedInternalUniquenessConstraintError(partition, roleAssignments, propertyAssignments);
				case 67: return new SetConstraintHasTooFewRoleSequencesError(partition, roleAssignments, propertyAssignments);
				case 68: return new SetConstraintHasTooManyRoleSequencesError(partition, roleAssignments, propertyAssignments);
				case 69: return new FrequencyConstraintHasFrequencyConstraintViolatedByUniquenessConstraintError(partition, roleAssignments, propertyAssignments);
				case 70: return new RingConstraintHasRingConstraintTypeNotSpecifiedError(partition, roleAssignments, propertyAssignments);
				case 71: return new ValueConstraintHasDuplicateNameError(partition, roleAssignments, propertyAssignments);
				case 72: return new ModelHasDefinition(partition, roleAssignments, propertyAssignments);
				case 73: return new ObjectTypeHasDefinition(partition, roleAssignments, propertyAssignments);
				case 74: return new FactTypeHasDefinition(partition, roleAssignments, propertyAssignments);
				case 75: return new SetConstraintHasDefinition(partition, roleAssignments, propertyAssignments);
				case 76: return new SetComparisonConstraintHasDefinition(partition, roleAssignments, propertyAssignments);
				case 77: return new ValueConstraintHasDefinition(partition, roleAssignments, propertyAssignments);
				case 78: return new ElementGroupingHasDefinition(partition, roleAssignments, propertyAssignments);
				case 79: return new FactTypeHasNote(partition, roleAssignments, propertyAssignments);
				case 80: return new ObjectTypeHasNote(partition, roleAssignments, propertyAssignments);
				case 81: return new SetConstraintHasNote(partition, roleAssignments, propertyAssignments);
				case 82: return new SetComparisonConstraintHasNote(partition, roleAssignments, propertyAssignments);
				case 83: return new ValueConstraintHasNote(partition, roleAssignments, propertyAssignments);
				case 84: return new ElementGroupingHasNote(partition, roleAssignments, propertyAssignments);
				case 85: return new ModelHasPrimaryNote(partition, roleAssignments, propertyAssignments);
				case 86: return new ModelHasModelNote(partition, roleAssignments, propertyAssignments);
				case 87: return new ModelNoteReferencesFactType(partition, roleAssignments, propertyAssignments);
				case 88: return new ModelNoteReferencesObjectType(partition, roleAssignments, propertyAssignments);
				case 89: return new ModelNoteReferencesSetConstraint(partition, roleAssignments, propertyAssignments);
				case 90: return new ModelNoteReferencesSetComparisonConstraint(partition, roleAssignments, propertyAssignments);
				case 91: return new ObjectTypeHasCompatibleSupertypesError(partition, roleAssignments, propertyAssignments);
				case 92: return new SetConstraintHasImplicationError(partition, roleAssignments, propertyAssignments);
				case 93: return new SetComparisonConstraintHasImplicationError(partition, roleAssignments, propertyAssignments);
				case 94: return new SetComparisonConstraintHasEqualityOrSubsetImpliedByMandatoryError(partition, roleAssignments, propertyAssignments);
				case 95: return new ObjectTypeHasPreferredIdentifierRequiresMandatoryError(partition, roleAssignments, propertyAssignments);
				case 96: return new ValueConstraintHasValueRangeOverlapError(partition, roleAssignments, propertyAssignments);
				case 97: return new ValueConstraintHasValueTypeDetachedError(partition, roleAssignments, propertyAssignments);
				case 98: return new FactTypeHasRole(partition, roleAssignments, propertyAssignments);
				case 99: return new ReadingOrderHasRole(partition, roleAssignments, propertyAssignments);
				case 100: return new RoleProxyHasRole(partition, roleAssignments, propertyAssignments);
				case 101: return new ObjectifiedUnaryRoleHasRole(partition, roleAssignments, propertyAssignments);
				case 102: return new FactTypeHasDerivationExpression(partition, roleAssignments, propertyAssignments);
				case 103: return new SubtypeHasDerivationExpression(partition, roleAssignments, propertyAssignments);
				case 104: return new ObjectTypeHasObjectTypeInstance(partition, roleAssignments, propertyAssignments);
				case 105: return new EntityTypeHasEntityTypeInstance(partition, roleAssignments, propertyAssignments);
				case 106: return new EntityTypeSubtypeHasEntityTypeSubtypeInstance(partition, roleAssignments, propertyAssignments);
				case 107: return new ValueTypeHasValueTypeInstance(partition, roleAssignments, propertyAssignments);
				case 108: return new EntityTypeRoleInstance(partition, roleAssignments, propertyAssignments);
				case 109: return new FactTypeRoleInstance(partition, roleAssignments, propertyAssignments);
				case 110: return new EntityTypeInstanceHasRoleInstance(partition, roleAssignments, propertyAssignments);
				case 111: return new EntityTypeSubtypeInstanceHasSupertypeInstance(partition, roleAssignments, propertyAssignments);
				case 112: return new FactTypeHasFactTypeInstance(partition, roleAssignments, propertyAssignments);
				case 113: return new FactTypeInstanceHasRoleInstance(partition, roleAssignments, propertyAssignments);
				case 114: return new ObjectificationInstance(partition, roleAssignments, propertyAssignments);
				case 115: return new ObjectifiedInstanceHasObjectifyingInstanceRequiredError(partition, roleAssignments, propertyAssignments);
				case 116: return new ObjectifyingInstanceHasObjectifiedInstanceRequiredError(partition, roleAssignments, propertyAssignments);
				case 117: return new EntityTypeInstanceHasTooFewEntityTypeRoleInstancesError(partition, roleAssignments, propertyAssignments);
				case 118: return new FactTypeInstanceHasTooFewFactTypeRoleInstancesError(partition, roleAssignments, propertyAssignments);
				case 119: return new ValueTypeInstanceHasCompatibleValueTypeInstanceValueError(partition, roleAssignments, propertyAssignments);
				case 120: return new JoinHasInputRole(partition, roleAssignments, propertyAssignments);
				case 121: return new JoinHasOutputRole(partition, roleAssignments, propertyAssignments);
				case 122: return new ConstraintRoleSequenceHasJoinPath(partition, roleAssignments, propertyAssignments);
				case 123: return new ConstraintRoleSequenceHasRoleHasProjectionJoin(partition, roleAssignments, propertyAssignments);
				case 124: return new ModelHasModelErrorDisplayFilter(partition, roleAssignments, propertyAssignments);
				case 125: return new ElementGroupingSetRelatesToORMModel(partition, roleAssignments, propertyAssignments);
				case 126: return new ElementGroupingSetContainsElementGrouping(partition, roleAssignments, propertyAssignments);
				case 127: return new ElementGroupingIsOfElementGroupingType(partition, roleAssignments, propertyAssignments);
				case 128: return new GroupingElementInclusion(partition, roleAssignments, propertyAssignments);
				case 129: return new GroupingElementExclusion(partition, roleAssignments, propertyAssignments);
				case 130: return new ElementGroupingIncludesElementGrouping(partition, roleAssignments, propertyAssignments);
				case 131: return new ElementGroupingExcludesElementGrouping(partition, roleAssignments, propertyAssignments);
				case 132: return new ElementGroupingHasDuplicateNameError(partition, roleAssignments, propertyAssignments);
				case 133: return new ElementGroupingHasMembershipContradictionError(partition, roleAssignments, propertyAssignments);
				case 134: return new GroupingMembershipContradictionErrorIsForElement(partition, roleAssignments, propertyAssignments);
				case 135: return new PrimaryRolePathHasRootObjectType(partition, roleAssignments, propertyAssignments);
				case 136: return new PathedRole(partition, roleAssignments, propertyAssignments);
				case 137: return new PathedRoleIsRemotelyCorrelatedWithPathedRole(partition, roleAssignments, propertyAssignments);
				case 138: return new RoleSubPathPathIsContinuationOfRolePath(partition, roleAssignments, propertyAssignments);
				case 139: return new ModelDefinesFunction(partition, roleAssignments, propertyAssignments);
				case 140: return new FunctionOperatesOnParameter(partition, roleAssignments, propertyAssignments);
				case 141: return new PrimaryRolePathCalculatesCalculatedPathValue(partition, roleAssignments, propertyAssignments);
				case 142: return new PrimaryRolePathSatisfiesCalculatedCondition(partition, roleAssignments, propertyAssignments);
				case 143: return new CalculatedPathValueHasInput(partition, roleAssignments, propertyAssignments);
				case 144: return new CalculatedPathValueScopedWithPathedRole(partition, roleAssignments, propertyAssignments);
				case 145: return new CalculatedPathValueIsCalculatedWithFunction(partition, roleAssignments, propertyAssignments);
				case 146: return new CalculatedPathValueInputCorrespondsToFunctionParameter(partition, roleAssignments, propertyAssignments);
				case 147: return new CalculatedPathValueInputBindsToPathedRole(partition, roleAssignments, propertyAssignments);
				case 148: return new CalculatedPathValueInputBindsToCalculatedPathValue(partition, roleAssignments, propertyAssignments);
				case 149: return new CalculatedPathValueInputBindsToPathConstant(partition, roleAssignments, propertyAssignments);
				case 150: return new FactTypeHasDerivationRule(partition, roleAssignments, propertyAssignments);
				case 151: return new RoleDerivesFromPathedRole(partition, roleAssignments, propertyAssignments);
				case 152: return new RoleDerivesFromCalculatedPathValue(partition, roleAssignments, propertyAssignments);
				case 153: return new RoleDerivesFromPathConstant(partition, roleAssignments, propertyAssignments);
				case 154: return new SubtypeHasDerivationRule(partition, roleAssignments, propertyAssignments);
				default: return null;
			}
		}
		#endregion
	...
	public partial class ORMCoreDeleteClosureBase : DslModeling::IElementVisitorFilter
	{
		...
		public ORMCoreDeleteClosureBase()
		{
			...
			DomainRoles.Add(global::ORMSolutions.ORMArchitect.Core.ObjectModel.RoleSubPathPathIsContinuationOfRolePath.SubPathDomainRoleId, true);
			...
			DomainRoles.Add(global::ORMSolutions.ORMArchitect.Core.ObjectModel.PrimaryRolePathCalculatesCalculatedPathValue.CalculatedValueDomainRoleId, true);
