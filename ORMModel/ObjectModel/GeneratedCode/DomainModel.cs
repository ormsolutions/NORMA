...
namespace ORMSolutions.ORMArchitect.Core.ObjectModel
{
	...
	public partial class ORMCoreDomainModel : DslModeling::DomainModel
	{
		...
		public sealed override DslModeling::ElementLink CreateElementLink(DslModeling::Partition partition, global::System.Type elementLinkType, DslModeling::RoleAssignment[] roleAssignments, DslModeling::PropertyAssignment[] propertyAssignments)
		{
			...
			{
				createElementLinkMap = new global::System.Collections.Generic.Dictionary<global::System.Type, int>(209);
				...
				createElementLinkMap.Add(typeof(ModelHasModelNote), 91);
				createElementLinkMap.Add(typeof(ModelNoteReferencesFactType), 92);
				createElementLinkMap.Add(typeof(ModelNoteReferencesObjectType), 93);
				createElementLinkMap.Add(typeof(ModelNoteReferencesSetConstraint), 94);
				createElementLinkMap.Add(typeof(ModelNoteReferencesSetComparisonConstraint), 95);
				createElementLinkMap.Add(typeof(ObjectTypeHasCompatibleSupertypesError), 96);
				createElementLinkMap.Add(typeof(SetConstraintHasImplicationError), 97);
				createElementLinkMap.Add(typeof(SetComparisonConstraintHasImplicationError), 98);
				createElementLinkMap.Add(typeof(SetComparisonConstraintHasEqualityOrSubsetImpliedByMandatoryError), 99);
				createElementLinkMap.Add(typeof(ObjectTypeHasPreferredIdentifierRequiresMandatoryError), 100);
				createElementLinkMap.Add(typeof(ValueConstraintHasValueRangeOverlapError), 101);
				createElementLinkMap.Add(typeof(ValueConstraintHasValueTypeDetachedError), 102);
				createElementLinkMap.Add(typeof(FactTypeHasRole), 103);
				createElementLinkMap.Add(typeof(ReadingOrderHasRole), 104);
				createElementLinkMap.Add(typeof(RoleProxyHasRole), 105);
				createElementLinkMap.Add(typeof(ObjectifiedUnaryRoleHasRole), 106);
				createElementLinkMap.Add(typeof(FactTypeHasDerivationExpression), 107);
				createElementLinkMap.Add(typeof(SubtypeHasDerivationExpression), 108);
				createElementLinkMap.Add(typeof(ObjectTypeHasObjectTypeInstance), 109);
				createElementLinkMap.Add(typeof(EntityTypeHasEntityTypeInstance), 110);
				createElementLinkMap.Add(typeof(EntityTypeSubtypeHasEntityTypeSubtypeInstance), 111);
				createElementLinkMap.Add(typeof(ValueTypeHasValueTypeInstance), 112);
				createElementLinkMap.Add(typeof(EntityTypeRoleInstance), 113);
				createElementLinkMap.Add(typeof(FactTypeRoleInstance), 114);
				createElementLinkMap.Add(typeof(EntityTypeInstanceHasRoleInstance), 115);
				createElementLinkMap.Add(typeof(EntityTypeSubtypeInstanceHasSupertypeInstance), 116);
				createElementLinkMap.Add(typeof(FactTypeHasFactTypeInstance), 117);
				createElementLinkMap.Add(typeof(FactTypeInstanceHasRoleInstance), 118);
				createElementLinkMap.Add(typeof(ObjectificationInstance), 119);
				createElementLinkMap.Add(typeof(ObjectifiedInstanceHasObjectifyingInstanceRequiredError), 120);
				createElementLinkMap.Add(typeof(ObjectifyingInstanceHasObjectifiedInstanceRequiredError), 121);
				createElementLinkMap.Add(typeof(EntityTypeInstanceHasTooFewEntityTypeRoleInstancesError), 122);
				createElementLinkMap.Add(typeof(FactTypeInstanceHasTooFewFactTypeRoleInstancesError), 123);
				createElementLinkMap.Add(typeof(ValueTypeInstanceHasCompatibleValueTypeInstanceValueError), 124);
				createElementLinkMap.Add(typeof(ConstraintRoleSequenceHasJoinPath), 125);
				createElementLinkMap.Add(typeof(ConstraintRoleSequenceJoinPathProjection), 126);
				createElementLinkMap.Add(typeof(ConstraintRoleProjection), 127);
				createElementLinkMap.Add(typeof(ConstraintRoleProjectedFromRolePathRoot), 128);
				createElementLinkMap.Add(typeof(ConstraintRoleProjectedFromPathedRole), 129);
				createElementLinkMap.Add(typeof(ConstraintRoleProjectedFromCalculatedPathValue), 130);
				createElementLinkMap.Add(typeof(ConstraintRoleProjectedFromPathConstant), 131);
				createElementLinkMap.Add(typeof(ConstraintRoleProjectedFromPathedRole_Deprecated), 132);
				createElementLinkMap.Add(typeof(ConstraintRoleProjectedFromCalculatedPathValue_Deprecated), 133);
				createElementLinkMap.Add(typeof(ConstraintRoleProjectedFromPathConstant_Deprecated), 134);
				createElementLinkMap.Add(typeof(ModelHasModelErrorDisplayFilter), 135);
				createElementLinkMap.Add(typeof(ElementGroupingSetRelatesToORMModel), 136);
				createElementLinkMap.Add(typeof(ElementGroupingSetContainsElementGrouping), 137);
				createElementLinkMap.Add(typeof(ElementGroupingIsOfElementGroupingType), 138);
				createElementLinkMap.Add(typeof(GroupingElementInclusion), 139);
				createElementLinkMap.Add(typeof(GroupingElementExclusion), 140);
				createElementLinkMap.Add(typeof(ElementGroupingIncludesElementGrouping), 141);
				createElementLinkMap.Add(typeof(ElementGroupingExcludesElementGrouping), 142);
				createElementLinkMap.Add(typeof(ElementGroupingHasDuplicateNameError), 143);
				createElementLinkMap.Add(typeof(ElementGroupingHasMembershipContradictionError), 144);
				createElementLinkMap.Add(typeof(GroupingMembershipContradictionErrorIsForElement), 145);
				createElementLinkMap.Add(typeof(RolePathOwnerHasPathComponent_Deprecated), 146);
				createElementLinkMap.Add(typeof(RolePathOwnerOwnsLeadRolePath), 147);
				createElementLinkMap.Add(typeof(RolePathOwnerUsesSharedLeadRolePath), 148);
				createElementLinkMap.Add(typeof(RolePathOwnerHasSingleLeadRolePath), 149);
				createElementLinkMap.Add(typeof(RolePathOwnerHasSingleOwnedLeadRolePath), 150);
				createElementLinkMap.Add(typeof(RolePathObjectTypeRoot), 151);
				createElementLinkMap.Add(typeof(PathedRole), 152);
				createElementLinkMap.Add(typeof(PathedRoleIsRemotelyCorrelatedWithPathedRole_Deprecated), 153);
				createElementLinkMap.Add(typeof(LeadRolePathHasObjectUnifier), 154);
				createElementLinkMap.Add(typeof(PathObjectUnifierUnifiesPathedRole), 155);
				createElementLinkMap.Add(typeof(PathObjectUnifierUnifiesRolePathRoot), 156);
				createElementLinkMap.Add(typeof(RoleSubPathIsContinuationOfRolePath), 157);
				createElementLinkMap.Add(typeof(ModelDefinesFunction), 158);
				createElementLinkMap.Add(typeof(FunctionOperatesOnParameter), 159);
				createElementLinkMap.Add(typeof(RolePathOwnerCalculatesCalculatedPathValue_Deprecated), 160);
				createElementLinkMap.Add(typeof(LeadRolePathCalculatesCalculatedPathValue), 161);
				createElementLinkMap.Add(typeof(LeadRolePathSatisfiesCalculatedCondition), 162);
				createElementLinkMap.Add(typeof(CalculatedPathValueHasInput), 163);
				createElementLinkMap.Add(typeof(CalculatedPathValueScopedWithPathedRole_Deprecated), 164);
				createElementLinkMap.Add(typeof(CalculatedPathValueAggregationContextIncludesPathedRole), 165);
				createElementLinkMap.Add(typeof(CalculatedPathValueAggregationContextIncludesRolePathRoot), 166);
				createElementLinkMap.Add(typeof(CalculatedPathValueIsCalculatedWithFunction), 167);
				createElementLinkMap.Add(typeof(CalculatedPathValueInputCorrespondsToFunctionParameter), 168);
				createElementLinkMap.Add(typeof(CalculatedPathValueInputBindsToRolePathRoot), 169);
				createElementLinkMap.Add(typeof(CalculatedPathValueInputBindsToPathedRole), 170);
				createElementLinkMap.Add(typeof(CalculatedPathValueInputBindsToCalculatedPathValue), 171);
				createElementLinkMap.Add(typeof(CalculatedPathValueInputBindsToPathConstant), 172);
				createElementLinkMap.Add(typeof(FactTypeHasDerivationRule), 173);
				createElementLinkMap.Add(typeof(FactTypeDerivationRuleHasDerivationNote), 174);
				createElementLinkMap.Add(typeof(FactTypeDerivationProjection), 175);
				createElementLinkMap.Add(typeof(FactTypeRoleProjection), 176);
				createElementLinkMap.Add(typeof(FactTypeRoleProjectedFromRolePathRoot), 177);
				createElementLinkMap.Add(typeof(FactTypeRoleProjectedFromPathedRole), 178);
				createElementLinkMap.Add(typeof(FactTypeRoleProjectedFromCalculatedPathValue), 179);
				createElementLinkMap.Add(typeof(FactTypeRoleProjectedFromPathConstant), 180);
				createElementLinkMap.Add(typeof(RoleDerivesFromPathedRole_Deprecated), 181);
				createElementLinkMap.Add(typeof(RoleDerivesFromCalculatedPathValue_Deprecated), 182);
				createElementLinkMap.Add(typeof(RoleDerivesFromPathConstant_Deprecated), 183);
				createElementLinkMap.Add(typeof(SubtypeHasDerivationRule), 184);
				createElementLinkMap.Add(typeof(SubtypeDerivationRuleHasDerivationNote), 185);
				createElementLinkMap.Add(typeof(RolePathHasRootObjectTypeError), 186);
				createElementLinkMap.Add(typeof(PathedRoleHasCompatibleJoinRolePlayerError), 187);
				createElementLinkMap.Add(typeof(PathObjectUnifierHasCompatibleObjectTypesError), 188);
				createElementLinkMap.Add(typeof(PathedRoleHasSameFactTypeFollowsJoinError), 189);
				createElementLinkMap.Add(typeof(PathedRoleHasMandatoryOuterJoinError), 190);
				createElementLinkMap.Add(typeof(CalculatedPathValueHasFunctionRequiredError), 191);
				createElementLinkMap.Add(typeof(CalculatedPathValueHasUnboundParameterError), 192);
				createElementLinkMap.Add(typeof(CalculatedPathValueParameterBindingErrorTargetsFunctionParameter), 193);
				createElementLinkMap.Add(typeof(CalculatedPathValueHasConsumptionRequiredError), 194);
				createElementLinkMap.Add(typeof(CalculatedPathValueHasAggregationContextRequiredError), 195);
				createElementLinkMap.Add(typeof(FactTypeDerivationRuleHasProjectionRequiredError), 196);
				createElementLinkMap.Add(typeof(FactTypeDerivationProjectionHasPartialProjectionError), 197);
				createElementLinkMap.Add(typeof(ConstraintRoleSequenceJoinPathHasProjectionRequiredError), 198);
				createElementLinkMap.Add(typeof(ConstraintRoleSequenceProjectionHasPartialProjectionError), 199);
			}
			int index;
			...
			switch (index)
			{
				...
				case 91: return new ModelHasModelNote(partition, roleAssignments, propertyAssignments);
				case 92: return new ModelNoteReferencesFactType(partition, roleAssignments, propertyAssignments);
				case 93: return new ModelNoteReferencesObjectType(partition, roleAssignments, propertyAssignments);
				case 94: return new ModelNoteReferencesSetConstraint(partition, roleAssignments, propertyAssignments);
				case 95: return new ModelNoteReferencesSetComparisonConstraint(partition, roleAssignments, propertyAssignments);
				case 96: return new ObjectTypeHasCompatibleSupertypesError(partition, roleAssignments, propertyAssignments);
				case 97: return new SetConstraintHasImplicationError(partition, roleAssignments, propertyAssignments);
				case 98: return new SetComparisonConstraintHasImplicationError(partition, roleAssignments, propertyAssignments);
				case 99: return new SetComparisonConstraintHasEqualityOrSubsetImpliedByMandatoryError(partition, roleAssignments, propertyAssignments);
				case 100: return new ObjectTypeHasPreferredIdentifierRequiresMandatoryError(partition, roleAssignments, propertyAssignments);
				case 101: return new ValueConstraintHasValueRangeOverlapError(partition, roleAssignments, propertyAssignments);
				case 102: return new ValueConstraintHasValueTypeDetachedError(partition, roleAssignments, propertyAssignments);
				case 103: return new FactTypeHasRole(partition, roleAssignments, propertyAssignments);
				case 104: return new ReadingOrderHasRole(partition, roleAssignments, propertyAssignments);
				case 105: return new RoleProxyHasRole(partition, roleAssignments, propertyAssignments);
				case 106: return new ObjectifiedUnaryRoleHasRole(partition, roleAssignments, propertyAssignments);
				case 107: return new FactTypeHasDerivationExpression(partition, roleAssignments, propertyAssignments);
				case 108: return new SubtypeHasDerivationExpression(partition, roleAssignments, propertyAssignments);
				case 109: return new ObjectTypeHasObjectTypeInstance(partition, roleAssignments, propertyAssignments);
				case 110: return new EntityTypeHasEntityTypeInstance(partition, roleAssignments, propertyAssignments);
				case 111: return new EntityTypeSubtypeHasEntityTypeSubtypeInstance(partition, roleAssignments, propertyAssignments);
				case 112: return new ValueTypeHasValueTypeInstance(partition, roleAssignments, propertyAssignments);
				case 113: return new EntityTypeRoleInstance(partition, roleAssignments, propertyAssignments);
				case 114: return new FactTypeRoleInstance(partition, roleAssignments, propertyAssignments);
				case 115: return new EntityTypeInstanceHasRoleInstance(partition, roleAssignments, propertyAssignments);
				case 116: return new EntityTypeSubtypeInstanceHasSupertypeInstance(partition, roleAssignments, propertyAssignments);
				case 117: return new FactTypeHasFactTypeInstance(partition, roleAssignments, propertyAssignments);
				case 118: return new FactTypeInstanceHasRoleInstance(partition, roleAssignments, propertyAssignments);
				case 119: return new ObjectificationInstance(partition, roleAssignments, propertyAssignments);
				case 120: return new ObjectifiedInstanceHasObjectifyingInstanceRequiredError(partition, roleAssignments, propertyAssignments);
				case 121: return new ObjectifyingInstanceHasObjectifiedInstanceRequiredError(partition, roleAssignments, propertyAssignments);
				case 122: return new EntityTypeInstanceHasTooFewEntityTypeRoleInstancesError(partition, roleAssignments, propertyAssignments);
				case 123: return new FactTypeInstanceHasTooFewFactTypeRoleInstancesError(partition, roleAssignments, propertyAssignments);
				case 124: return new ValueTypeInstanceHasCompatibleValueTypeInstanceValueError(partition, roleAssignments, propertyAssignments);
				case 125: return new ConstraintRoleSequenceHasJoinPath(partition, roleAssignments, propertyAssignments);
				case 126: return new ConstraintRoleSequenceJoinPathProjection(partition, roleAssignments, propertyAssignments);
				case 127: return new ConstraintRoleProjection(partition, roleAssignments, propertyAssignments);
				case 128: return new ConstraintRoleProjectedFromRolePathRoot(partition, roleAssignments, propertyAssignments);
				case 129: return new ConstraintRoleProjectedFromPathedRole(partition, roleAssignments, propertyAssignments);
				case 130: return new ConstraintRoleProjectedFromCalculatedPathValue(partition, roleAssignments, propertyAssignments);
				case 131: return new ConstraintRoleProjectedFromPathConstant(partition, roleAssignments, propertyAssignments);
				case 132: return new ConstraintRoleProjectedFromPathedRole_Deprecated(partition, roleAssignments, propertyAssignments);
				case 133: return new ConstraintRoleProjectedFromCalculatedPathValue_Deprecated(partition, roleAssignments, propertyAssignments);
				case 134: return new ConstraintRoleProjectedFromPathConstant_Deprecated(partition, roleAssignments, propertyAssignments);
				case 135: return new ModelHasModelErrorDisplayFilter(partition, roleAssignments, propertyAssignments);
				case 136: return new ElementGroupingSetRelatesToORMModel(partition, roleAssignments, propertyAssignments);
				case 137: return new ElementGroupingSetContainsElementGrouping(partition, roleAssignments, propertyAssignments);
				case 138: return new ElementGroupingIsOfElementGroupingType(partition, roleAssignments, propertyAssignments);
				case 139: return new GroupingElementInclusion(partition, roleAssignments, propertyAssignments);
				case 140: return new GroupingElementExclusion(partition, roleAssignments, propertyAssignments);
				case 141: return new ElementGroupingIncludesElementGrouping(partition, roleAssignments, propertyAssignments);
				case 142: return new ElementGroupingExcludesElementGrouping(partition, roleAssignments, propertyAssignments);
				case 143: return new ElementGroupingHasDuplicateNameError(partition, roleAssignments, propertyAssignments);
				case 144: return new ElementGroupingHasMembershipContradictionError(partition, roleAssignments, propertyAssignments);
				case 145: return new GroupingMembershipContradictionErrorIsForElement(partition, roleAssignments, propertyAssignments);
				case 146: return new RolePathOwnerHasPathComponent_Deprecated(partition, roleAssignments, propertyAssignments);
				case 147: return new RolePathOwnerOwnsLeadRolePath(partition, roleAssignments, propertyAssignments);
				case 148: return new RolePathOwnerUsesSharedLeadRolePath(partition, roleAssignments, propertyAssignments);
				case 149: return new RolePathOwnerHasSingleLeadRolePath(partition, roleAssignments, propertyAssignments);
				case 150: return new RolePathOwnerHasSingleOwnedLeadRolePath(partition, roleAssignments, propertyAssignments);
				case 151: return new RolePathObjectTypeRoot(partition, roleAssignments, propertyAssignments);
				case 152: return new PathedRole(partition, roleAssignments, propertyAssignments);
				case 153: return new PathedRoleIsRemotelyCorrelatedWithPathedRole_Deprecated(partition, roleAssignments, propertyAssignments);
				case 154: return new LeadRolePathHasObjectUnifier(partition, roleAssignments, propertyAssignments);
				case 155: return new PathObjectUnifierUnifiesPathedRole(partition, roleAssignments, propertyAssignments);
				case 156: return new PathObjectUnifierUnifiesRolePathRoot(partition, roleAssignments, propertyAssignments);
				case 157: return new RoleSubPathIsContinuationOfRolePath(partition, roleAssignments, propertyAssignments);
				case 158: return new ModelDefinesFunction(partition, roleAssignments, propertyAssignments);
				case 159: return new FunctionOperatesOnParameter(partition, roleAssignments, propertyAssignments);
				case 160: return new RolePathOwnerCalculatesCalculatedPathValue_Deprecated(partition, roleAssignments, propertyAssignments);
				case 161: return new LeadRolePathCalculatesCalculatedPathValue(partition, roleAssignments, propertyAssignments);
				case 162: return new LeadRolePathSatisfiesCalculatedCondition(partition, roleAssignments, propertyAssignments);
				case 163: return new CalculatedPathValueHasInput(partition, roleAssignments, propertyAssignments);
				case 164: return new CalculatedPathValueScopedWithPathedRole_Deprecated(partition, roleAssignments, propertyAssignments);
				case 165: return new CalculatedPathValueAggregationContextIncludesPathedRole(partition, roleAssignments, propertyAssignments);
				case 166: return new CalculatedPathValueAggregationContextIncludesRolePathRoot(partition, roleAssignments, propertyAssignments);
				case 167: return new CalculatedPathValueIsCalculatedWithFunction(partition, roleAssignments, propertyAssignments);
				case 168: return new CalculatedPathValueInputCorrespondsToFunctionParameter(partition, roleAssignments, propertyAssignments);
				case 169: return new CalculatedPathValueInputBindsToRolePathRoot(partition, roleAssignments, propertyAssignments);
				case 170: return new CalculatedPathValueInputBindsToPathedRole(partition, roleAssignments, propertyAssignments);
				case 171: return new CalculatedPathValueInputBindsToCalculatedPathValue(partition, roleAssignments, propertyAssignments);
				case 172: return new CalculatedPathValueInputBindsToPathConstant(partition, roleAssignments, propertyAssignments);
				case 173: return new FactTypeHasDerivationRule(partition, roleAssignments, propertyAssignments);
				case 174: return new FactTypeDerivationRuleHasDerivationNote(partition, roleAssignments, propertyAssignments);
				case 175: return new FactTypeDerivationProjection(partition, roleAssignments, propertyAssignments);
				case 176: return new FactTypeRoleProjection(partition, roleAssignments, propertyAssignments);
				case 177: return new FactTypeRoleProjectedFromRolePathRoot(partition, roleAssignments, propertyAssignments);
				case 178: return new FactTypeRoleProjectedFromPathedRole(partition, roleAssignments, propertyAssignments);
				case 179: return new FactTypeRoleProjectedFromCalculatedPathValue(partition, roleAssignments, propertyAssignments);
				case 180: return new FactTypeRoleProjectedFromPathConstant(partition, roleAssignments, propertyAssignments);
				case 181: return new RoleDerivesFromPathedRole_Deprecated(partition, roleAssignments, propertyAssignments);
				case 182: return new RoleDerivesFromCalculatedPathValue_Deprecated(partition, roleAssignments, propertyAssignments);
				case 183: return new RoleDerivesFromPathConstant_Deprecated(partition, roleAssignments, propertyAssignments);
				case 184: return new SubtypeHasDerivationRule(partition, roleAssignments, propertyAssignments);
				case 185: return new SubtypeDerivationRuleHasDerivationNote(partition, roleAssignments, propertyAssignments);
				case 186: return new RolePathHasRootObjectTypeError(partition, roleAssignments, propertyAssignments);
				case 187: return new PathedRoleHasCompatibleJoinRolePlayerError(partition, roleAssignments, propertyAssignments);
				case 188: return new PathObjectUnifierHasCompatibleObjectTypesError(partition, roleAssignments, propertyAssignments);
				case 189: return new PathedRoleHasSameFactTypeFollowsJoinError(partition, roleAssignments, propertyAssignments);
				case 190: return new PathedRoleHasMandatoryOuterJoinError(partition, roleAssignments, propertyAssignments);
				case 191: return new CalculatedPathValueHasFunctionRequiredError(partition, roleAssignments, propertyAssignments);
				case 192: return new CalculatedPathValueHasUnboundParameterError(partition, roleAssignments, propertyAssignments);
				case 193: return new CalculatedPathValueParameterBindingErrorTargetsFunctionParameter(partition, roleAssignments, propertyAssignments);
				case 194: return new CalculatedPathValueHasConsumptionRequiredError(partition, roleAssignments, propertyAssignments);
				case 195: return new CalculatedPathValueHasAggregationContextRequiredError(partition, roleAssignments, propertyAssignments);
				case 196: return new FactTypeDerivationRuleHasProjectionRequiredError(partition, roleAssignments, propertyAssignments);
				case 197: return new FactTypeDerivationProjectionHasPartialProjectionError(partition, roleAssignments, propertyAssignments);
				case 198: return new ConstraintRoleSequenceJoinPathHasProjectionRequiredError(partition, roleAssignments, propertyAssignments);
				case 199: return new ConstraintRoleSequenceProjectionHasPartialProjectionError(partition, roleAssignments, propertyAssignments);
				default: return null;
			}
		}
		#endregion
