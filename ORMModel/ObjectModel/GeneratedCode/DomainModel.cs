...
namespace Neumont.Tools.ORM.ObjectModel
{
	...
	public partial class ORMCoreDomainModel : DslModeling::DomainModel
	{
		...
		public sealed override DslModeling::ModelElement CreateElement(DslModeling::Partition partition, global::System.Type elementType, DslModeling::PropertyAssignment[] propertyAssignments)
		{
			...
			{
				createElementMap = new global::System.Collections.Generic.Dictionary<global::System.Type, int>(107);
				...
				createElementMap.Add(typeof(ExclusionContradictsEqualityError), 18);
				createElementMap.Add(typeof(ExclusionContradictsSubsetError), 19);
				createElementMap.Add(typeof(PopulationMandatoryError), 20);
				createElementMap.Add(typeof(ConstraintDuplicateNameError), 21);
				createElementMap.Add(typeof(TooFewReadingRolesError), 22);
				createElementMap.Add(typeof(TooManyReadingRolesError), 23);
				createElementMap.Add(typeof(ExternalConstraintRoleSequenceArityMismatchError), 24);
				createElementMap.Add(typeof(FactTypeRequiresReadingError), 25);
				createElementMap.Add(typeof(FactTypeRequiresInternalUniquenessConstraintError), 26);
				createElementMap.Add(typeof(DataTypeNotSpecifiedError), 27);
				createElementMap.Add(typeof(NMinusOneError), 28);
				createElementMap.Add(typeof(CompatibleRolePlayerTypeError), 29);
				createElementMap.Add(typeof(RolePlayerRequiredError), 30);
				createElementMap.Add(typeof(EqualityImpliedByMandatoryError), 31);
				createElementMap.Add(typeof(EntityTypeRequiresReferenceSchemeError), 32);
				createElementMap.Add(typeof(FrequencyConstraintMinMaxError), 33);
				createElementMap.Add(typeof(ReferenceModeKind), 34);
				createElementMap.Add(typeof(IntrinsicReferenceMode), 35);
				createElementMap.Add(typeof(CustomReferenceMode), 36);
				createElementMap.Add(typeof(UnspecifiedDataType), 37);
				createElementMap.Add(typeof(FixedLengthTextDataType), 38);
				createElementMap.Add(typeof(VariableLengthTextDataType), 39);
				createElementMap.Add(typeof(LargeLengthTextDataType), 40);
				createElementMap.Add(typeof(SignedIntegerNumericDataType), 41);
				createElementMap.Add(typeof(UnsignedIntegerNumericDataType), 42);
				createElementMap.Add(typeof(AutoCounterNumericDataType), 43);
				createElementMap.Add(typeof(FloatingPointNumericDataType), 44);
				createElementMap.Add(typeof(DecimalNumericDataType), 45);
				createElementMap.Add(typeof(MoneyNumericDataType), 46);
				createElementMap.Add(typeof(FixedLengthRawDataDataType), 47);
				createElementMap.Add(typeof(VariableLengthRawDataDataType), 48);
				createElementMap.Add(typeof(LargeLengthRawDataDataType), 49);
				createElementMap.Add(typeof(PictureRawDataDataType), 50);
				createElementMap.Add(typeof(OleObjectRawDataDataType), 51);
				createElementMap.Add(typeof(AutoTimestampTemporalDataType), 52);
				createElementMap.Add(typeof(TimeTemporalDataType), 53);
				createElementMap.Add(typeof(DateTemporalDataType), 54);
				createElementMap.Add(typeof(DateAndTimeTemporalDataType), 55);
				createElementMap.Add(typeof(TrueOrFalseLogicalDataType), 56);
				createElementMap.Add(typeof(YesOrNoLogicalDataType), 57);
				createElementMap.Add(typeof(RowIdOtherDataType), 58);
				createElementMap.Add(typeof(ObjectIdOtherDataType), 59);
				createElementMap.Add(typeof(Reading), 60);
				createElementMap.Add(typeof(ReadingOrder), 61);
				createElementMap.Add(typeof(ValueRange), 62);
				createElementMap.Add(typeof(ValueTypeValueConstraint), 63);
				createElementMap.Add(typeof(RoleValueConstraint), 64);
				createElementMap.Add(typeof(MinValueMismatchError), 65);
				createElementMap.Add(typeof(MaxValueMismatchError), 66);
				createElementMap.Add(typeof(ImpliedInternalUniquenessConstraintError), 67);
				createElementMap.Add(typeof(FrequencyConstraintContradictsInternalUniquenessConstraintError), 68);
				createElementMap.Add(typeof(RingConstraintTypeNotSpecifiedError), 69);
				createElementMap.Add(typeof(SubtypeMetaRole), 70);
				createElementMap.Add(typeof(SupertypeMetaRole), 71);
				createElementMap.Add(typeof(ObjectTypeRequiresPrimarySupertypeError), 72);
				createElementMap.Add(typeof(Note), 73);
				createElementMap.Add(typeof(ModelNote), 74);
				createElementMap.Add(typeof(CompatibleSupertypesError), 75);
				createElementMap.Add(typeof(ImplicationError), 76);
				createElementMap.Add(typeof(PreferredIdentifierRequiresMandatoryError), 77);
				createElementMap.Add(typeof(ValueRangeOverlapError), 78);
				createElementMap.Add(typeof(FactTypeDerivationExpression), 79);
				createElementMap.Add(typeof(EntityTypeInstance), 80);
				createElementMap.Add(typeof(ValueTypeInstance), 81);
				createElementMap.Add(typeof(FactTypeInstance), 82);
				createElementMap.Add(typeof(TooFewEntityTypeRoleInstancesError), 83);
				createElementMap.Add(typeof(TooFewFactTypeRoleInstancesError), 84);
				createElementMap.Add(typeof(CompatibleValueTypeInstanceValueError), 85);
			}
			int index;
			...
			switch (index)
			{
				...
				case 18: return new ExclusionContradictsEqualityError(partition, propertyAssignments);
				case 19: return new ExclusionContradictsSubsetError(partition, propertyAssignments);
				case 20: return new PopulationMandatoryError(partition, propertyAssignments);
				case 21: return new ConstraintDuplicateNameError(partition, propertyAssignments);
				case 22: return new TooFewReadingRolesError(partition, propertyAssignments);
				case 23: return new TooManyReadingRolesError(partition, propertyAssignments);
				case 24: return new ExternalConstraintRoleSequenceArityMismatchError(partition, propertyAssignments);
				case 25: return new FactTypeRequiresReadingError(partition, propertyAssignments);
				case 26: return new FactTypeRequiresInternalUniquenessConstraintError(partition, propertyAssignments);
				case 27: return new DataTypeNotSpecifiedError(partition, propertyAssignments);
				case 28: return new NMinusOneError(partition, propertyAssignments);
				case 29: return new CompatibleRolePlayerTypeError(partition, propertyAssignments);
				case 30: return new RolePlayerRequiredError(partition, propertyAssignments);
				case 31: return new EqualityImpliedByMandatoryError(partition, propertyAssignments);
				case 32: return new EntityTypeRequiresReferenceSchemeError(partition, propertyAssignments);
				case 33: return new FrequencyConstraintMinMaxError(partition, propertyAssignments);
				case 34: return new ReferenceModeKind(partition, propertyAssignments);
				case 35: return new IntrinsicReferenceMode(partition, propertyAssignments);
				case 36: return new CustomReferenceMode(partition, propertyAssignments);
				case 37: return new UnspecifiedDataType(partition, propertyAssignments);
				case 38: return new FixedLengthTextDataType(partition, propertyAssignments);
				case 39: return new VariableLengthTextDataType(partition, propertyAssignments);
				case 40: return new LargeLengthTextDataType(partition, propertyAssignments);
				case 41: return new SignedIntegerNumericDataType(partition, propertyAssignments);
				case 42: return new UnsignedIntegerNumericDataType(partition, propertyAssignments);
				case 43: return new AutoCounterNumericDataType(partition, propertyAssignments);
				case 44: return new FloatingPointNumericDataType(partition, propertyAssignments);
				case 45: return new DecimalNumericDataType(partition, propertyAssignments);
				case 46: return new MoneyNumericDataType(partition, propertyAssignments);
				case 47: return new FixedLengthRawDataDataType(partition, propertyAssignments);
				case 48: return new VariableLengthRawDataDataType(partition, propertyAssignments);
				case 49: return new LargeLengthRawDataDataType(partition, propertyAssignments);
				case 50: return new PictureRawDataDataType(partition, propertyAssignments);
				case 51: return new OleObjectRawDataDataType(partition, propertyAssignments);
				case 52: return new AutoTimestampTemporalDataType(partition, propertyAssignments);
				case 53: return new TimeTemporalDataType(partition, propertyAssignments);
				case 54: return new DateTemporalDataType(partition, propertyAssignments);
				case 55: return new DateAndTimeTemporalDataType(partition, propertyAssignments);
				case 56: return new TrueOrFalseLogicalDataType(partition, propertyAssignments);
				case 57: return new YesOrNoLogicalDataType(partition, propertyAssignments);
				case 58: return new RowIdOtherDataType(partition, propertyAssignments);
				case 59: return new ObjectIdOtherDataType(partition, propertyAssignments);
				case 60: return new Reading(partition, propertyAssignments);
				case 61: return new ReadingOrder(partition, propertyAssignments);
				case 62: return new ValueRange(partition, propertyAssignments);
				case 63: return new ValueTypeValueConstraint(partition, propertyAssignments);
				case 64: return new RoleValueConstraint(partition, propertyAssignments);
				case 65: return new MinValueMismatchError(partition, propertyAssignments);
				case 66: return new MaxValueMismatchError(partition, propertyAssignments);
				case 67: return new ImpliedInternalUniquenessConstraintError(partition, propertyAssignments);
				case 68: return new FrequencyConstraintContradictsInternalUniquenessConstraintError(partition, propertyAssignments);
				case 69: return new RingConstraintTypeNotSpecifiedError(partition, propertyAssignments);
				case 70: return new SubtypeMetaRole(partition, propertyAssignments);
				case 71: return new SupertypeMetaRole(partition, propertyAssignments);
				case 72: return new ObjectTypeRequiresPrimarySupertypeError(partition, propertyAssignments);
				case 73: return new Note(partition, propertyAssignments);
				case 74: return new ModelNote(partition, propertyAssignments);
				case 75: return new CompatibleSupertypesError(partition, propertyAssignments);
				case 76: return new ImplicationError(partition, propertyAssignments);
				case 77: return new PreferredIdentifierRequiresMandatoryError(partition, propertyAssignments);
				case 78: return new ValueRangeOverlapError(partition, propertyAssignments);
				case 79: return new FactTypeDerivationExpression(partition, propertyAssignments);
				case 80: return new EntityTypeInstance(partition, propertyAssignments);
				case 81: return new ValueTypeInstance(partition, propertyAssignments);
				case 82: return new FactTypeInstance(partition, propertyAssignments);
				case 83: return new TooFewEntityTypeRoleInstancesError(partition, propertyAssignments);
				case 84: return new TooFewFactTypeRoleInstancesError(partition, propertyAssignments);
				case 85: return new CompatibleValueTypeInstanceValueError(partition, propertyAssignments);
				default: return null;
			}
		}
