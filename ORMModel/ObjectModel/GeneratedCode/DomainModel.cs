...
namespace Neumont.Tools.ORM.ObjectModel
{
	...
	public partial class ORMCoreDomainModel : DslModeling::DomainModel
	{
		...
		public sealed override DslModeling::ModelElement CreateElement(DslModeling::Partition partition, global::System.Type elementType, DslModeling::PropertyAssignment[] propertyAssignments)
		{
			...
			{
				createElementMap = new global::System.Collections.Generic.Dictionary<global::System.Type, int>(123);
				...
				createElementMap.Add(typeof(ImplicitBooleanRole), 8);
				createElementMap.Add(typeof(EqualityConstraint), 9);
				createElementMap.Add(typeof(ExclusionConstraint), 10);
				createElementMap.Add(typeof(SubsetConstraint), 11);
				createElementMap.Add(typeof(SetComparisonConstraintRoleSequence), 12);
				createElementMap.Add(typeof(RingConstraint), 13);
				createElementMap.Add(typeof(FrequencyConstraint), 14);
				createElementMap.Add(typeof(UniquenessConstraint), 15);
				createElementMap.Add(typeof(MandatoryConstraint), 16);
				createElementMap.Add(typeof(Join), 17);
				createElementMap.Add(typeof(TooFewRoleSequencesError), 18);
				createElementMap.Add(typeof(TooManyRoleSequencesError), 19);
				createElementMap.Add(typeof(ObjectTypeDuplicateNameError), 20);
				createElementMap.Add(typeof(PopulationUniquenessError), 21);
				createElementMap.Add(typeof(ExclusionContradictsMandatoryError), 22);
				createElementMap.Add(typeof(ExclusionContradictsEqualityError), 23);
				createElementMap.Add(typeof(ExclusionContradictsSubsetError), 24);
				createElementMap.Add(typeof(NotWellModeledSubsetAndMandatoryError), 25);
				createElementMap.Add(typeof(PopulationMandatoryError), 26);
				createElementMap.Add(typeof(ConstraintDuplicateNameError), 27);
				createElementMap.Add(typeof(TooFewReadingRolesError), 28);
				createElementMap.Add(typeof(TooManyReadingRolesError), 29);
				createElementMap.Add(typeof(ExternalConstraintRoleSequenceArityMismatchError), 30);
				createElementMap.Add(typeof(FactTypeRequiresReadingError), 31);
				createElementMap.Add(typeof(FactTypeRequiresInternalUniquenessConstraintError), 32);
				createElementMap.Add(typeof(DataTypeNotSpecifiedError), 33);
				createElementMap.Add(typeof(NMinusOneError), 34);
				createElementMap.Add(typeof(CompatibleRolePlayerTypeError), 35);
				createElementMap.Add(typeof(RolePlayerRequiredError), 36);
				createElementMap.Add(typeof(EqualityImpliedByMandatoryError), 37);
				createElementMap.Add(typeof(EntityTypeRequiresReferenceSchemeError), 38);
				createElementMap.Add(typeof(FrequencyConstraintMinMaxError), 39);
				createElementMap.Add(typeof(ReadingRequiresUserModificationError), 40);
				createElementMap.Add(typeof(ReferenceModeKind), 41);
				createElementMap.Add(typeof(IntrinsicReferenceMode), 42);
				createElementMap.Add(typeof(CustomReferenceMode), 43);
				createElementMap.Add(typeof(UnspecifiedDataType), 44);
				createElementMap.Add(typeof(FixedLengthTextDataType), 45);
				createElementMap.Add(typeof(VariableLengthTextDataType), 46);
				createElementMap.Add(typeof(LargeLengthTextDataType), 47);
				createElementMap.Add(typeof(SignedIntegerNumericDataType), 48);
				createElementMap.Add(typeof(UnsignedIntegerNumericDataType), 49);
				createElementMap.Add(typeof(AutoCounterNumericDataType), 50);
				createElementMap.Add(typeof(FloatingPointNumericDataType), 51);
				createElementMap.Add(typeof(DecimalNumericDataType), 52);
				createElementMap.Add(typeof(MoneyNumericDataType), 53);
				createElementMap.Add(typeof(FixedLengthRawDataDataType), 54);
				createElementMap.Add(typeof(VariableLengthRawDataDataType), 55);
				createElementMap.Add(typeof(LargeLengthRawDataDataType), 56);
				createElementMap.Add(typeof(PictureRawDataDataType), 57);
				createElementMap.Add(typeof(OleObjectRawDataDataType), 58);
				createElementMap.Add(typeof(AutoTimestampTemporalDataType), 59);
				createElementMap.Add(typeof(TimeTemporalDataType), 60);
				createElementMap.Add(typeof(DateTemporalDataType), 61);
				createElementMap.Add(typeof(DateAndTimeTemporalDataType), 62);
				createElementMap.Add(typeof(TrueOrFalseLogicalDataType), 63);
				createElementMap.Add(typeof(YesOrNoLogicalDataType), 64);
				createElementMap.Add(typeof(RowIdOtherDataType), 65);
				createElementMap.Add(typeof(ObjectIdOtherDataType), 66);
				createElementMap.Add(typeof(Reading), 67);
				createElementMap.Add(typeof(ReadingOrder), 68);
				createElementMap.Add(typeof(ValueRange), 69);
				createElementMap.Add(typeof(ValueTypeValueConstraint), 70);
				createElementMap.Add(typeof(RoleValueConstraint), 71);
				createElementMap.Add(typeof(MinValueMismatchError), 72);
				createElementMap.Add(typeof(MaxValueMismatchError), 73);
				createElementMap.Add(typeof(ImpliedInternalUniquenessConstraintError), 74);
				createElementMap.Add(typeof(FrequencyConstraintContradictsInternalUniquenessConstraintError), 75);
				createElementMap.Add(typeof(RingConstraintTypeNotSpecifiedError), 76);
				createElementMap.Add(typeof(SubtypeMetaRole), 77);
				createElementMap.Add(typeof(SupertypeMetaRole), 78);
				createElementMap.Add(typeof(ObjectTypeRequiresPrimarySupertypeError), 79);
				createElementMap.Add(typeof(Note), 80);
				createElementMap.Add(typeof(ModelNote), 81);
				createElementMap.Add(typeof(CompatibleSupertypesError), 82);
				createElementMap.Add(typeof(ImplicationError), 83);
				createElementMap.Add(typeof(EqualityOrSubsetImpliedByMandatoryError), 84);
				createElementMap.Add(typeof(PreferredIdentifierRequiresMandatoryError), 85);
				createElementMap.Add(typeof(ValueRangeOverlapError), 86);
				createElementMap.Add(typeof(FactTypeDerivationExpression), 87);
				createElementMap.Add(typeof(EntityTypeInstance), 88);
				createElementMap.Add(typeof(ValueTypeInstance), 89);
				createElementMap.Add(typeof(FactTypeInstance), 90);
				createElementMap.Add(typeof(TooFewEntityTypeRoleInstancesError), 91);
				createElementMap.Add(typeof(TooFewFactTypeRoleInstancesError), 92);
				createElementMap.Add(typeof(CompatibleValueTypeInstanceValueError), 93);
			}
			int index;
			...
			switch (index)
			{
				...
				case 8: return new ImplicitBooleanRole(partition, propertyAssignments);
				case 9: return new EqualityConstraint(partition, propertyAssignments);
				case 10: return new ExclusionConstraint(partition, propertyAssignments);
				case 11: return new SubsetConstraint(partition, propertyAssignments);
				case 12: return new SetComparisonConstraintRoleSequence(partition, propertyAssignments);
				case 13: return new RingConstraint(partition, propertyAssignments);
				case 14: return new FrequencyConstraint(partition, propertyAssignments);
				case 15: return new UniquenessConstraint(partition, propertyAssignments);
				case 16: return new MandatoryConstraint(partition, propertyAssignments);
				case 17: return new Join(partition, propertyAssignments);
				case 18: return new TooFewRoleSequencesError(partition, propertyAssignments);
				case 19: return new TooManyRoleSequencesError(partition, propertyAssignments);
				case 20: return new ObjectTypeDuplicateNameError(partition, propertyAssignments);
				case 21: return new PopulationUniquenessError(partition, propertyAssignments);
				case 22: return new ExclusionContradictsMandatoryError(partition, propertyAssignments);
				case 23: return new ExclusionContradictsEqualityError(partition, propertyAssignments);
				case 24: return new ExclusionContradictsSubsetError(partition, propertyAssignments);
				case 25: return new NotWellModeledSubsetAndMandatoryError(partition, propertyAssignments);
				case 26: return new PopulationMandatoryError(partition, propertyAssignments);
				case 27: return new ConstraintDuplicateNameError(partition, propertyAssignments);
				case 28: return new TooFewReadingRolesError(partition, propertyAssignments);
				case 29: return new TooManyReadingRolesError(partition, propertyAssignments);
				case 30: return new ExternalConstraintRoleSequenceArityMismatchError(partition, propertyAssignments);
				case 31: return new FactTypeRequiresReadingError(partition, propertyAssignments);
				case 32: return new FactTypeRequiresInternalUniquenessConstraintError(partition, propertyAssignments);
				case 33: return new DataTypeNotSpecifiedError(partition, propertyAssignments);
				case 34: return new NMinusOneError(partition, propertyAssignments);
				case 35: return new CompatibleRolePlayerTypeError(partition, propertyAssignments);
				case 36: return new RolePlayerRequiredError(partition, propertyAssignments);
				case 37: return new EqualityImpliedByMandatoryError(partition, propertyAssignments);
				case 38: return new EntityTypeRequiresReferenceSchemeError(partition, propertyAssignments);
				case 39: return new FrequencyConstraintMinMaxError(partition, propertyAssignments);
				case 40: return new ReadingRequiresUserModificationError(partition, propertyAssignments);
				case 41: return new ReferenceModeKind(partition, propertyAssignments);
				case 42: return new IntrinsicReferenceMode(partition, propertyAssignments);
				case 43: return new CustomReferenceMode(partition, propertyAssignments);
				case 44: return new UnspecifiedDataType(partition, propertyAssignments);
				case 45: return new FixedLengthTextDataType(partition, propertyAssignments);
				case 46: return new VariableLengthTextDataType(partition, propertyAssignments);
				case 47: return new LargeLengthTextDataType(partition, propertyAssignments);
				case 48: return new SignedIntegerNumericDataType(partition, propertyAssignments);
				case 49: return new UnsignedIntegerNumericDataType(partition, propertyAssignments);
				case 50: return new AutoCounterNumericDataType(partition, propertyAssignments);
				case 51: return new FloatingPointNumericDataType(partition, propertyAssignments);
				case 52: return new DecimalNumericDataType(partition, propertyAssignments);
				case 53: return new MoneyNumericDataType(partition, propertyAssignments);
				case 54: return new FixedLengthRawDataDataType(partition, propertyAssignments);
				case 55: return new VariableLengthRawDataDataType(partition, propertyAssignments);
				case 56: return new LargeLengthRawDataDataType(partition, propertyAssignments);
				case 57: return new PictureRawDataDataType(partition, propertyAssignments);
				case 58: return new OleObjectRawDataDataType(partition, propertyAssignments);
				case 59: return new AutoTimestampTemporalDataType(partition, propertyAssignments);
				case 60: return new TimeTemporalDataType(partition, propertyAssignments);
				case 61: return new DateTemporalDataType(partition, propertyAssignments);
				case 62: return new DateAndTimeTemporalDataType(partition, propertyAssignments);
				case 63: return new TrueOrFalseLogicalDataType(partition, propertyAssignments);
				case 64: return new YesOrNoLogicalDataType(partition, propertyAssignments);
				case 65: return new RowIdOtherDataType(partition, propertyAssignments);
				case 66: return new ObjectIdOtherDataType(partition, propertyAssignments);
				case 67: return new Reading(partition, propertyAssignments);
				case 68: return new ReadingOrder(partition, propertyAssignments);
				case 69: return new ValueRange(partition, propertyAssignments);
				case 70: return new ValueTypeValueConstraint(partition, propertyAssignments);
				case 71: return new RoleValueConstraint(partition, propertyAssignments);
				case 72: return new MinValueMismatchError(partition, propertyAssignments);
				case 73: return new MaxValueMismatchError(partition, propertyAssignments);
				case 74: return new ImpliedInternalUniquenessConstraintError(partition, propertyAssignments);
				case 75: return new FrequencyConstraintContradictsInternalUniquenessConstraintError(partition, propertyAssignments);
				case 76: return new RingConstraintTypeNotSpecifiedError(partition, propertyAssignments);
				case 77: return new SubtypeMetaRole(partition, propertyAssignments);
				case 78: return new SupertypeMetaRole(partition, propertyAssignments);
				case 79: return new ObjectTypeRequiresPrimarySupertypeError(partition, propertyAssignments);
				case 80: return new Note(partition, propertyAssignments);
				case 81: return new ModelNote(partition, propertyAssignments);
				case 82: return new CompatibleSupertypesError(partition, propertyAssignments);
				case 83: return new ImplicationError(partition, propertyAssignments);
				case 84: return new EqualityOrSubsetImpliedByMandatoryError(partition, propertyAssignments);
				case 85: return new PreferredIdentifierRequiresMandatoryError(partition, propertyAssignments);
				case 86: return new ValueRangeOverlapError(partition, propertyAssignments);
				case 87: return new FactTypeDerivationExpression(partition, propertyAssignments);
				case 88: return new EntityTypeInstance(partition, propertyAssignments);
				case 89: return new ValueTypeInstance(partition, propertyAssignments);
				case 90: return new FactTypeInstance(partition, propertyAssignments);
				case 91: return new TooFewEntityTypeRoleInstancesError(partition, propertyAssignments);
				case 92: return new TooFewFactTypeRoleInstancesError(partition, propertyAssignments);
				case 93: return new CompatibleValueTypeInstanceValueError(partition, propertyAssignments);
				default: return null;
			}
		}
		...
		public sealed override DslModeling::ElementLink CreateElementLink(DslModeling::Partition partition, global::System.Type elementLinkType, DslModeling::RoleAssignment[] roleAssignments, DslModeling::PropertyAssignment[] propertyAssignments)
		{
			...
			{
				createElementLinkMap = new global::System.Collections.Generic.Dictionary<global::System.Type, int>(103);
				...
				createElementLinkMap.Add(typeof(FactTypeHasFactTypeRequiresReadingError), 42);
				createElementLinkMap.Add(typeof(FactTypeHasFactTypeRequiresInternalUniquenessConstraintError), 43);
				createElementLinkMap.Add(typeof(ValueTypeHasValueConstraint), 44);
				createElementLinkMap.Add(typeof(RoleHasValueConstraint), 45);
				createElementLinkMap.Add(typeof(ValueConstraintHasValueRange), 46);
				createElementLinkMap.Add(typeof(ValueTypeHasUnspecifiedDataTypeError), 47);
				createElementLinkMap.Add(typeof(SetComparisonConstraintHasCompatibleRolePlayerTypeError), 48);
				createElementLinkMap.Add(typeof(SetConstraintHasCompatibleRolePlayerTypeError), 49);
				createElementLinkMap.Add(typeof(UniquenessConstraintHasNMinusOneError), 50);
				createElementLinkMap.Add(typeof(RoleHasRolePlayerRequiredError), 51);
				createElementLinkMap.Add(typeof(EqualityConstraintHasEqualityImpliedByMandatoryError), 52);
				createElementLinkMap.Add(typeof(ObjectTypeHasEntityTypeRequiresReferenceSchemeError), 53);
				createElementLinkMap.Add(typeof(FrequencyConstraintHasFrequencyConstraintMinMaxError), 54);
				createElementLinkMap.Add(typeof(ObjectificationImpliesFactType), 55);
				createElementLinkMap.Add(typeof(ValueRangeHasMaxValueMismatchError), 56);
				createElementLinkMap.Add(typeof(ValueRangeHasMinValueMismatchError), 57);
				createElementLinkMap.Add(typeof(FactTypeHasImpliedInternalUniquenessConstraintError), 58);
				createElementLinkMap.Add(typeof(SetConstraintHasTooFewRoleSequencesError), 59);
				createElementLinkMap.Add(typeof(SetConstraintHasTooManyRoleSequencesError), 60);
				createElementLinkMap.Add(typeof(FrequencyConstraintHasFrequencyConstraintInvalidatedByInternalUniquenessConstraintError), 61);
				createElementLinkMap.Add(typeof(FactTypeHasFrequencyConstraintContradictsInternalUniquenessConstraintError), 62);
				createElementLinkMap.Add(typeof(RingConstraintHasRingConstraintTypeNotSpecifiedError), 63);
				createElementLinkMap.Add(typeof(ValueConstraintHasDuplicateNameError), 64);
				createElementLinkMap.Add(typeof(ObjectTypeHasObjectTypeRequiresPrimarySupertypeError), 65);
				createElementLinkMap.Add(typeof(FactTypeHasNote), 66);
				createElementLinkMap.Add(typeof(ObjectTypeHasNote), 67);
				createElementLinkMap.Add(typeof(ModelHasModelNote), 68);
				createElementLinkMap.Add(typeof(ModelNoteReferencesFactType), 69);
				createElementLinkMap.Add(typeof(ModelNoteReferencesObjectType), 70);
				createElementLinkMap.Add(typeof(ObjectTypeHasCompatibleSupertypesError), 71);
				createElementLinkMap.Add(typeof(SetConstraintHasImplicationError), 72);
				createElementLinkMap.Add(typeof(SetComparisonConstraintHasImplicationError), 73);
				createElementLinkMap.Add(typeof(SetComparisonConstraintHasEqualityOrSubsetImpliedByMandatoryError), 74);
				createElementLinkMap.Add(typeof(ObjectTypeHasPreferredIdentifierRequiresMandatoryError), 75);
				createElementLinkMap.Add(typeof(ValueConstraintHasValueRangeOverlapError), 76);
				createElementLinkMap.Add(typeof(FactTypeHasRole), 77);
				createElementLinkMap.Add(typeof(ReadingOrderHasRole), 78);
				createElementLinkMap.Add(typeof(RoleProxyHasRole), 79);
				createElementLinkMap.Add(typeof(FactTypeHasDerivationExpression), 80);
				createElementLinkMap.Add(typeof(EntityTypeHasEntityTypeInstance), 81);
				createElementLinkMap.Add(typeof(ValueTypeHasValueTypeInstance), 82);
				createElementLinkMap.Add(typeof(EntityTypeRoleInstance), 83);
				createElementLinkMap.Add(typeof(FactTypeRoleInstance), 84);
				createElementLinkMap.Add(typeof(EntityTypeInstanceHasRoleInstance), 85);
				createElementLinkMap.Add(typeof(FactTypeHasFactTypeInstance), 86);
				createElementLinkMap.Add(typeof(FactTypeInstanceHasRoleInstance), 87);
				createElementLinkMap.Add(typeof(EntityTypeInstanceHasTooFewEntityTypeRoleInstancesError), 88);
				createElementLinkMap.Add(typeof(FactTypeInstanceHasTooFewFactTypeRoleInstancesError), 89);
				createElementLinkMap.Add(typeof(ValueTypeInstanceHasCompatibleValueTypeInstanceValueError), 90);
				createElementLinkMap.Add(typeof(JoinHasInputRole), 91);
				createElementLinkMap.Add(typeof(JoinHasOutputRole), 92);
				createElementLinkMap.Add(typeof(ConstraintRoleSequenceHasJoinPath), 93);
				createElementLinkMap.Add(typeof(ConstraintRoleSequenceHasRoleHasProjectionJoin), 94);
				createElementLinkMap.Add(typeof(ModelHasModelErrorDisplayFilter), 95);
			}
			int index;
			...
			switch (index)
			{
				...
				case 42: return new FactTypeHasFactTypeRequiresReadingError(partition, roleAssignments, propertyAssignments);
				case 43: return new FactTypeHasFactTypeRequiresInternalUniquenessConstraintError(partition, roleAssignments, propertyAssignments);
				case 44: return new ValueTypeHasValueConstraint(partition, roleAssignments, propertyAssignments);
				case 45: return new RoleHasValueConstraint(partition, roleAssignments, propertyAssignments);
				case 46: return new ValueConstraintHasValueRange(partition, roleAssignments, propertyAssignments);
				case 47: return new ValueTypeHasUnspecifiedDataTypeError(partition, roleAssignments, propertyAssignments);
				case 48: return new SetComparisonConstraintHasCompatibleRolePlayerTypeError(partition, roleAssignments, propertyAssignments);
				case 49: return new SetConstraintHasCompatibleRolePlayerTypeError(partition, roleAssignments, propertyAssignments);
				case 50: return new UniquenessConstraintHasNMinusOneError(partition, roleAssignments, propertyAssignments);
				case 51: return new RoleHasRolePlayerRequiredError(partition, roleAssignments, propertyAssignments);
				case 52: return new EqualityConstraintHasEqualityImpliedByMandatoryError(partition, roleAssignments, propertyAssignments);
				case 53: return new ObjectTypeHasEntityTypeRequiresReferenceSchemeError(partition, roleAssignments, propertyAssignments);
				case 54: return new FrequencyConstraintHasFrequencyConstraintMinMaxError(partition, roleAssignments, propertyAssignments);
				case 55: return new ObjectificationImpliesFactType(partition, roleAssignments, propertyAssignments);
				case 56: return new ValueRangeHasMaxValueMismatchError(partition, roleAssignments, propertyAssignments);
				case 57: return new ValueRangeHasMinValueMismatchError(partition, roleAssignments, propertyAssignments);
				case 58: return new FactTypeHasImpliedInternalUniquenessConstraintError(partition, roleAssignments, propertyAssignments);
				case 59: return new SetConstraintHasTooFewRoleSequencesError(partition, roleAssignments, propertyAssignments);
				case 60: return new SetConstraintHasTooManyRoleSequencesError(partition, roleAssignments, propertyAssignments);
				case 61: return new FrequencyConstraintHasFrequencyConstraintInvalidatedByInternalUniquenessConstraintError(partition, roleAssignments, propertyAssignments);
				case 62: return new FactTypeHasFrequencyConstraintContradictsInternalUniquenessConstraintError(partition, roleAssignments, propertyAssignments);
				case 63: return new RingConstraintHasRingConstraintTypeNotSpecifiedError(partition, roleAssignments, propertyAssignments);
				case 64: return new ValueConstraintHasDuplicateNameError(partition, roleAssignments, propertyAssignments);
				case 65: return new ObjectTypeHasObjectTypeRequiresPrimarySupertypeError(partition, roleAssignments, propertyAssignments);
				case 66: return new FactTypeHasNote(partition, roleAssignments, propertyAssignments);
				case 67: return new ObjectTypeHasNote(partition, roleAssignments, propertyAssignments);
				case 68: return new ModelHasModelNote(partition, roleAssignments, propertyAssignments);
				case 69: return new ModelNoteReferencesFactType(partition, roleAssignments, propertyAssignments);
				case 70: return new ModelNoteReferencesObjectType(partition, roleAssignments, propertyAssignments);
				case 71: return new ObjectTypeHasCompatibleSupertypesError(partition, roleAssignments, propertyAssignments);
				case 72: return new SetConstraintHasImplicationError(partition, roleAssignments, propertyAssignments);
				case 73: return new SetComparisonConstraintHasImplicationError(partition, roleAssignments, propertyAssignments);
				case 74: return new SetComparisonConstraintHasEqualityOrSubsetImpliedByMandatoryError(partition, roleAssignments, propertyAssignments);
				case 75: return new ObjectTypeHasPreferredIdentifierRequiresMandatoryError(partition, roleAssignments, propertyAssignments);
				case 76: return new ValueConstraintHasValueRangeOverlapError(partition, roleAssignments, propertyAssignments);
				case 77: return new FactTypeHasRole(partition, roleAssignments, propertyAssignments);
				case 78: return new ReadingOrderHasRole(partition, roleAssignments, propertyAssignments);
				case 79: return new RoleProxyHasRole(partition, roleAssignments, propertyAssignments);
				case 80: return new FactTypeHasDerivationExpression(partition, roleAssignments, propertyAssignments);
				case 81: return new EntityTypeHasEntityTypeInstance(partition, roleAssignments, propertyAssignments);
				case 82: return new ValueTypeHasValueTypeInstance(partition, roleAssignments, propertyAssignments);
				case 83: return new EntityTypeRoleInstance(partition, roleAssignments, propertyAssignments);
				case 84: return new FactTypeRoleInstance(partition, roleAssignments, propertyAssignments);
				case 85: return new EntityTypeInstanceHasRoleInstance(partition, roleAssignments, propertyAssignments);
				case 86: return new FactTypeHasFactTypeInstance(partition, roleAssignments, propertyAssignments);
				case 87: return new FactTypeInstanceHasRoleInstance(partition, roleAssignments, propertyAssignments);
				case 88: return new EntityTypeInstanceHasTooFewEntityTypeRoleInstancesError(partition, roleAssignments, propertyAssignments);
				case 89: return new FactTypeInstanceHasTooFewFactTypeRoleInstancesError(partition, roleAssignments, propertyAssignments);
				case 90: return new ValueTypeInstanceHasCompatibleValueTypeInstanceValueError(partition, roleAssignments, propertyAssignments);
				case 91: return new JoinHasInputRole(partition, roleAssignments, propertyAssignments);
				case 92: return new JoinHasOutputRole(partition, roleAssignments, propertyAssignments);
				case 93: return new ConstraintRoleSequenceHasJoinPath(partition, roleAssignments, propertyAssignments);
				case 94: return new ConstraintRoleSequenceHasRoleHasProjectionJoin(partition, roleAssignments, propertyAssignments);
				case 95: return new ModelHasModelErrorDisplayFilter(partition, roleAssignments, propertyAssignments);
				default: return null;
			}
		}
		#endregion
