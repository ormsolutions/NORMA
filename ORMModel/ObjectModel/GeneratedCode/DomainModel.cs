	...
	public partial class ORMCoreDomainModel : DslModeling::DomainModel
	{
		...
		public sealed override DslModeling::ModelElement CreateElement(DslModeling::Partition partition, global::System.Type elementType, DslModeling::PropertyAssignment[] propertyAssignments)
		{
			...
			if (createElementMap == null)
			{
				...
				createElementMap.Add(typeof(PopulationUniquenessError), 24);
				createElementMap.Add(typeof(ExclusionContradictsMandatoryError), 25);
				createElementMap.Add(typeof(ExclusionContradictsEqualityError), 26);
				createElementMap.Add(typeof(ExclusionContradictsSubsetError), 27);
				createElementMap.Add(typeof(NotWellModeledSubsetAndMandatoryError), 28);
				createElementMap.Add(typeof(PopulationMandatoryError), 29);
				createElementMap.Add(typeof(ConstraintDuplicateNameError), 30);
				createElementMap.Add(typeof(TooFewReadingRolesError), 31);
				createElementMap.Add(typeof(TooManyReadingRolesError), 32);
				createElementMap.Add(typeof(ExternalConstraintRoleSequenceArityMismatchError), 33);
				createElementMap.Add(typeof(FactTypeRequiresReadingError), 34);
				createElementMap.Add(typeof(FactTypeRequiresInternalUniquenessConstraintError), 35);
				createElementMap.Add(typeof(DataTypeNotSpecifiedError), 36);
				createElementMap.Add(typeof(NMinusOneError), 37);
				createElementMap.Add(typeof(CompatibleRolePlayerTypeError), 38);
				createElementMap.Add(typeof(RolePlayerRequiredError), 39);
				createElementMap.Add(typeof(EqualityImpliedByMandatoryError), 40);
			...
			switch (index)
			{
				...
				case 24: return new PopulationUniquenessError(partition, propertyAssignments);
				case 25: return new ExclusionContradictsMandatoryError(partition, propertyAssignments);
				case 26: return new ExclusionContradictsEqualityError(partition, propertyAssignments);
				case 27: return new ExclusionContradictsSubsetError(partition, propertyAssignments);
				case 28: return new NotWellModeledSubsetAndMandatoryError(partition, propertyAssignments);
				case 29: return new PopulationMandatoryError(partition, propertyAssignments);
				case 30: return new ConstraintDuplicateNameError(partition, propertyAssignments);
				case 31: return new TooFewReadingRolesError(partition, propertyAssignments);
				case 32: return new TooManyReadingRolesError(partition, propertyAssignments);
				case 33: return new ExternalConstraintRoleSequenceArityMismatchError(partition, propertyAssignments);
				case 34: return new FactTypeRequiresReadingError(partition, propertyAssignments);
				case 35: return new FactTypeRequiresInternalUniquenessConstraintError(partition, propertyAssignments);
				case 36: return new DataTypeNotSpecifiedError(partition, propertyAssignments);
				case 37: return new NMinusOneError(partition, propertyAssignments);
				case 38: return new CompatibleRolePlayerTypeError(partition, propertyAssignments);
				case 39: return new RolePlayerRequiredError(partition, propertyAssignments);
				case 40: return new EqualityImpliedByMandatoryError(partition, propertyAssignments);
		...
		public sealed override DslModeling::ElementLink CreateElementLink(DslModeling::Partition partition, global::System.Type elementLinkType, DslModeling::RoleAssignment[] roleAssignments, DslModeling::PropertyAssignment[] propertyAssignments)
		{
			...
			{
				createElementLinkMap = new global::System.Collections.Generic.Dictionary<global::System.Type, int>(116);
				...
				createElementLinkMap.Add(typeof(ObjectTypeHasAbbreviation), 18);
				createElementLinkMap.Add(typeof(NameGeneratorContainsOmittedWord), 19);
				createElementLinkMap.Add(typeof(ExternalRoleConstraint), 20);
				createElementLinkMap.Add(typeof(ExclusiveOrConstraintCoupler), 21);
				createElementLinkMap.Add(typeof(SetComparisonConstraintHasRoleSequence), 22);
				createElementLinkMap.Add(typeof(ConstraintRoleSequenceHasRole), 23);
				createElementLinkMap.Add(typeof(SetComparisonConstraintHasTooFewRoleSequencesError), 24);
				createElementLinkMap.Add(typeof(SetComparisonConstraintHasTooManyRoleSequencesError), 25);
				createElementLinkMap.Add(typeof(ObjectTypeHasDuplicateNameError), 26);
				createElementLinkMap.Add(typeof(EntityTypeRoleInstanceHasPopulationUniquenessError), 27);
				createElementLinkMap.Add(typeof(FactTypeRoleInstanceHasPopulationUniquenessError), 28);
				createElementLinkMap.Add(typeof(SetComparisonConstraintHasExclusionContradictsEqualityError), 29);
				createElementLinkMap.Add(typeof(SetComparisonConstraintHasExclusionContradictsSubsetError), 30);
				createElementLinkMap.Add(typeof(ExclusionConstraintHasExclusionContradictsMandatoryError), 31);
				createElementLinkMap.Add(typeof(MandatoryConstraintHasExclusionContradictsMandatoryError), 32);
				createElementLinkMap.Add(typeof(SubsetConstraintHasNotWellModeledSubsetAndMandatoryError), 33);
				createElementLinkMap.Add(typeof(MandatoryConstraintHasNotWellModeledSubsetAndMandatoryError), 34);
				createElementLinkMap.Add(typeof(MandatoryConstraintHasPopulationMandatoryError), 35);
				createElementLinkMap.Add(typeof(ObjectTypeInstanceHasPopulationMandatoryError), 36);
				createElementLinkMap.Add(typeof(ReadingOrderHasReading), 37);
				createElementLinkMap.Add(typeof(FactTypeHasReadingOrder), 38);
				createElementLinkMap.Add(typeof(ReferenceModeHasReferenceModeKind), 39);
				createElementLinkMap.Add(typeof(SetConstraintHasDuplicateNameError), 40);
				createElementLinkMap.Add(typeof(SetComparisonConstraintHasDuplicateNameError), 41);
				createElementLinkMap.Add(typeof(EntityTypeHasPreferredIdentifier), 42);
				createElementLinkMap.Add(typeof(ReadingHasTooManyRolesError), 43);
				createElementLinkMap.Add(typeof(ReadingHasTooFewRolesError), 44);
				createElementLinkMap.Add(typeof(ReadingHasReadingRequiresUserModificationError), 45);
				createElementLinkMap.Add(typeof(SetComparisonConstraintHasExternalConstraintRoleSequenceArityMismatchError), 46);
				createElementLinkMap.Add(typeof(ElementAssociatedWithModelError), 47);
				createElementLinkMap.Add(typeof(FactTypeHasFactTypeRequiresReadingError), 48);
				createElementLinkMap.Add(typeof(FactTypeHasFactTypeRequiresInternalUniquenessConstraintError), 49);
				createElementLinkMap.Add(typeof(ValueTypeHasValueConstraint), 50);
				createElementLinkMap.Add(typeof(RoleHasValueConstraint), 51);
				createElementLinkMap.Add(typeof(ValueConstraintHasValueRange), 52);
				createElementLinkMap.Add(typeof(ValueTypeHasUnspecifiedDataTypeError), 53);
				createElementLinkMap.Add(typeof(SetComparisonConstraintHasCompatibleRolePlayerTypeError), 54);
				createElementLinkMap.Add(typeof(SetConstraintHasCompatibleRolePlayerTypeError), 55);
				createElementLinkMap.Add(typeof(UniquenessConstraintHasNMinusOneError), 56);
				createElementLinkMap.Add(typeof(RoleHasRolePlayerRequiredError), 57);
				createElementLinkMap.Add(typeof(EqualityConstraintHasEqualityImpliedByMandatoryError), 58);
				createElementLinkMap.Add(typeof(ObjectTypeHasEntityTypeRequiresReferenceSchemeError), 59);
				createElementLinkMap.Add(typeof(FrequencyConstraintHasFrequencyConstraintMinMaxError), 60);
				createElementLinkMap.Add(typeof(FrequencyConstraintHasFrequencyConstraintExactlyOneError), 61);
				createElementLinkMap.Add(typeof(ObjectificationImpliesFactType), 62);
				createElementLinkMap.Add(typeof(ValueRangeHasMaxValueMismatchError), 63);
				createElementLinkMap.Add(typeof(ValueRangeHasMinValueMismatchError), 64);
				createElementLinkMap.Add(typeof(FactTypeHasImpliedInternalUniquenessConstraintError), 65);
				createElementLinkMap.Add(typeof(SetConstraintHasTooFewRoleSequencesError), 66);
				createElementLinkMap.Add(typeof(SetConstraintHasTooManyRoleSequencesError), 67);
				createElementLinkMap.Add(typeof(FrequencyConstraintHasFrequencyConstraintInvalidatedByInternalUniquenessConstraintError), 68);
				createElementLinkMap.Add(typeof(FactTypeHasFrequencyConstraintContradictsInternalUniquenessConstraintError), 69);
				...
				createElementLinkMap.Add(typeof(ValueConstraintHasValueTypeDetachedError), 87);
				createElementLinkMap.Add(typeof(FactTypeHasRole), 88);
				createElementLinkMap.Add(typeof(ReadingOrderHasRole), 89);
				createElementLinkMap.Add(typeof(RoleProxyHasRole), 90);
				createElementLinkMap.Add(typeof(FactTypeHasDerivationExpression), 91);
				createElementLinkMap.Add(typeof(ObjectTypeHasObjectTypeInstance), 92);
				createElementLinkMap.Add(typeof(EntityTypeHasEntityTypeInstance), 93);
				createElementLinkMap.Add(typeof(ValueTypeHasValueTypeInstance), 94);
				createElementLinkMap.Add(typeof(EntityTypeRoleInstance), 95);
				createElementLinkMap.Add(typeof(FactTypeRoleInstance), 96);
				createElementLinkMap.Add(typeof(EntityTypeInstanceHasRoleInstance), 97);
				createElementLinkMap.Add(typeof(FactTypeHasFactTypeInstance), 98);
				createElementLinkMap.Add(typeof(FactTypeInstanceHasRoleInstance), 99);
				createElementLinkMap.Add(typeof(EntityTypeInstanceHasTooFewEntityTypeRoleInstancesError), 100);
				createElementLinkMap.Add(typeof(FactTypeInstanceHasTooFewFactTypeRoleInstancesError), 101);
				createElementLinkMap.Add(typeof(ValueTypeInstanceHasCompatibleValueTypeInstanceValueError), 102);
				createElementLinkMap.Add(typeof(JoinHasInputRole), 103);
				createElementLinkMap.Add(typeof(JoinHasOutputRole), 104);
				createElementLinkMap.Add(typeof(ConstraintRoleSequenceHasJoinPath), 105);
				createElementLinkMap.Add(typeof(ConstraintRoleSequenceHasRoleHasProjectionJoin), 106);
				createElementLinkMap.Add(typeof(ModelHasModelErrorDisplayFilter), 107);
			}
			int index;
			...
			switch (index)
			{
				...
				case 18: return new ObjectTypeHasAbbreviation(partition, roleAssignments, propertyAssignments);
				case 19: return new NameGeneratorContainsOmittedWord(partition, roleAssignments, propertyAssignments);
				case 20: return new ExternalRoleConstraint(partition, roleAssignments, propertyAssignments);
				case 21: return new ExclusiveOrConstraintCoupler(partition, roleAssignments, propertyAssignments);
				case 22: return new SetComparisonConstraintHasRoleSequence(partition, roleAssignments, propertyAssignments);
				case 23: return new ConstraintRoleSequenceHasRole(partition, roleAssignments, propertyAssignments);
				case 24: return new SetComparisonConstraintHasTooFewRoleSequencesError(partition, roleAssignments, propertyAssignments);
				case 25: return new SetComparisonConstraintHasTooManyRoleSequencesError(partition, roleAssignments, propertyAssignments);
				case 26: return new ObjectTypeHasDuplicateNameError(partition, roleAssignments, propertyAssignments);
				case 27: return new EntityTypeRoleInstanceHasPopulationUniquenessError(partition, roleAssignments, propertyAssignments);
				case 28: return new FactTypeRoleInstanceHasPopulationUniquenessError(partition, roleAssignments, propertyAssignments);
				case 29: return new SetComparisonConstraintHasExclusionContradictsEqualityError(partition, roleAssignments, propertyAssignments);
				case 30: return new SetComparisonConstraintHasExclusionContradictsSubsetError(partition, roleAssignments, propertyAssignments);
				case 31: return new ExclusionConstraintHasExclusionContradictsMandatoryError(partition, roleAssignments, propertyAssignments);
				case 32: return new MandatoryConstraintHasExclusionContradictsMandatoryError(partition, roleAssignments, propertyAssignments);
				case 33: return new SubsetConstraintHasNotWellModeledSubsetAndMandatoryError(partition, roleAssignments, propertyAssignments);
				case 34: return new MandatoryConstraintHasNotWellModeledSubsetAndMandatoryError(partition, roleAssignments, propertyAssignments);
				case 35: return new MandatoryConstraintHasPopulationMandatoryError(partition, roleAssignments, propertyAssignments);
				case 36: return new ObjectTypeInstanceHasPopulationMandatoryError(partition, roleAssignments, propertyAssignments);
				case 37: return new ReadingOrderHasReading(partition, roleAssignments, propertyAssignments);
				case 38: return new FactTypeHasReadingOrder(partition, roleAssignments, propertyAssignments);
				case 39: return new ReferenceModeHasReferenceModeKind(partition, roleAssignments, propertyAssignments);
				case 40: return new SetConstraintHasDuplicateNameError(partition, roleAssignments, propertyAssignments);
				case 41: return new SetComparisonConstraintHasDuplicateNameError(partition, roleAssignments, propertyAssignments);
				case 42: return new EntityTypeHasPreferredIdentifier(partition, roleAssignments, propertyAssignments);
				case 43: return new ReadingHasTooManyRolesError(partition, roleAssignments, propertyAssignments);
				case 44: return new ReadingHasTooFewRolesError(partition, roleAssignments, propertyAssignments);
				case 45: return new ReadingHasReadingRequiresUserModificationError(partition, roleAssignments, propertyAssignments);
				case 46: return new SetComparisonConstraintHasExternalConstraintRoleSequenceArityMismatchError(partition, roleAssignments, propertyAssignments);
				case 47: return new ElementAssociatedWithModelError(partition, roleAssignments, propertyAssignments);
				case 48: return new FactTypeHasFactTypeRequiresReadingError(partition, roleAssignments, propertyAssignments);
				case 49: return new FactTypeHasFactTypeRequiresInternalUniquenessConstraintError(partition, roleAssignments, propertyAssignments);
				case 50: return new ValueTypeHasValueConstraint(partition, roleAssignments, propertyAssignments);
				case 51: return new RoleHasValueConstraint(partition, roleAssignments, propertyAssignments);
				case 52: return new ValueConstraintHasValueRange(partition, roleAssignments, propertyAssignments);
				case 53: return new ValueTypeHasUnspecifiedDataTypeError(partition, roleAssignments, propertyAssignments);
				case 54: return new SetComparisonConstraintHasCompatibleRolePlayerTypeError(partition, roleAssignments, propertyAssignments);
				case 55: return new SetConstraintHasCompatibleRolePlayerTypeError(partition, roleAssignments, propertyAssignments);
				case 56: return new UniquenessConstraintHasNMinusOneError(partition, roleAssignments, propertyAssignments);
				case 57: return new RoleHasRolePlayerRequiredError(partition, roleAssignments, propertyAssignments);
				case 58: return new EqualityConstraintHasEqualityImpliedByMandatoryError(partition, roleAssignments, propertyAssignments);
				case 59: return new ObjectTypeHasEntityTypeRequiresReferenceSchemeError(partition, roleAssignments, propertyAssignments);
				case 60: return new FrequencyConstraintHasFrequencyConstraintMinMaxError(partition, roleAssignments, propertyAssignments);
				case 61: return new FrequencyConstraintHasFrequencyConstraintExactlyOneError(partition, roleAssignments, propertyAssignments);
				case 62: return new ObjectificationImpliesFactType(partition, roleAssignments, propertyAssignments);
				case 63: return new ValueRangeHasMaxValueMismatchError(partition, roleAssignments, propertyAssignments);
				case 64: return new ValueRangeHasMinValueMismatchError(partition, roleAssignments, propertyAssignments);
				case 65: return new FactTypeHasImpliedInternalUniquenessConstraintError(partition, roleAssignments, propertyAssignments);
				case 66: return new SetConstraintHasTooFewRoleSequencesError(partition, roleAssignments, propertyAssignments);
				case 67: return new SetConstraintHasTooManyRoleSequencesError(partition, roleAssignments, propertyAssignments);
				case 68: return new FrequencyConstraintHasFrequencyConstraintInvalidatedByInternalUniquenessConstraintError(partition, roleAssignments, propertyAssignments);
				case 69: return new FactTypeHasFrequencyConstraintContradictsInternalUniquenessConstraintError(partition, roleAssignments, propertyAssignments);
				...
				case 87: return new ValueConstraintHasValueTypeDetachedError(partition, roleAssignments, propertyAssignments);
				case 88: return new FactTypeHasRole(partition, roleAssignments, propertyAssignments);
				case 89: return new ReadingOrderHasRole(partition, roleAssignments, propertyAssignments);
				case 90: return new RoleProxyHasRole(partition, roleAssignments, propertyAssignments);
				case 91: return new FactTypeHasDerivationExpression(partition, roleAssignments, propertyAssignments);
				case 92: return new ObjectTypeHasObjectTypeInstance(partition, roleAssignments, propertyAssignments);
				case 93: return new EntityTypeHasEntityTypeInstance(partition, roleAssignments, propertyAssignments);
				case 94: return new ValueTypeHasValueTypeInstance(partition, roleAssignments, propertyAssignments);
				case 95: return new EntityTypeRoleInstance(partition, roleAssignments, propertyAssignments);
				case 96: return new FactTypeRoleInstance(partition, roleAssignments, propertyAssignments);
				case 97: return new EntityTypeInstanceHasRoleInstance(partition, roleAssignments, propertyAssignments);
				case 98: return new FactTypeHasFactTypeInstance(partition, roleAssignments, propertyAssignments);
				case 99: return new FactTypeInstanceHasRoleInstance(partition, roleAssignments, propertyAssignments);
				case 100: return new EntityTypeInstanceHasTooFewEntityTypeRoleInstancesError(partition, roleAssignments, propertyAssignments);
				case 101: return new FactTypeInstanceHasTooFewFactTypeRoleInstancesError(partition, roleAssignments, propertyAssignments);
				case 102: return new ValueTypeInstanceHasCompatibleValueTypeInstanceValueError(partition, roleAssignments, propertyAssignments);
				case 103: return new JoinHasInputRole(partition, roleAssignments, propertyAssignments);
				case 104: return new JoinHasOutputRole(partition, roleAssignments, propertyAssignments);
				case 105: return new ConstraintRoleSequenceHasJoinPath(partition, roleAssignments, propertyAssignments);
				case 106: return new ConstraintRoleSequenceHasRoleHasProjectionJoin(partition, roleAssignments, propertyAssignments);
				case 107: return new ModelHasModelErrorDisplayFilter(partition, roleAssignments, propertyAssignments);
				default: return null;
			}
		}
		#endregion
