...
namespace Neumont.Tools.ORM.ObjectModel
{
	...
	public partial class ORMCoreDomainModel : DslModeling::DomainModel
	{
		...
		public sealed override DslModeling::ModelElement CreateElement(DslModeling::Partition partition, global::System.Type elementType, DslModeling::PropertyAssignment[] propertyAssignments)
		{
			...
			{
				createElementMap = new global::System.Collections.Generic.Dictionary<global::System.Type, int>(137);
				...
				createElementMap.Add(typeof(EntityTypeRequiresReferenceSchemeError), 41);
				createElementMap.Add(typeof(FrequencyConstraintMinMaxError), 42);
				createElementMap.Add(typeof(FrequencyConstraintExactlyOneError), 43);
				createElementMap.Add(typeof(ReadingRequiresUserModificationError), 44);
				createElementMap.Add(typeof(ReferenceModeKind), 45);
				createElementMap.Add(typeof(IntrinsicReferenceMode), 46);
				createElementMap.Add(typeof(CustomReferenceMode), 47);
				createElementMap.Add(typeof(UnspecifiedDataType), 48);
				createElementMap.Add(typeof(FixedLengthTextDataType), 49);
				createElementMap.Add(typeof(VariableLengthTextDataType), 50);
				createElementMap.Add(typeof(LargeLengthTextDataType), 51);
				createElementMap.Add(typeof(SignedIntegerNumericDataType), 52);
				createElementMap.Add(typeof(SignedSmallIntegerNumericDataType), 53);
				createElementMap.Add(typeof(SignedLargeIntegerNumericDataType), 54);
				createElementMap.Add(typeof(UnsignedIntegerNumericDataType), 55);
				createElementMap.Add(typeof(UnsignedTinyIntegerNumericDataType), 56);
				createElementMap.Add(typeof(UnsignedSmallIntegerNumericDataType), 57);
				createElementMap.Add(typeof(UnsignedLargeIntegerNumericDataType), 58);
				createElementMap.Add(typeof(AutoCounterNumericDataType), 59);
				createElementMap.Add(typeof(FloatingPointNumericDataType), 60);
				createElementMap.Add(typeof(SinglePrecisionFloatingPointNumericDataType), 61);
				createElementMap.Add(typeof(DoublePrecisionFloatingPointNumericDataType), 62);
				createElementMap.Add(typeof(DecimalNumericDataType), 63);
				createElementMap.Add(typeof(MoneyNumericDataType), 64);
				createElementMap.Add(typeof(FixedLengthRawDataDataType), 65);
				createElementMap.Add(typeof(VariableLengthRawDataDataType), 66);
				createElementMap.Add(typeof(LargeLengthRawDataDataType), 67);
				createElementMap.Add(typeof(PictureRawDataDataType), 68);
				createElementMap.Add(typeof(OleObjectRawDataDataType), 69);
				createElementMap.Add(typeof(AutoTimestampTemporalDataType), 70);
				createElementMap.Add(typeof(TimeTemporalDataType), 71);
				createElementMap.Add(typeof(DateTemporalDataType), 72);
				createElementMap.Add(typeof(DateAndTimeTemporalDataType), 73);
				createElementMap.Add(typeof(TrueOrFalseLogicalDataType), 74);
				createElementMap.Add(typeof(YesOrNoLogicalDataType), 75);
				createElementMap.Add(typeof(RowIdOtherDataType), 76);
				createElementMap.Add(typeof(ObjectIdOtherDataType), 77);
				createElementMap.Add(typeof(Reading), 78);
				createElementMap.Add(typeof(ReadingOrder), 79);
				createElementMap.Add(typeof(ValueRange), 80);
				createElementMap.Add(typeof(ValueTypeValueConstraint), 81);
				createElementMap.Add(typeof(RoleValueConstraint), 82);
				createElementMap.Add(typeof(MinValueMismatchError), 83);
				createElementMap.Add(typeof(MaxValueMismatchError), 84);
				createElementMap.Add(typeof(ImpliedInternalUniquenessConstraintError), 85);
				createElementMap.Add(typeof(FrequencyConstraintContradictsInternalUniquenessConstraintError), 86);
				createElementMap.Add(typeof(RingConstraintTypeNotSpecifiedError), 87);
				createElementMap.Add(typeof(SubtypeMetaRole), 88);
				createElementMap.Add(typeof(SupertypeMetaRole), 89);
				createElementMap.Add(typeof(Definition), 90);
				createElementMap.Add(typeof(Note), 91);
				createElementMap.Add(typeof(ModelNote), 92);
				createElementMap.Add(typeof(CompatibleSupertypesError), 93);
				createElementMap.Add(typeof(ImplicationError), 94);
				createElementMap.Add(typeof(EqualityOrSubsetImpliedByMandatoryError), 95);
				createElementMap.Add(typeof(PreferredIdentifierRequiresMandatoryError), 96);
				createElementMap.Add(typeof(ValueRangeOverlapError), 97);
				createElementMap.Add(typeof(ValueConstraintValueTypeDetachedError), 98);
				createElementMap.Add(typeof(FactTypeDerivationExpression), 99);
				createElementMap.Add(typeof(EntityTypeInstance), 100);
				createElementMap.Add(typeof(ValueTypeInstance), 101);
				createElementMap.Add(typeof(FactTypeInstance), 102);
				createElementMap.Add(typeof(TooFewEntityTypeRoleInstancesError), 103);
				createElementMap.Add(typeof(TooFewFactTypeRoleInstancesError), 104);
				createElementMap.Add(typeof(CompatibleValueTypeInstanceValueError), 105);
			}
			int index;
			...
			switch (index)
			{
				...
				case 41: return new EntityTypeRequiresReferenceSchemeError(partition, propertyAssignments);
				case 42: return new FrequencyConstraintMinMaxError(partition, propertyAssignments);
				case 43: return new FrequencyConstraintExactlyOneError(partition, propertyAssignments);
				case 44: return new ReadingRequiresUserModificationError(partition, propertyAssignments);
				case 45: return new ReferenceModeKind(partition, propertyAssignments);
				case 46: return new IntrinsicReferenceMode(partition, propertyAssignments);
				case 47: return new CustomReferenceMode(partition, propertyAssignments);
				case 48: return new UnspecifiedDataType(partition, propertyAssignments);
				case 49: return new FixedLengthTextDataType(partition, propertyAssignments);
				case 50: return new VariableLengthTextDataType(partition, propertyAssignments);
				case 51: return new LargeLengthTextDataType(partition, propertyAssignments);
				case 52: return new SignedIntegerNumericDataType(partition, propertyAssignments);
				case 53: return new SignedSmallIntegerNumericDataType(partition, propertyAssignments);
				case 54: return new SignedLargeIntegerNumericDataType(partition, propertyAssignments);
				case 55: return new UnsignedIntegerNumericDataType(partition, propertyAssignments);
				case 56: return new UnsignedTinyIntegerNumericDataType(partition, propertyAssignments);
				case 57: return new UnsignedSmallIntegerNumericDataType(partition, propertyAssignments);
				case 58: return new UnsignedLargeIntegerNumericDataType(partition, propertyAssignments);
				case 59: return new AutoCounterNumericDataType(partition, propertyAssignments);
				case 60: return new FloatingPointNumericDataType(partition, propertyAssignments);
				case 61: return new SinglePrecisionFloatingPointNumericDataType(partition, propertyAssignments);
				case 62: return new DoublePrecisionFloatingPointNumericDataType(partition, propertyAssignments);
				case 63: return new DecimalNumericDataType(partition, propertyAssignments);
				case 64: return new MoneyNumericDataType(partition, propertyAssignments);
				case 65: return new FixedLengthRawDataDataType(partition, propertyAssignments);
				case 66: return new VariableLengthRawDataDataType(partition, propertyAssignments);
				case 67: return new LargeLengthRawDataDataType(partition, propertyAssignments);
				case 68: return new PictureRawDataDataType(partition, propertyAssignments);
				case 69: return new OleObjectRawDataDataType(partition, propertyAssignments);
				case 70: return new AutoTimestampTemporalDataType(partition, propertyAssignments);
				case 71: return new TimeTemporalDataType(partition, propertyAssignments);
				case 72: return new DateTemporalDataType(partition, propertyAssignments);
				case 73: return new DateAndTimeTemporalDataType(partition, propertyAssignments);
				case 74: return new TrueOrFalseLogicalDataType(partition, propertyAssignments);
				case 75: return new YesOrNoLogicalDataType(partition, propertyAssignments);
				case 76: return new RowIdOtherDataType(partition, propertyAssignments);
				case 77: return new ObjectIdOtherDataType(partition, propertyAssignments);
				case 78: return new Reading(partition, propertyAssignments);
				case 79: return new ReadingOrder(partition, propertyAssignments);
				case 80: return new ValueRange(partition, propertyAssignments);
				case 81: return new ValueTypeValueConstraint(partition, propertyAssignments);
				case 82: return new RoleValueConstraint(partition, propertyAssignments);
				case 83: return new MinValueMismatchError(partition, propertyAssignments);
				case 84: return new MaxValueMismatchError(partition, propertyAssignments);
				case 85: return new ImpliedInternalUniquenessConstraintError(partition, propertyAssignments);
				case 86: return new FrequencyConstraintContradictsInternalUniquenessConstraintError(partition, propertyAssignments);
				case 87: return new RingConstraintTypeNotSpecifiedError(partition, propertyAssignments);
				case 88: return new SubtypeMetaRole(partition, propertyAssignments);
				case 89: return new SupertypeMetaRole(partition, propertyAssignments);
				case 90: return new Definition(partition, propertyAssignments);
				case 91: return new Note(partition, propertyAssignments);
				case 92: return new ModelNote(partition, propertyAssignments);
				case 93: return new CompatibleSupertypesError(partition, propertyAssignments);
				case 94: return new ImplicationError(partition, propertyAssignments);
				case 95: return new EqualityOrSubsetImpliedByMandatoryError(partition, propertyAssignments);
				case 96: return new PreferredIdentifierRequiresMandatoryError(partition, propertyAssignments);
				case 97: return new ValueRangeOverlapError(partition, propertyAssignments);
				case 98: return new ValueConstraintValueTypeDetachedError(partition, propertyAssignments);
				case 99: return new FactTypeDerivationExpression(partition, propertyAssignments);
				case 100: return new EntityTypeInstance(partition, propertyAssignments);
				case 101: return new ValueTypeInstance(partition, propertyAssignments);
				case 102: return new FactTypeInstance(partition, propertyAssignments);
				case 103: return new TooFewEntityTypeRoleInstancesError(partition, propertyAssignments);
				case 104: return new TooFewFactTypeRoleInstancesError(partition, propertyAssignments);
				case 105: return new CompatibleValueTypeInstanceValueError(partition, propertyAssignments);
				default: return null;
			}
		}
		...
		public sealed override DslModeling::ElementLink CreateElementLink(DslModeling::Partition partition, global::System.Type elementLinkType, DslModeling::RoleAssignment[] roleAssignments, DslModeling::PropertyAssignment[] propertyAssignments)
		{
			...
			{
				createElementLinkMap = new global::System.Collections.Generic.Dictionary<global::System.Type, int>(117);
				...
				createElementLinkMap.Add(typeof(FrequencyConstraintHasFrequencyConstraintInvalidatedByInternalUniquenessConstraintError), 69);
				createElementLinkMap.Add(typeof(FactTypeHasFrequencyConstraintContradictsInternalUniquenessConstraintError), 70);
				...
				createElementLinkMap.Add(typeof(FactTypeHasNote), 75);
				createElementLinkMap.Add(typeof(ObjectTypeHasNote), 76);
				createElementLinkMap.Add(typeof(ModelHasModelNote), 77);
				createElementLinkMap.Add(typeof(ModelNoteReferencesFactType), 78);
				createElementLinkMap.Add(typeof(ModelNoteReferencesObjectType), 79);
				createElementLinkMap.Add(typeof(ModelNoteReferencesSetConstraint), 80);
				createElementLinkMap.Add(typeof(ModelNoteReferencesSetComparisonConstraint), 81);
				createElementLinkMap.Add(typeof(ObjectTypeHasCompatibleSupertypesError), 82);
				createElementLinkMap.Add(typeof(SetConstraintHasImplicationError), 83);
				createElementLinkMap.Add(typeof(SetComparisonConstraintHasImplicationError), 84);
				createElementLinkMap.Add(typeof(SetComparisonConstraintHasEqualityOrSubsetImpliedByMandatoryError), 85);
				createElementLinkMap.Add(typeof(ObjectTypeHasPreferredIdentifierRequiresMandatoryError), 86);
				createElementLinkMap.Add(typeof(ValueConstraintHasValueRangeOverlapError), 87);
				createElementLinkMap.Add(typeof(ValueConstraintHasValueTypeDetachedError), 88);
				createElementLinkMap.Add(typeof(FactTypeHasRole), 89);
				createElementLinkMap.Add(typeof(ReadingOrderHasRole), 90);
				createElementLinkMap.Add(typeof(RoleProxyHasRole), 91);
				createElementLinkMap.Add(typeof(FactTypeHasDerivationExpression), 92);
				createElementLinkMap.Add(typeof(ObjectTypeHasObjectTypeInstance), 93);
				createElementLinkMap.Add(typeof(EntityTypeHasEntityTypeInstance), 94);
				createElementLinkMap.Add(typeof(ValueTypeHasValueTypeInstance), 95);
				createElementLinkMap.Add(typeof(EntityTypeRoleInstance), 96);
				createElementLinkMap.Add(typeof(FactTypeRoleInstance), 97);
				createElementLinkMap.Add(typeof(EntityTypeInstanceHasRoleInstance), 98);
				createElementLinkMap.Add(typeof(FactTypeHasFactTypeInstance), 99);
				createElementLinkMap.Add(typeof(FactTypeInstanceHasRoleInstance), 100);
				createElementLinkMap.Add(typeof(EntityTypeInstanceHasTooFewEntityTypeRoleInstancesError), 101);
				createElementLinkMap.Add(typeof(FactTypeInstanceHasTooFewFactTypeRoleInstancesError), 102);
				createElementLinkMap.Add(typeof(ValueTypeInstanceHasCompatibleValueTypeInstanceValueError), 103);
				createElementLinkMap.Add(typeof(JoinHasInputRole), 104);
				createElementLinkMap.Add(typeof(JoinHasOutputRole), 105);
				createElementLinkMap.Add(typeof(ConstraintRoleSequenceHasJoinPath), 106);
				createElementLinkMap.Add(typeof(ConstraintRoleSequenceHasRoleHasProjectionJoin), 107);
				createElementLinkMap.Add(typeof(ModelHasModelErrorDisplayFilter), 108);
			}
			int index;
			...
			switch (index)
			{
				...
				case 69: return new FrequencyConstraintHasFrequencyConstraintInvalidatedByInternalUniquenessConstraintError(partition, roleAssignments, propertyAssignments);
				case 70: return new FactTypeHasFrequencyConstraintContradictsInternalUniquenessConstraintError(partition, roleAssignments, propertyAssignments);
				...
				case 75: return new FactTypeHasNote(partition, roleAssignments, propertyAssignments);
				case 76: return new ObjectTypeHasNote(partition, roleAssignments, propertyAssignments);
				case 77: return new ModelHasModelNote(partition, roleAssignments, propertyAssignments);
				case 78: return new ModelNoteReferencesFactType(partition, roleAssignments, propertyAssignments);
				case 79: return new ModelNoteReferencesObjectType(partition, roleAssignments, propertyAssignments);
				case 80: return new ModelNoteReferencesSetConstraint(partition, roleAssignments, propertyAssignments);
				case 81: return new ModelNoteReferencesSetComparisonConstraint(partition, roleAssignments, propertyAssignments);
				case 82: return new ObjectTypeHasCompatibleSupertypesError(partition, roleAssignments, propertyAssignments);
				case 83: return new SetConstraintHasImplicationError(partition, roleAssignments, propertyAssignments);
				case 84: return new SetComparisonConstraintHasImplicationError(partition, roleAssignments, propertyAssignments);
				case 85: return new SetComparisonConstraintHasEqualityOrSubsetImpliedByMandatoryError(partition, roleAssignments, propertyAssignments);
				case 86: return new ObjectTypeHasPreferredIdentifierRequiresMandatoryError(partition, roleAssignments, propertyAssignments);
				case 87: return new ValueConstraintHasValueRangeOverlapError(partition, roleAssignments, propertyAssignments);
				case 88: return new ValueConstraintHasValueTypeDetachedError(partition, roleAssignments, propertyAssignments);
				case 89: return new FactTypeHasRole(partition, roleAssignments, propertyAssignments);
				case 90: return new ReadingOrderHasRole(partition, roleAssignments, propertyAssignments);
				case 91: return new RoleProxyHasRole(partition, roleAssignments, propertyAssignments);
				case 92: return new FactTypeHasDerivationExpression(partition, roleAssignments, propertyAssignments);
				case 93: return new ObjectTypeHasObjectTypeInstance(partition, roleAssignments, propertyAssignments);
				case 94: return new EntityTypeHasEntityTypeInstance(partition, roleAssignments, propertyAssignments);
				case 95: return new ValueTypeHasValueTypeInstance(partition, roleAssignments, propertyAssignments);
				case 96: return new EntityTypeRoleInstance(partition, roleAssignments, propertyAssignments);
				case 97: return new FactTypeRoleInstance(partition, roleAssignments, propertyAssignments);
				case 98: return new EntityTypeInstanceHasRoleInstance(partition, roleAssignments, propertyAssignments);
				case 99: return new FactTypeHasFactTypeInstance(partition, roleAssignments, propertyAssignments);
				case 100: return new FactTypeInstanceHasRoleInstance(partition, roleAssignments, propertyAssignments);
				case 101: return new EntityTypeInstanceHasTooFewEntityTypeRoleInstancesError(partition, roleAssignments, propertyAssignments);
				case 102: return new FactTypeInstanceHasTooFewFactTypeRoleInstancesError(partition, roleAssignments, propertyAssignments);
				case 103: return new ValueTypeInstanceHasCompatibleValueTypeInstanceValueError(partition, roleAssignments, propertyAssignments);
				case 104: return new JoinHasInputRole(partition, roleAssignments, propertyAssignments);
				case 105: return new JoinHasOutputRole(partition, roleAssignments, propertyAssignments);
				case 106: return new ConstraintRoleSequenceHasJoinPath(partition, roleAssignments, propertyAssignments);
				case 107: return new ConstraintRoleSequenceHasRoleHasProjectionJoin(partition, roleAssignments, propertyAssignments);
				case 108: return new ModelHasModelErrorDisplayFilter(partition, roleAssignments, propertyAssignments);
				default: return null;
			}
		}
		#endregion
