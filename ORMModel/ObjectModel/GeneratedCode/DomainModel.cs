...
namespace Neumont.Tools.ORM.ObjectModel
{
	...
	public partial class ORMCoreDomainModel : DslModeling::DomainModel
	{
		...
		public sealed override DslModeling::ModelElement CreateElement(DslModeling::Partition partition, global::System.Type elementType, DslModeling::PropertyAssignment[] propertyAssignments)
		{
			...
			{
				createElementMap = new global::System.Collections.Generic.Dictionary<global::System.Type, int>(136);
				...
				createElementMap.Add(typeof(UnsignedSmallIntegerNumericDataType), 56);
				createElementMap.Add(typeof(UnsignedLargeIntegerNumericDataType), 57);
				createElementMap.Add(typeof(AutoCounterNumericDataType), 58);
				createElementMap.Add(typeof(FloatingPointNumericDataType), 59);
				createElementMap.Add(typeof(SinglePrecisionFloatingPointNumericDataType), 60);
				createElementMap.Add(typeof(DoublePrecisionFloatingPointNumericDataType), 61);
				createElementMap.Add(typeof(DecimalNumericDataType), 62);
				createElementMap.Add(typeof(MoneyNumericDataType), 63);
				createElementMap.Add(typeof(FixedLengthRawDataDataType), 64);
				createElementMap.Add(typeof(VariableLengthRawDataDataType), 65);
				createElementMap.Add(typeof(LargeLengthRawDataDataType), 66);
				createElementMap.Add(typeof(PictureRawDataDataType), 67);
				createElementMap.Add(typeof(OleObjectRawDataDataType), 68);
				createElementMap.Add(typeof(AutoTimestampTemporalDataType), 69);
				createElementMap.Add(typeof(TimeTemporalDataType), 70);
				createElementMap.Add(typeof(DateTemporalDataType), 71);
				createElementMap.Add(typeof(DateAndTimeTemporalDataType), 72);
				createElementMap.Add(typeof(TrueOrFalseLogicalDataType), 73);
				createElementMap.Add(typeof(YesOrNoLogicalDataType), 74);
				createElementMap.Add(typeof(RowIdOtherDataType), 75);
				createElementMap.Add(typeof(ObjectIdOtherDataType), 76);
				createElementMap.Add(typeof(Reading), 77);
				createElementMap.Add(typeof(ReadingOrder), 78);
				createElementMap.Add(typeof(ValueRange), 79);
				createElementMap.Add(typeof(ValueTypeValueConstraint), 80);
				createElementMap.Add(typeof(RoleValueConstraint), 81);
				createElementMap.Add(typeof(MinValueMismatchError), 82);
				createElementMap.Add(typeof(MaxValueMismatchError), 83);
				createElementMap.Add(typeof(ImpliedInternalUniquenessConstraintError), 84);
				createElementMap.Add(typeof(FrequencyConstraintContradictsInternalUniquenessConstraintError), 85);
				createElementMap.Add(typeof(RingConstraintTypeNotSpecifiedError), 86);
				createElementMap.Add(typeof(SubtypeMetaRole), 87);
				createElementMap.Add(typeof(SupertypeMetaRole), 88);
				...
				createElementMap.Add(typeof(ValueConstraintValueTypeDetachedError), 97);
				createElementMap.Add(typeof(FactTypeDerivationExpression), 98);
				createElementMap.Add(typeof(EntityTypeInstance), 99);
				createElementMap.Add(typeof(ValueTypeInstance), 100);
				createElementMap.Add(typeof(FactTypeInstance), 101);
				createElementMap.Add(typeof(TooFewEntityTypeRoleInstancesError), 102);
				createElementMap.Add(typeof(TooFewFactTypeRoleInstancesError), 103);
				createElementMap.Add(typeof(CompatibleValueTypeInstanceValueError), 104);
			}
			int index;
			...
			switch (index)
			{
				...
				case 56: return new UnsignedSmallIntegerNumericDataType(partition, propertyAssignments);
				case 57: return new UnsignedLargeIntegerNumericDataType(partition, propertyAssignments);
				case 58: return new AutoCounterNumericDataType(partition, propertyAssignments);
				case 59: return new FloatingPointNumericDataType(partition, propertyAssignments);
				case 60: return new SinglePrecisionFloatingPointNumericDataType(partition, propertyAssignments);
				case 61: return new DoublePrecisionFloatingPointNumericDataType(partition, propertyAssignments);
				case 62: return new DecimalNumericDataType(partition, propertyAssignments);
				case 63: return new MoneyNumericDataType(partition, propertyAssignments);
				case 64: return new FixedLengthRawDataDataType(partition, propertyAssignments);
				case 65: return new VariableLengthRawDataDataType(partition, propertyAssignments);
				case 66: return new LargeLengthRawDataDataType(partition, propertyAssignments);
				case 67: return new PictureRawDataDataType(partition, propertyAssignments);
				case 68: return new OleObjectRawDataDataType(partition, propertyAssignments);
				case 69: return new AutoTimestampTemporalDataType(partition, propertyAssignments);
				case 70: return new TimeTemporalDataType(partition, propertyAssignments);
				case 71: return new DateTemporalDataType(partition, propertyAssignments);
				case 72: return new DateAndTimeTemporalDataType(partition, propertyAssignments);
				case 73: return new TrueOrFalseLogicalDataType(partition, propertyAssignments);
				case 74: return new YesOrNoLogicalDataType(partition, propertyAssignments);
				case 75: return new RowIdOtherDataType(partition, propertyAssignments);
				case 76: return new ObjectIdOtherDataType(partition, propertyAssignments);
				case 77: return new Reading(partition, propertyAssignments);
				case 78: return new ReadingOrder(partition, propertyAssignments);
				case 79: return new ValueRange(partition, propertyAssignments);
				case 80: return new ValueTypeValueConstraint(partition, propertyAssignments);
				case 81: return new RoleValueConstraint(partition, propertyAssignments);
				case 82: return new MinValueMismatchError(partition, propertyAssignments);
				case 83: return new MaxValueMismatchError(partition, propertyAssignments);
				case 84: return new ImpliedInternalUniquenessConstraintError(partition, propertyAssignments);
				case 85: return new FrequencyConstraintContradictsInternalUniquenessConstraintError(partition, propertyAssignments);
				case 86: return new RingConstraintTypeNotSpecifiedError(partition, propertyAssignments);
				case 87: return new SubtypeMetaRole(partition, propertyAssignments);
				case 88: return new SupertypeMetaRole(partition, propertyAssignments);
				...
				case 97: return new ValueConstraintValueTypeDetachedError(partition, propertyAssignments);
				case 98: return new FactTypeDerivationExpression(partition, propertyAssignments);
				case 99: return new EntityTypeInstance(partition, propertyAssignments);
				case 100: return new ValueTypeInstance(partition, propertyAssignments);
				case 101: return new FactTypeInstance(partition, propertyAssignments);
				case 102: return new TooFewEntityTypeRoleInstancesError(partition, propertyAssignments);
				case 103: return new TooFewFactTypeRoleInstancesError(partition, propertyAssignments);
				case 104: return new CompatibleValueTypeInstanceValueError(partition, propertyAssignments);
				default: return null;
			}
		}
