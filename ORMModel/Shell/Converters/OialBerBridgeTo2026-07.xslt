...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
	xmlns:oldOialtober="http://schemas.neumont.edu/ORM/Bridge/2008-05/ORMAbstractionToBarkerER"
	xmlns:oialtober="http://schemas.neumont.edu/ORM/Bridge/2026-07/ORMAbstractionToBarkerER"
	xmlns:exsl="http://exslt.org/common"
	exclude-result-prefixes="#default xsl oldOialtober"
	...
	<xsl:variable name="targetPrefix" select="'oialtober'"/>
	<xsl:variable name="targetNamespace" select="'http://schemas.neumont.edu/ORM/Bridge/2026-07/ORMAbstractionToBarkerER'"/>
	<xsl:variable name="replaceNamespace" select="'http://schemas.neumont.edu/ORM/Bridge/2008-05/ORMAbstractionToBarkerER'"/>
	...
	<xsl:template match="oldOialtober:*">
		<xsl:element name="oialtober:{local-name()}">
			<xsl:apply-templates select="@*|*|text()|comment()"/>
		</xsl:element>
	</xsl:template>
</xsl:stylesheet>