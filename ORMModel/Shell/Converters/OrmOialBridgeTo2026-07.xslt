...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
	xmlns:oldOrmtooial="http://schemas.neumont.edu/ORM/Bridge/2007-06/ORMToORMAbstraction"
	xmlns:ormtooial="http://schemas.neumont.edu/ORM/Bridge/2026-07/ORMToORMAbstraction"
	xmlns:exsl="http://exslt.org/common"
	exclude-result-prefixes="#default xsl oldOrmtooial"
	...
	<xsl:variable name="targetPrefix" select="'ormtooial'"/>
	<xsl:variable name="targetNamespace" select="'http://schemas.neumont.edu/ORM/Bridge/2026-07/ORMToORMAbstraction'"/>
	<xsl:variable name="replaceNamespace" select="'http://schemas.neumont.edu/ORM/Bridge/2007-06/ORMToORMAbstraction'"/>
	...
	<xsl:template match="oldOrmtooial:*">
		<xsl:element name="ormtooial:{local-name()}">
			<xsl:apply-templates select="@*|*|text()|comment()"/>
		</xsl:element>
	</xsl:template>
</xsl:stylesheet>